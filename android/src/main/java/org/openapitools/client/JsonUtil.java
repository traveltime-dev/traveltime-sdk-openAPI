...
public class JsonUtil {
  ...
  public static Type getListTypeForDeserialization(Class cls) {
    ...
    if ("RequestLevelOfDetail".equalsIgnoreCase(className)) {
      return new TypeToken<List<RequestLevelOfDetail>>(){}.getType();
    }
  ...
  public static Type getTypeForDeserialization(Class cls) {
    ...
    if ("RequestLevelOfDetail".equalsIgnoreCase(className)) {
      return new TypeToken<RequestLevelOfDetail>(){}.getType();
    }
