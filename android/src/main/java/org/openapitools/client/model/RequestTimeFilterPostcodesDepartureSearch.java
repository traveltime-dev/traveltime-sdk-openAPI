...
public class RequestTimeFilterPostcodesDepartureSearch {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? requestTimeFilterPostcodesDepartureSearch.id == null : this.id.equals(requestTimeFilterPostcodesDepartureSearch.id)) &&
        (this.transportation == null ? requestTimeFilterPostcodesDepartureSearch.transportation == null : this.transportation.equals(requestTimeFilterPostcodesDepartureSearch.transportation)) &&
        (this.travelTime == null ? requestTimeFilterPostcodesDepartureSearch.travelTime == null : this.travelTime.equals(requestTimeFilterPostcodesDepartureSearch.travelTime)) &&
        (this.departureTime == null ? requestTimeFilterPostcodesDepartureSearch.departureTime == null : this.departureTime.equals(requestTimeFilterPostcodesDepartureSearch.departureTime)) &&
        (this.properties == null ? requestTimeFilterPostcodesDepartureSearch.properties == null : this.properties.equals(requestTimeFilterPostcodesDepartureSearch.properties)) &&
        (this.range == null ? requestTimeFilterPostcodesDepartureSearch.range == null : this.range.equals(requestTimeFilterPostcodesDepartureSearch.range));
  }
