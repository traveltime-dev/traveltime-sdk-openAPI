...
operation_parameters_minimum_occurrences["timeFilterFast:::RequestTimeFilterFast"]=1
operation_parameters_minimum_occurrences["timeFilterPostcodeDistricts:::RequestTimeFilterPostcodeDistricts"]=1
operation_parameters_minimum_occurrences["timeFilterPostcodeSectors:::RequestTimeFilterPostcodeSectors"]=1
operation_parameters_minimum_occurrences["timeFilterPostcodes:::RequestTimeFilterPostcodes"]=1
operation_parameters_minimum_occurrences["timeMap:::RequestTimeMap"]=1
...
operation_parameters_maximum_occurrences["timeFilterFast:::RequestTimeFilterFast"]=0
operation_parameters_maximum_occurrences["timeFilterPostcodeDistricts:::RequestTimeFilterPostcodeDistricts"]=0
operation_parameters_maximum_occurrences["timeFilterPostcodeSectors:::RequestTimeFilterPostcodeSectors"]=0
operation_parameters_maximum_occurrences["timeFilterPostcodes:::RequestTimeFilterPostcodes"]=0
operation_parameters_maximum_occurrences["timeMap:::RequestTimeMap"]=0
...
operation_parameters_collection_type["timeFilterFast:::RequestTimeFilterFast"]=""
operation_parameters_collection_type["timeFilterPostcodeDistricts:::RequestTimeFilterPostcodeDistricts"]=""
operation_parameters_collection_type["timeFilterPostcodeSectors:::RequestTimeFilterPostcodeSectors"]=""
operation_parameters_collection_type["timeFilterPostcodes:::RequestTimeFilterPostcodes"]=""
operation_parameters_collection_type["timeMap:::RequestTimeMap"]=""
...
header_arguments_to_curl() {
    ...
    local api_key_header=""
    local api_key_header_in_cli=""
    api_key_header="X-Application-Id"
...
EOF
    ...
    echo -e "  - ${BLUE}Api-key${OFF} - add '${RED}X-Application-Id:<api-key>${OFF}' after ${YELLOW}<operation>${OFF}"
...
read -r -d '' ops <<EOF
  ${CYAN}geocodingReverseSearch${OFF}; (AUTH) (AUTH)
  ${CYAN}geocodingSearch${OFF}; (AUTH) (AUTH)
  ${CYAN}mapInfo${OFF}; (AUTH) (AUTH)
  ${CYAN}routes${OFF}; (AUTH) (AUTH)
  ${CYAN}supportedLocations${OFF}; (AUTH) (AUTH)
  ${CYAN}timeFilter${OFF}; (AUTH) (AUTH)
  ${CYAN}timeFilterFast${OFF}; (AUTH) (AUTH)
  ${CYAN}timeFilterPostcodeDistricts${OFF}; (AUTH) (AUTH)
  ${CYAN}timeFilterPostcodeSectors${OFF}; (AUTH) (AUTH)
  ${CYAN}timeFilterPostcodes${OFF}; (AUTH) (AUTH)
  ${CYAN}timeMap${OFF}; (AUTH) (AUTH)
EOF
echo "  $ops" | column -t -s ';'
    echo ""
...
echo -e "              \\t\\t\\t\\t(e.g. 'https://api.traveltimeapp.com')"
...
##############################################################################
#
# Print help for geocodingReverseSearch operation
#
##############################################################################
print_geocodingReverseSearch_help() {
    echo ""
...
##############################################################################
#
# Print help for geocodingSearch operation
#
##############################################################################
print_geocodingSearch_help() {
    echo ""
    echo -e "${BOLD}${WHITE}geocodingSearch - ${OFF}${BLUE}(AUTH - HEADER)${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
...
##############################################################################
#
# Print help for mapInfo operation
#
##############################################################################
print_mapInfo_help() {
    echo ""
    echo -e "${BOLD}${WHITE}mapInfo - ${OFF}${BLUE}(AUTH - HEADER)${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
##############################################################################
#
# Print help for routes operation
#
##############################################################################
print_routes_help() {
    echo ""
    echo -e "${BOLD}${WHITE}routes - ${OFF}${BLUE}(AUTH - HEADER)${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
...
##############################################################################
#
# Print help for supportedLocations operation
#
##############################################################################
print_supportedLocations_help() {
    echo ""
    echo -e "${BOLD}${WHITE}supportedLocations - ${OFF}${BLUE}(AUTH - HEADER)${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
##############################################################################
#
# Print help for timeFilter operation
#
##############################################################################
print_timeFilter_help() {
    echo ""
    echo -e "${BOLD}${WHITE}timeFilter - ${OFF}${BLUE}(AUTH - HEADER)${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
##############################################################################
#
# Print help for timeFilterFast operation
#
##############################################################################
print_timeFilterFast_help() {
    echo ""
    echo -e "${BOLD}${WHITE}timeFilterFast - ${OFF}${BLUE}(AUTH - HEADER)${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
##############################################################################
#
# Print help for timeFilterPostcodeDistricts operation
#
##############################################################################
print_timeFilterPostcodeDistricts_help() {
    echo ""
    echo -e "${BOLD}${WHITE}timeFilterPostcodeDistricts - ${OFF}${BLUE}(AUTH - HEADER)${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
##############################################################################
#
# Print help for timeFilterPostcodeSectors operation
#
##############################################################################
print_timeFilterPostcodeSectors_help() {
    echo ""
    echo -e "${BOLD}${WHITE}timeFilterPostcodeSectors - ${OFF}${BLUE}(AUTH - HEADER)${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
##############################################################################
#
# Print help for timeFilterPostcodes operation
#
##############################################################################
print_timeFilterPostcodes_help() {
    echo ""
    echo -e "${BOLD}${WHITE}timeFilterPostcodes - ${OFF}${BLUE}(AUTH - HEADER)${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
##############################################################################
#
# Print help for timeMap operation
#
##############################################################################
print_timeMap_help() {
    echo ""
    echo -e "${BOLD}${WHITE}timeMap - ${OFF}${BLUE}(AUTH - HEADER)${OFF}${BLUE}(AUTH - HEADER)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[application/json]${OFF} ${RED}(required)${OFF}${OFF} - " | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
...
##############################################################################
#
# Call geocodingReverseSearch operation
#
##############################################################################
call_geocodingReverseSearch() {
...
##############################################################################
#
# Call geocodingSearch operation
#
##############################################################################
call_geocodingSearch() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
    local path_parameter_names=()
    # ignore error about 'query_parameter_names' being unused; passed by reference
...
call_mapInfo() {
    ...
    if ! path=$(build_request_path "/v4/map-info" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="GET"
...
call_routes() {
    ...
    if ! path=$(build_request_path "/v4/routes" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="POST"
...
##############################################################################
#
# Call supportedLocations operation
#
##############################################################################
call_supportedLocations() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
    local path_parameter_names=()
    # ignore error about 'query_parameter_names' being unused; passed by reference
    ...
    if ! path=$(build_request_path "/v4/supported-locations" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="POST"
...
call_timeFilter() {
    ...
    if ! path=$(build_request_path "/v4/time-filter" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="POST"
...
call_timeFilterFast() {
    ...
    if ! path=$(build_request_path "/v4/time-filter/fast" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="POST"
...
##############################################################################
#
# Call timeFilterPostcodeDistricts operation
#
##############################################################################
call_timeFilterPostcodeDistricts() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
    local path_parameter_names=()
    # ignore error about 'query_parameter_names' being unused; passed by reference
    ...
    if ! path=$(build_request_path "/v4/time-filter/postcode-districts" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="POST"
...
##############################################################################
#
# Call timeFilterPostcodeSectors operation
#
##############################################################################
call_timeFilterPostcodeSectors() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
    local path_parameter_names=()
    # ignore error about 'query_parameter_names' being unused; passed by reference
    ...
    if ! path=$(build_request_path "/v4/time-filter/postcode-sectors" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="POST"
...
##############################################################################
#
# Call timeFilterPostcodes operation
#
##############################################################################
call_timeFilterPostcodes() {
    # ignore error about 'path_parameter_names' being unused; passed by reference
    # shellcheck disable=SC2034
    local path_parameter_names=()
    # ignore error about 'query_parameter_names' being unused; passed by reference
    ...
    if ! path=$(build_request_path "/v4/time-filter/postcodes" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="POST"
...
call_timeMap() {
    ...
    if ! path=$(build_request_path "/v4/time-map" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="POST"
...
case $key in
    ...
    *:=*)
    ...
    if [[ "$operation" ]]; then
        ...
        # header, override the ${apikey_auth_credential} variable
        #
        if [[ $header_name == "X-Application-Id" ]]; then
            apikey_auth_credential=$header_value
        fi
