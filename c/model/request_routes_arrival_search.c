...
#include "request_routes_arrival_search.h"
    ...
    char* propertiesrequest_routes_arrival_search_ToString(properties_e properties){
        char *propertiesArray[] =  { "travel_time","distance","fares","route" };
        return propertiesArray[properties - 1];
    }

    properties_e propertiesrequest_routes_arrival_search_FromString(char* properties){
