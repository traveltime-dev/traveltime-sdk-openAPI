...
typedef struct request_routes_departure_search_t request_routes_departure_search_t;
...
typedef enum  { traveltime_api_request_routes_departure_search__NULL = 0, traveltime_api_request_routes_departure_search__travel_time, traveltime_api_request_routes_departure_search__distance, traveltime_api_request_routes_departure_search__fares, traveltime_api_request_routes_departure_search__route } traveltime_api_request_routes_departure_search__e;

char* request_routes_departure_search_properties_ToString(traveltime_api_request_routes_departure_search__e properties);

traveltime_api_request_routes_departure_search__e request_routes_departure_search_properties_FromString(char* properties);
