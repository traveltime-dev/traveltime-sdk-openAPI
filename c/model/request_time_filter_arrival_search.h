...
typedef struct request_time_filter_arrival_search_t request_time_filter_arrival_search_t;
...
typedef enum  { traveltime_api_request_time_filter_arrival_search__NULL = 0, traveltime_api_request_time_filter_arrival_search__travel_time, traveltime_api_request_time_filter_arrival_search__distance, traveltime_api_request_time_filter_arrival_search__distance_breakdown, traveltime_api_request_time_filter_arrival_search__fares, traveltime_api_request_time_filter_arrival_search__route } traveltime_api_request_time_filter_arrival_search__e;

char* request_time_filter_arrival_search_properties_ToString(traveltime_api_request_time_filter_arrival_search__e properties);

traveltime_api_request_time_filter_arrival_search__e request_time_filter_arrival_search_properties_FromString(char* properties);
