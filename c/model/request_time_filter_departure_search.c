...
request_time_filter_departure_search_t *request_time_filter_departure_search_create(
	...
	request_time_filter_departure_search_t *request_time_filter_departure_search = malloc(sizeof(request_time_filter_departure_search_t));
	request_time_filter_departure_search->id = id;
	request_time_filter_departure_search->departure_location_id = departure_location_id;
	request_time_filter_departure_search->arrival_location_ids = arrival_location_ids;
	request_time_filter_departure_search->transportation = transportation;
	request_time_filter_departure_search->travel_time = travel_time;
	request_time_filter_departure_search->departure_time = departure_time;
	request_time_filter_departure_search->properties = properties;
	request_time_filter_departure_search->range = range;

	return request_time_filter_departure_search;
}
...
cJSON *request_time_filter_departure_search_convertToJSON(request_time_filter_departure_search_t *request_time_filter_departure_search) {
	...
	cJSON *transportation = request_transportation_convertToJSON(request_time_filter_departure_search->transportation);
	...
	cJSON *range = request_range_full_convertToJSON(request_time_filter_departure_search->range);
	if(range == NULL) {
		goto fail; //nonprimitive
	}
...
request_time_filter_departure_search_t *request_time_filter_departure_search_parseFromJSON(char *jsonString){
    ...
    request_time_filter_departure_search_t *request_time_filter_departure_search = NULL;
    cJSON *request_time_filter_departure_searchJSON = cJSON_Parse(jsonString);
    if(request_time_filter_departure_searchJSON == NULL){
    ...
    cJSON *arrival_location_idsJSON = cJSON_GetObjectItemCaseSensitive(request_time_filter_departure_searchJSON, "arrival_location_ids");
    ...
    // request_time_filter_departure_search->transportation
    request_transportation_t *transportation;
    cJSON *transportationJSON = cJSON_GetObjectItemCaseSensitive(request_time_filter_departure_searchJSON, "transportation");
    if(request_time_filter_departure_searchJSON == NULL){
        const char *error_ptr = cJSON_GetErrorPtr();
        if (error_ptr != NULL)
            fprintf(stderr, "Error Before: %s\n", error_ptr);
    ...
    // request_time_filter_departure_search->properties
    cJSON *properties;
    cJSON *propertiesJSON = cJSON_GetObjectItemCaseSensitive(request_time_filter_departure_searchJSON,"properties");
    ...
    // request_time_filter_departure_search->range
    request_range_full_t *range;
    cJSON *rangeJSON = cJSON_GetObjectItemCaseSensitive(request_time_filter_departure_searchJSON, "range");
    if(request_time_filter_departure_searchJSON == NULL){
        const char *error_ptr = cJSON_GetErrorPtr();
        if (error_ptr != NULL)
            fprintf(stderr, "Error Before: %s\n", error_ptr);
    ...
    request_time_filter_departure_search = request_time_filter_departure_search_create (
        ...
        free(rangeJSONData);
 cJSON_Delete(request_time_filter_departure_searchJSON);
    return request_time_filter_departure_search;
end:
    cJSON_Delete(request_time_filter_departure_searchJSON);
    return NULL;
