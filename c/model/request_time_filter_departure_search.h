...
typedef enum  { traveltime_platform_api_request_time_filter_departure_search__NULL = 0, traveltime_platform_api_request_time_filter_departure_search__travel_time, traveltime_platform_api_request_time_filter_departure_search__distance, traveltime_platform_api_request_time_filter_departure_search__distance_breakdown, traveltime_platform_api_request_time_filter_departure_search__fares, traveltime_platform_api_request_time_filter_departure_search__route } traveltime_platform_api_request_time_filter_departure_search__e;

char* request_time_filter_departure_search_properties_ToString(traveltime_platform_api_request_time_filter_departure_search__e properties);

traveltime_platform_api_request_time_filter_departure_search__e request_time_filter_departure_search_properties_FromString(char* properties);
