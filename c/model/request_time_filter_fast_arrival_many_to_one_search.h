...
typedef struct request_time_filter_fast_arrival_many_to_one_search_t request_time_filter_fast_arrival_many_to_one_search_t;
...
typedef enum  { traveltime_api_request_time_filter_fast_arrival_many_to_one_search__NULL = 0, traveltime_api_request_time_filter_fast_arrival_many_to_one_search__weekday_morning } traveltime_api_request_time_filter_fast_arrival_many_to_one_search__e;

char* request_time_filter_fast_arrival_many_to_one_search_arrival_time_period_ToString(traveltime_api_request_time_filter_fast_arrival_many_to_one_search__e arrival_time_period);

traveltime_api_request_time_filter_fast_arrival_many_to_one_search__e request_time_filter_fast_arrival_many_to_one_search_arrival_time_period_FromString(char* arrival_time_period);

// Enum  for request_time_filter_fast_arrival_many_to_one_search

typedef enum  { traveltime_api_request_time_filter_fast_arrival_many_to_one_search__NULL = 0, traveltime_api_request_time_filter_fast_arrival_many_to_one_search__travel_time, traveltime_api_request_time_filter_fast_arrival_many_to_one_search__fares } traveltime_api_request_time_filter_fast_arrival_many_to_one_search__e;

char* request_time_filter_fast_arrival_many_to_one_search_properties_ToString(traveltime_api_request_time_filter_fast_arrival_many_to_one_search__e properties);

traveltime_api_request_time_filter_fast_arrival_many_to_one_search__e request_time_filter_fast_arrival_many_to_one_search_properties_FromString(char* properties);
