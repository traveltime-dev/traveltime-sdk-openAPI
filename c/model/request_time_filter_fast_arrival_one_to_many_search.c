...
#include "request_time_filter_fast_arrival_one_to_many_search.h"
    ...
    char* arrival_time_periodrequest_time_filter_fast_arrival_one_to_many_search_ToString(arrival_time_period_e arrival_time_period){
    char *arrival_time_periodArray[] =  { "weekday_morning" };
        return arrival_time_periodArray[arrival_time_period];
    }

    arrival_time_period_e arrival_time_periodrequest_time_filter_fast_arrival_one_to_many_search_FromString(char* arrival_time_period){
    ...
    char* propertiesrequest_time_filter_fast_arrival_one_to_many_search_ToString(properties_e properties){
        char *propertiesArray[] =  { "travel_time","fares" };
        return propertiesArray[properties - 1];
    }

    properties_e propertiesrequest_time_filter_fast_arrival_one_to_many_search_FromString(char* properties){
    int stringToReturn = 0;
    char *propertiesArray[] =  { "travel_time","fares" };
