...
request_time_filter_postcode_districts_t *request_time_filter_postcode_districts_create(
	...
	request_time_filter_postcode_districts_t *request_time_filter_postcode_districts = malloc(sizeof(request_time_filter_postcode_districts_t));
	request_time_filter_postcode_districts->departure_searches = departure_searches;
	request_time_filter_postcode_districts->arrival_searches = arrival_searches;
...
cJSON *request_time_filter_postcode_districts_convertToJSON(request_time_filter_postcode_districts_t *request_time_filter_postcode_districts) {
	...
	list_ForEach(departure_searchesListEntry, request_time_filter_postcode_districts->departure_searches) {
		cJSON *item = request_time_filter_postcode_districts_departure_search_convertToJSON(departure_searchesListEntry->data);
		if(item == NULL) {
			goto fail;
		}
	...
	list_ForEach(arrival_searchesListEntry, request_time_filter_postcode_districts->arrival_searches) {
		cJSON *item = request_time_filter_postcode_districts_arrival_search_convertToJSON(arrival_searchesListEntry->data);
		if(item == NULL) {
			goto fail;
		}
...
request_time_filter_postcode_districts_t *request_time_filter_postcode_districts_parseFromJSON(char *jsonString){

    request_time_filter_postcode_districts_t *request_time_filter_postcode_districts = NULL;
    cJSON *request_time_filter_postcode_districtsJSON = cJSON_Parse(jsonString);
    if(request_time_filter_postcode_districtsJSON == NULL){
    ...
    cJSON *departure_searchesJSON = cJSON_GetObjectItemCaseSensitive(request_time_filter_postcode_districtsJSON,"departure_searches");
    ...
    cJSON_ArrayForEach(departure_searches,departure_searchesJSON )
    {
        ...
        request_time_filter_postcode_districts_departure_search_t *departure_searchesItem = request_time_filter_postcode_districts_departure_search_parseFromJSON(JSONData);
    ...
    cJSON *arrival_searchesJSON = cJSON_GetObjectItemCaseSensitive(request_time_filter_postcode_districtsJSON,"arrival_searches");
    ...
    cJSON_ArrayForEach(arrival_searches,arrival_searchesJSON )
    {
        ...
        request_time_filter_postcode_districts_arrival_search_t *arrival_searchesItem = request_time_filter_postcode_districts_arrival_search_parseFromJSON(JSONData);
 ...
 cJSON_Delete(request_time_filter_postcode_districtsJSON);
    return request_time_filter_postcode_districts;
end:
    cJSON_Delete(request_time_filter_postcode_districtsJSON);
    return NULL;
