...
typedef enum  { traveltime_platform_api_request_time_filter_postcode_districts_arrival_search__NULL = 0, traveltime_platform_api_request_time_filter_postcode_districts_arrival_search__travel_time_reachable, traveltime_platform_api_request_time_filter_postcode_districts_arrival_search__travel_time_all, traveltime_platform_api_request_time_filter_postcode_districts_arrival_search__coverage } traveltime_platform_api_request_time_filter_postcode_districts_arrival_search__e;

char* request_time_filter_postcode_districts_arrival_search_properties_ToString(traveltime_platform_api_request_time_filter_postcode_districts_arrival_search__e properties);

traveltime_platform_api_request_time_filter_postcode_districts_arrival_search__e request_time_filter_postcode_districts_arrival_search_properties_FromString(char* properties);
