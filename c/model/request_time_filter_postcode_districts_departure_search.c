...
char* propertiesrequest_time_filter_postcode_districts_departure_search_ToString(traveltime_api_request_time_filter_postcode_districts_departure_search__e properties) {
	char *propertiesArray[] =  { "NULL", "travel_time_reachable", "travel_time_all", "coverage" };
	return propertiesArray[properties - 1];
}

traveltime_api_request_time_filter_postcode_districts_departure_search__e propertiesrequest_time_filter_postcode_districts_departure_search_FromString(char* properties) {
...
void request_time_filter_postcode_districts_departure_search_free(request_time_filter_postcode_districts_departure_search_t *request_time_filter_postcode_districts_departure_search) {
    if(NULL == request_time_filter_postcode_districts_departure_search){
        return ;
    }
    ...
    if (request_time_filter_postcode_districts_departure_search->id) {
        ...
        request_time_filter_postcode_districts_departure_search->id = NULL;
    }
    if (request_time_filter_postcode_districts_departure_search->transportation) {
        ...
        request_time_filter_postcode_districts_departure_search->transportation = NULL;
    }
    if (request_time_filter_postcode_districts_departure_search->departure_time) {
        ...
        request_time_filter_postcode_districts_departure_search->departure_time = NULL;
    }
    if (request_time_filter_postcode_districts_departure_search->properties) {
        ...
        request_time_filter_postcode_districts_departure_search->properties = NULL;
    }
    if (request_time_filter_postcode_districts_departure_search->range) {
        ...
        request_time_filter_postcode_districts_departure_search->range = NULL;
    }
...
cJSON *request_time_filter_postcode_districts_departure_search_convertToJSON(request_time_filter_postcode_districts_departure_search_t *request_time_filter_postcode_districts_departure_search) {
    ...
    cJSON *itemLocal = request_time_filter_postcode_districts_property_convertToJSON((traveltime_api_request_time_filter_postcode_districts_departure_search__e)propertiesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
request_time_filter_postcode_districts_departure_search_t *request_time_filter_postcode_districts_departure_search_parseFromJSON(cJSON *request_time_filter_postcode_districts_departure_searchJSON){
    ...
    cJSON_ArrayForEach(properties_local_nonprimitive,properties )
    {
        ...
        request_time_filter_postcode_districts_departure_search_request_time_filter_postcode_districts_property_e propertiesItem = request_time_filter_postcode_districts_property_parseFromJSON(properties_local_nonprimitive);
