...
typedef struct request_time_filter_postcode_districts_departure_search_t request_time_filter_postcode_districts_departure_search_t;
...
typedef enum  { traveltime_api_request_time_filter_postcode_districts_departure_search__NULL = 0, traveltime_api_request_time_filter_postcode_districts_departure_search__travel_time_reachable, traveltime_api_request_time_filter_postcode_districts_departure_search__travel_time_all, traveltime_api_request_time_filter_postcode_districts_departure_search__coverage } traveltime_api_request_time_filter_postcode_districts_departure_search__e;

char* request_time_filter_postcode_districts_departure_search_properties_ToString(traveltime_api_request_time_filter_postcode_districts_departure_search__e properties);

traveltime_api_request_time_filter_postcode_districts_departure_search__e request_time_filter_postcode_districts_departure_search_properties_FromString(char* properties);
