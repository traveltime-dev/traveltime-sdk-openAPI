...
char *request_time_filter_postcode_districts_propertyArray[] =  { "travel_time_reachable","travel_time_all","coverage" };
...
cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "request_time_filter_postcode_districts_property", request_time_filter_postcode_districts_property_ToString(request_time_filter_postcode_districts_property)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
request_time_filter_postcode_districts_property_e *request_time_filter_postcode_districts_property = NULL;

request_time_filter_postcode_districts_property_e request_time_filter_postcode_districts_propertyVariable;
...
request_time_filter_postcode_districts_propertyVariable = request_time_filter_postcode_districts_property_FromString(request_time_filter_postcode_districts_propertyVar->valuestring);
