...
request_time_filter_postcode_districts_property_request_time_filter_postcode_districts_property_e request_time_filter_postcode_districts_property_request_time_filter_postcode_districts_property_parseFromJSON(cJSON *request_time_filter_postcode_districts_propertyJSON) {
    request_time_filter_postcode_districts_property_request_time_filter_postcode_districts_property_e *request_time_filter_postcode_districts_property = NULL;
    request_time_filter_postcode_districts_property_request_time_filter_postcode_districts_property_e request_time_filter_postcode_districts_propertyVariable;
