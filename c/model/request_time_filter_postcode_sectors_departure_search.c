...
char* propertiesrequest_time_filter_postcode_sectors_departure_search_ToString(traveltime_platform_api_request_time_filter_postcode_sectors_departure_search__e properties) {
	char *propertiesArray[] =  { "NULL", "travel_time_reachable", "travel_time_all", "coverage" };
	return propertiesArray[properties - 1];
}

traveltime_platform_api_request_time_filter_postcode_sectors_departure_search__e propertiesrequest_time_filter_postcode_sectors_departure_search_FromString(char* properties) {
...
cJSON *request_time_filter_postcode_sectors_departure_search_convertToJSON(request_time_filter_postcode_sectors_departure_search_t *request_time_filter_postcode_sectors_departure_search) {
    ...
    cJSON *itemLocal = request_time_filter_postcode_sectors_property_convertToJSON((traveltime_platform_api_request_time_filter_postcode_sectors_departure_search__e)propertiesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
