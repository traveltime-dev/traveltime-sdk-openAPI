...
#include "request_time_filter_postcode_sectors_departure_search.h"
    ...
    char* propertiesrequest_time_filter_postcode_sectors_departure_search_ToString(properties_e properties){
        char *propertiesArray[] =  { "travel_time_reachable","travel_time_all","coverage" };
        return propertiesArray[properties - 1];
    }

    properties_e propertiesrequest_time_filter_postcode_sectors_departure_search_FromString(char* properties){
...
cJSON *request_time_filter_postcode_sectors_departure_search_convertToJSON(request_time_filter_postcode_sectors_departure_search_t *request_time_filter_postcode_sectors_departure_search) {
    ...
    cJSON *itemLocal = request_time_filter_postcode_sectors_property_convertToJSON((request_time_filter_postcode_sectors_property_e)propertiesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
request_time_filter_postcode_sectors_departure_search_t *request_time_filter_postcode_sectors_departure_search_parseFromJSON(cJSON *request_time_filter_postcode_sectors_departure_searchJSON){
    ...
    cJSON_ArrayForEach(properties_local_nonprimitive,properties )
    {
        ...
        request_time_filter_postcode_sectors_property_e propertiesItem = request_time_filter_postcode_sectors_property_parseFromJSON(properties_local_nonprimitive);
