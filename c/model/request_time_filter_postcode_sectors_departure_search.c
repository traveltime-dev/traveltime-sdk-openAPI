...
char* propertiesrequest_time_filter_postcode_sectors_departure_search_ToString(traveltime_api_request_time_filter_postcode_sectors_departure_search__e properties) {
	char *propertiesArray[] =  { "NULL", "travel_time_reachable", "travel_time_all", "coverage" };
	return propertiesArray[properties - 1];
}

traveltime_api_request_time_filter_postcode_sectors_departure_search__e propertiesrequest_time_filter_postcode_sectors_departure_search_FromString(char* properties) {
...
request_time_filter_postcode_sectors_departure_search_t *request_time_filter_postcode_sectors_departure_search_create(
    ...
    request_time_filter_postcode_sectors_departure_search_t *request_time_filter_postcode_sectors_departure_search_local_var = malloc(sizeof(request_time_filter_postcode_sectors_departure_search_t));
    if (!request_time_filter_postcode_sectors_departure_search_local_var) {
        return NULL;
    }
    request_time_filter_postcode_sectors_departure_search_local_var->id = id;
    request_time_filter_postcode_sectors_departure_search_local_var->transportation = transportation;
    request_time_filter_postcode_sectors_departure_search_local_var->travel_time = travel_time;
    request_time_filter_postcode_sectors_departure_search_local_var->departure_time = departure_time;
    request_time_filter_postcode_sectors_departure_search_local_var->reachable_postcodes_threshold = reachable_postcodes_threshold;
    request_time_filter_postcode_sectors_departure_search_local_var->properties = properties;
    request_time_filter_postcode_sectors_departure_search_local_var->range = range;
...
void request_time_filter_postcode_sectors_departure_search_free(request_time_filter_postcode_sectors_departure_search_t *request_time_filter_postcode_sectors_departure_search) {
    if(NULL == request_time_filter_postcode_sectors_departure_search){
        return ;
    }
...
cJSON *request_time_filter_postcode_sectors_departure_search_convertToJSON(request_time_filter_postcode_sectors_departure_search_t *request_time_filter_postcode_sectors_departure_search) {
    ...
    cJSON *transportation_local_JSON = request_transportation_convertToJSON(request_time_filter_postcode_sectors_departure_search->transportation);
    ...
    if (!request_time_filter_postcode_sectors_departure_search->travel_time) {
        goto fail;
    }
    ...
    if (!request_time_filter_postcode_sectors_departure_search->reachable_postcodes_threshold) {
        goto fail;
    }
    ...
    cJSON *itemLocal = request_time_filter_postcode_sectors_property_convertToJSON((traveltime_api_request_time_filter_postcode_sectors_departure_search__e)propertiesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    cJSON *range_local_JSON = request_range_full_convertToJSON(request_time_filter_postcode_sectors_departure_search->range);
...
request_time_filter_postcode_sectors_departure_search_t *request_time_filter_postcode_sectors_departure_search_parseFromJSON(cJSON *request_time_filter_postcode_sectors_departure_searchJSON){
    ...
    request_time_filter_postcode_sectors_departure_search_t *request_time_filter_postcode_sectors_departure_search_local_var = NULL;
    ...
    // request_time_filter_postcode_sectors_departure_search->transportation
    cJSON *transportation = cJSON_GetObjectItemCaseSensitive(request_time_filter_postcode_sectors_departure_searchJSON, "transportation");
    if (!transportation) {
        goto end;
    }
    ...
    // request_time_filter_postcode_sectors_departure_search->properties
    cJSON *properties = cJSON_GetObjectItemCaseSensitive(request_time_filter_postcode_sectors_departure_searchJSON, "properties");
    if (!properties) {
        goto end;
    }
    ...
    cJSON_ArrayForEach(properties_local_nonprimitive,properties )
    {
        ...
        request_time_filter_postcode_sectors_departure_search_request_time_filter_postcode_sectors_property_e propertiesItem = request_time_filter_postcode_sectors_property_parseFromJSON(properties_local_nonprimitive);

        list_addElement(propertiesList, (void *)propertiesItem);
    }

    // request_time_filter_postcode_sectors_departure_search->range
    cJSON *range = cJSON_GetObjectItemCaseSensitive(request_time_filter_postcode_sectors_departure_searchJSON, "range");
    ...
    request_time_filter_postcode_sectors_departure_search_local_var = request_time_filter_postcode_sectors_departure_search_create (
