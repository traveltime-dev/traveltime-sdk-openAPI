...
traveltime_api_request_time_filter_postcode_sectors_property__e request_time_filter_postcode_sectors_property_request_time_filter_postcode_sectors_property_parseFromJSON(cJSON *request_time_filter_postcode_sectors_propertyJSON) {
    traveltime_api_request_time_filter_postcode_sectors_property__e *request_time_filter_postcode_sectors_property = NULL;
    traveltime_api_request_time_filter_postcode_sectors_property__e request_time_filter_postcode_sectors_propertyVariable;
