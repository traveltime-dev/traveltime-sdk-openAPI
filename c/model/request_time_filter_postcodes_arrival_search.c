...
char* propertiesrequest_time_filter_postcodes_arrival_search_ToString(traveltime_platform_api_request_time_filter_postcodes_arrival_search__e properties) {
	char *propertiesArray[] =  { "NULL", "travel_time", "distance" };
	return propertiesArray[properties - 1];
}

traveltime_platform_api_request_time_filter_postcodes_arrival_search__e propertiesrequest_time_filter_postcodes_arrival_search_FromString(char* properties) {
...
cJSON *request_time_filter_postcodes_arrival_search_convertToJSON(request_time_filter_postcodes_arrival_search_t *request_time_filter_postcodes_arrival_search) {
    ...
    cJSON *itemLocal = request_time_filter_postcodes_property_convertToJSON((traveltime_platform_api_request_time_filter_postcodes_arrival_search__e)propertiesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
