...
#include "request_time_filter_postcodes_departure_search.h"
    ...
    char* propertiesrequest_time_filter_postcodes_departure_search_ToString(properties_e properties){
        char *propertiesArray[] =  { "travel_time","distance" };
        return propertiesArray[properties - 1];
    }

    properties_e propertiesrequest_time_filter_postcodes_departure_search_FromString(char* properties){
