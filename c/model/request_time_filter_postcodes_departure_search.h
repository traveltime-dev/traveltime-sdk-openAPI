...
typedef struct request_time_filter_postcodes_departure_search_t request_time_filter_postcodes_departure_search_t;

#include "request_range_full.h"
#include "request_time_filter_postcodes_property.h"
#include "request_transportation.h"

// Enum  for request_time_filter_postcodes_departure_search

typedef enum  { traveltime_api_request_time_filter_postcodes_departure_search__NULL = 0, traveltime_api_request_time_filter_postcodes_departure_search__travel_time, traveltime_api_request_time_filter_postcodes_departure_search__distance } traveltime_api_request_time_filter_postcodes_departure_search__e;

char* request_time_filter_postcodes_departure_search_properties_ToString(traveltime_api_request_time_filter_postcodes_departure_search__e properties);

traveltime_api_request_time_filter_postcodes_departure_search__e request_time_filter_postcodes_departure_search_properties_FromString(char* properties);
