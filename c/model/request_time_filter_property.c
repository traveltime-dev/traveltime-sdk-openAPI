...
char *request_time_filter_propertyArray[] =  { "travel_time","distance","distance_breakdown","fares","route" };
...
cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "request_time_filter_property", request_time_filter_property_ToString(request_time_filter_property)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
request_time_filter_property_e *request_time_filter_property = NULL;

request_time_filter_property_e request_time_filter_propertyVariable;
...
request_time_filter_propertyVariable = request_time_filter_property_FromString(request_time_filter_propertyVar->valuestring);
