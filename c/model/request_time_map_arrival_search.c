...
#include "request_time_map_arrival_search.h"
    ...
    char* propertiesrequest_time_map_arrival_search_ToString(properties_e properties){
        char *propertiesArray[] =  { "is_only_walking" };
        return propertiesArray[properties - 1];
    }

    properties_e propertiesrequest_time_map_arrival_search_FromString(char* properties){
