...
char* propertiesrequest_time_map_departure_search_ToString(traveltime_api_request_time_map_departure_search__e properties) {
	char *propertiesArray[] =  { "NULL", "is_only_walking" };
	return propertiesArray[properties - 1];
}

traveltime_api_request_time_map_departure_search__e propertiesrequest_time_map_departure_search_FromString(char* properties) {
...
request_time_map_departure_search_t *request_time_map_departure_search_create(
    ...
    request_time_map_departure_search_t *request_time_map_departure_search_local_var = malloc(sizeof(request_time_map_departure_search_t));
    if (!request_time_map_departure_search_local_var) {
        return NULL;
    }
    request_time_map_departure_search_local_var->id = id;
    request_time_map_departure_search_local_var->coords = coords;
    request_time_map_departure_search_local_var->transportation = transportation;
    request_time_map_departure_search_local_var->travel_time = travel_time;
    request_time_map_departure_search_local_var->departure_time = departure_time;
    request_time_map_departure_search_local_var->properties = properties;
    request_time_map_departure_search_local_var->range = range;
    request_time_map_departure_search_local_var->level_of_detail = level_of_detail;
...
void request_time_map_departure_search_free(request_time_map_departure_search_t *request_time_map_departure_search) {
    if(NULL == request_time_map_departure_search){
        return ;
    }
    ...
    if (request_time_map_departure_search->level_of_detail) {
        request_level_of_detail_free(request_time_map_departure_search->level_of_detail);
        request_time_map_departure_search->level_of_detail = NULL;
    }
...
cJSON *request_time_map_departure_search_convertToJSON(request_time_map_departure_search_t *request_time_map_departure_search) {
    ...
    cJSON *coords_local_JSON = coords_convertToJSON(request_time_map_departure_search->coords);
    ...
    cJSON *transportation_local_JSON = request_transportation_convertToJSON(request_time_map_departure_search->transportation);
    ...
    if (!request_time_map_departure_search->travel_time) {
        goto fail;
    }
    ...
    cJSON *itemLocal = request_time_map_property_convertToJSON((traveltime_api_request_time_map_departure_search__e)propertiesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if(request_time_map_departure_search->range) { 
    cJSON *range_local_JSON = request_range_no_max_results_convertToJSON(request_time_map_departure_search->range);
    ...
    // request_time_map_departure_search->level_of_detail
    if(request_time_map_departure_search->level_of_detail) { 
    cJSON *level_of_detail_local_JSON = request_level_of_detail_convertToJSON(request_time_map_departure_search->level_of_detail);
    if(level_of_detail_local_JSON == NULL) {
    goto fail; //model
    }
    cJSON_AddItemToObject(item, "level_of_detail", level_of_detail_local_JSON);
    if(item->child == NULL) {
    goto fail;
    }
     } 
...
request_time_map_departure_search_t *request_time_map_departure_search_parseFromJSON(cJSON *request_time_map_departure_searchJSON){
    ...
    request_time_map_departure_search_t *request_time_map_departure_search_local_var = NULL;
    ...
    // request_time_map_departure_search->coords
    cJSON *coords = cJSON_GetObjectItemCaseSensitive(request_time_map_departure_searchJSON, "coords");
    if (!coords) {
        goto end;
    }
    ...
    // request_time_map_departure_search->transportation
    cJSON *transportation = cJSON_GetObjectItemCaseSensitive(request_time_map_departure_searchJSON, "transportation");
    if (!transportation) {
        goto end;
    }
    ...
    // request_time_map_departure_search->properties
    cJSON *properties = cJSON_GetObjectItemCaseSensitive(request_time_map_departure_searchJSON, "properties");
    ...
    // request_time_map_departure_search->range
    cJSON *range = cJSON_GetObjectItemCaseSensitive(request_time_map_departure_searchJSON, "range");
    ...
    // request_time_map_departure_search->level_of_detail
    cJSON *level_of_detail = cJSON_GetObjectItemCaseSensitive(request_time_map_departure_searchJSON, "level_of_detail");
    request_level_of_detail_t *level_of_detail_local_nonprim = NULL;
    if (level_of_detail) { 
    level_of_detail_local_nonprim = request_level_of_detail_parseFromJSON(level_of_detail); //nonprimitive
    }


    request_time_map_departure_search_local_var = request_time_map_departure_search_create (
        ...
        level_of_detail ? level_of_detail_local_nonprim : NULL
        );
    ...
    if (level_of_detail_local_nonprim) {
        request_level_of_detail_free(level_of_detail_local_nonprim);
        level_of_detail_local_nonprim = NULL;
    }
    return NULL;
