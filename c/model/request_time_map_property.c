...
char *request_time_map_propertyArray[] =  { "is_only_walking" };
...
cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "request_time_map_property", request_time_map_property_ToString(request_time_map_property)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
request_time_map_property_e *request_time_map_property = NULL;

request_time_map_property_e request_time_map_propertyVariable;
...
request_time_map_propertyVariable = request_time_map_property_FromString(request_time_map_propertyVar->valuestring);
