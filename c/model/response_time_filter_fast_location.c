...
response_time_filter_fast_location_t *response_time_filter_fast_location_create(
	...
	response_time_filter_fast_location_t *response_time_filter_fast_location = malloc(sizeof(response_time_filter_fast_location_t));
	response_time_filter_fast_location->id = id;
	response_time_filter_fast_location->properties = properties;
...
cJSON *response_time_filter_fast_location_convertToJSON(response_time_filter_fast_location_t *response_time_filter_fast_location) {
    ...
    if(cJSON_AddStringToObject(item, "id", response_time_filter_fast_location->id) == NULL) {
    goto fail; //String
    }
	...
	list_ForEach(propertiesListEntry, response_time_filter_fast_location->properties) {
		cJSON *item = response_time_filter_fast_properties_convertToJSON(propertiesListEntry->data);
		if(item == NULL) {
			goto fail;
		}
...
response_time_filter_fast_location_t *response_time_filter_fast_location_parseFromJSON(char *jsonString){
    ...
    cJSON *response_time_filter_fast_locationJSON = cJSON_Parse(jsonString);
    if(response_time_filter_fast_locationJSON == NULL){
    ...
    // response_time_filter_fast_location->id
    cJSON *id = cJSON_GetObjectItemCaseSensitive(response_time_filter_fast_locationJSON, "id");
    ...
    // response_time_filter_fast_location->properties
    cJSON *properties;
    cJSON *propertiesJSON = cJSON_GetObjectItemCaseSensitive(response_time_filter_fast_locationJSON,"properties");
    ...
    cJSON_ArrayForEach(properties,propertiesJSON )
    {
        ...
        response_time_filter_fast_properties_t *propertiesItem = response_time_filter_fast_properties_parseFromJSON(JSONData);
 ...
 cJSON_Delete(response_time_filter_fast_locationJSON);
    return response_time_filter_fast_location;
end:
    cJSON_Delete(response_time_filter_fast_locationJSON);
    return NULL;
