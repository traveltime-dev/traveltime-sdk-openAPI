...
response_time_filter_fast_result_t *response_time_filter_fast_result_create(
    ...
    response_time_filter_fast_result_t *response_time_filter_fast_result_local_var = malloc(sizeof(response_time_filter_fast_result_t));
    if (!response_time_filter_fast_result_local_var) {
        return NULL;
    }
    response_time_filter_fast_result_local_var->search_id = search_id;
    response_time_filter_fast_result_local_var->locations = locations;
    response_time_filter_fast_result_local_var->unreachable = unreachable;

    return response_time_filter_fast_result_local_var;
}
...
void response_time_filter_fast_result_free(response_time_filter_fast_result_t *response_time_filter_fast_result) {
    ...
    if (response_time_filter_fast_result->search_id) {
        free(response_time_filter_fast_result->search_id);
        response_time_filter_fast_result->search_id = NULL;
    }
    if (response_time_filter_fast_result->locations) {
        ...
        response_time_filter_fast_result->locations = NULL;
    }
    if (response_time_filter_fast_result->unreachable) {
        ...
        response_time_filter_fast_result->unreachable = NULL;
    }
...
cJSON *response_time_filter_fast_result_convertToJSON(response_time_filter_fast_result_t *response_time_filter_fast_result) {
    ...
    cJSON *itemLocal = response_time_filter_fast_location_convertToJSON(locationsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
response_time_filter_fast_result_t *response_time_filter_fast_result_parseFromJSON(cJSON *response_time_filter_fast_resultJSON){

    response_time_filter_fast_result_t *response_time_filter_fast_result_local_var = NULL;
    ...
    // response_time_filter_fast_result->locations
    cJSON *locations = cJSON_GetObjectItemCaseSensitive(response_time_filter_fast_resultJSON, "locations");
    if (!locations) {
        goto end;
    }
    ...
    cJSON_ArrayForEach(locations_local_nonprimitive,locations )
    {
        ...
        response_time_filter_fast_location_t *locationsItem = response_time_filter_fast_location_parseFromJSON(locations_local_nonprimitive);

        list_addElement(locationsList, locationsItem);
    }

    // response_time_filter_fast_result->unreachable
    cJSON *unreachable = cJSON_GetObjectItemCaseSensitive(response_time_filter_fast_resultJSON, "unreachable");
    if (!unreachable) {
        goto end;
    }
    ...
    response_time_filter_fast_result_local_var = response_time_filter_fast_result_create (
