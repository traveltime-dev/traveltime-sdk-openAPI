...
response_time_filter_postcode_district_properties_t *response_time_filter_postcode_district_properties_create(
    ...
    response_time_filter_postcode_district_properties_t *response_time_filter_postcode_district_properties_local_var = malloc(sizeof(response_time_filter_postcode_district_properties_t));
    if (!response_time_filter_postcode_district_properties_local_var) {
        return NULL;
    }
    response_time_filter_postcode_district_properties_local_var->travel_time_reachable = travel_time_reachable;
    response_time_filter_postcode_district_properties_local_var->travel_time_all = travel_time_all;
    response_time_filter_postcode_district_properties_local_var->coverage = coverage;
...
void response_time_filter_postcode_district_properties_free(response_time_filter_postcode_district_properties_t *response_time_filter_postcode_district_properties) {
    if(NULL == response_time_filter_postcode_district_properties){
        return ;
    }
...
cJSON *response_time_filter_postcode_district_properties_convertToJSON(response_time_filter_postcode_district_properties_t *response_time_filter_postcode_district_properties) {
    ...
    if(response_time_filter_postcode_district_properties->travel_time_reachable) { 
    cJSON *travel_time_reachable_local_JSON = response_travel_time_statistics_convertToJSON(response_time_filter_postcode_district_properties->travel_time_reachable);
    ...
    if(response_time_filter_postcode_district_properties->travel_time_all) { 
    cJSON *travel_time_all_local_JSON = response_travel_time_statistics_convertToJSON(response_time_filter_postcode_district_properties->travel_time_all);
    ...
    if(response_time_filter_postcode_district_properties->coverage) { 
...
response_time_filter_postcode_district_properties_t *response_time_filter_postcode_district_properties_parseFromJSON(cJSON *response_time_filter_postcode_district_propertiesJSON){
    ...
    response_time_filter_postcode_district_properties_t *response_time_filter_postcode_district_properties_local_var = NULL;

    // response_time_filter_postcode_district_properties->travel_time_reachable
    cJSON *travel_time_reachable = cJSON_GetObjectItemCaseSensitive(response_time_filter_postcode_district_propertiesJSON, "travel_time_reachable");
    ...
    // response_time_filter_postcode_district_properties->travel_time_all
    cJSON *travel_time_all = cJSON_GetObjectItemCaseSensitive(response_time_filter_postcode_district_propertiesJSON, "travel_time_all");
    ...
    response_time_filter_postcode_district_properties_local_var = response_time_filter_postcode_district_properties_create (
