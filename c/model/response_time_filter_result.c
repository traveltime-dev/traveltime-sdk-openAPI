...
response_time_filter_result_t *response_time_filter_result_create(
	...
	response_time_filter_result_t *response_time_filter_result = malloc(sizeof(response_time_filter_result_t));
	response_time_filter_result->search_id = search_id;
	response_time_filter_result->locations = locations;
	response_time_filter_result->unreachable = unreachable;
...
cJSON *response_time_filter_result_convertToJSON(response_time_filter_result_t *response_time_filter_result) {
	...
	list_ForEach(locationsListEntry, response_time_filter_result->locations) {
		cJSON *item = response_time_filter_location_convertToJSON(locationsListEntry->data);
		if(item == NULL) {
			goto fail;
		}
...
response_time_filter_result_t *response_time_filter_result_parseFromJSON(char *jsonString){
    ...
    cJSON *response_time_filter_resultJSON = cJSON_Parse(jsonString);
    if(response_time_filter_resultJSON == NULL){
    ...
    // response_time_filter_result->locations
    cJSON *locations;
    cJSON *locationsJSON = cJSON_GetObjectItemCaseSensitive(response_time_filter_resultJSON,"locations");
    ...
    cJSON_ArrayForEach(locations,locationsJSON )
    {
        ...
        response_time_filter_location_t *locationsItem = response_time_filter_location_parseFromJSON(JSONData);
    ...
    // response_time_filter_result->unreachable
    cJSON *unreachable;
    cJSON *unreachableJSON = cJSON_GetObjectItemCaseSensitive(response_time_filter_resultJSON, "unreachable");
 ...
 cJSON_Delete(response_time_filter_resultJSON);
    return response_time_filter_result;
end:
    cJSON_Delete(response_time_filter_resultJSON);
    return NULL;
