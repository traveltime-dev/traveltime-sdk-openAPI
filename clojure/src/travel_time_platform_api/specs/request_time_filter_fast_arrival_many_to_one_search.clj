(ns travel-time-platform-api.specs.request-time-filter-fast-arrival-many-to-one-search
...
(def request-time-filter-fast-arrival-many-to-one-search-data
  {
   (ds/req :id) string?
...
(def request-time-filter-fast-arrival-many-to-one-search-spec
  (ds/spec
    {:name ::request-time-filter-fast-arrival-many-to-one-search
     :spec request-time-filter-fast-arrival-many-to-one-search-data}))
