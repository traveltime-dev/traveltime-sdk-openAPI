(ns travel-time-platform-api.specs.request-time-filter-postcode-sectors-arrival-search
...
(def request-time-filter-postcode-sectors-arrival-search-data
  {
   (ds/req :id) string?
...
(def request-time-filter-postcode-sectors-arrival-search-spec
  (ds/spec
    {:name ::request-time-filter-postcode-sectors-arrival-search
     :spec request-time-filter-postcode-sectors-arrival-search-data}))
