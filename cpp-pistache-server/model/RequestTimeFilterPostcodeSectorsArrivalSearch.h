...
public:
    ...
    virtual ~RequestTimeFilterPostcodeSectorsArrivalSearch() = default;
    ...
    bool operator==(const RequestTimeFilterPostcodeSectorsArrivalSearch& rhs) const;
    bool operator!=(const RequestTimeFilterPostcodeSectorsArrivalSearch& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const RequestTimeFilterPostcodeSectorsArrivalSearch& o);
    friend void from_json(const nlohmann::json& j, RequestTimeFilterPostcodeSectorsArrivalSearch& o);
protected:
    std::string m_Id;
