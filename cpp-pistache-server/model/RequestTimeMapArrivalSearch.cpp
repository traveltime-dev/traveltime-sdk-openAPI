...
RequestLevelOfDetail RequestTimeMapArrivalSearch::getLevelOfDetail() const
{
    return m_Level_of_detail;
}
void RequestTimeMapArrivalSearch::setLevelOfDetail(RequestLevelOfDetail const& value)
{
    m_Level_of_detail = value;
    m_Level_of_detailIsSet = true;
}
bool RequestTimeMapArrivalSearch::levelOfDetailIsSet() const
{
    return m_Level_of_detailIsSet;
}
void RequestTimeMapArrivalSearch::unsetLevel_of_detail()
{
    m_Level_of_detailIsSet = false;
}
