...
nlohmann::json ResponseTimeFilterPostcodeDistricts::toJson() const
{
...
void ResponseTimeFilterPostcodeDistricts::fromJson(const nlohmann::json& val)
{
    {
        m_Results.clear();
                    for( auto& item : val["results"] )
            {
                ...
                if(item.is_null())
                {
                    m_Results.push_back( ResponseTimeFilterPostcodeDistrictsResult() );
                }
                else
                {
                    ResponseTimeFilterPostcodeDistrictsResult newItem;
