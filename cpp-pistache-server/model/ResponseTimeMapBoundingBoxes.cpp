...
nlohmann::json ResponseTimeMapBoundingBoxes::toJson() const
{
...
void ResponseTimeMapBoundingBoxes::fromJson(const nlohmann::json& val)
{
    {
        m_Results.clear();
                    for( auto& item : val["results"] )
            {
                ...
                if(item.is_null())
                {
                    m_Results.push_back( ResponseTimeMapBoundingBoxesResult() );
                }
                else
                {
                    ResponseTimeMapBoundingBoxesResult newItem;
