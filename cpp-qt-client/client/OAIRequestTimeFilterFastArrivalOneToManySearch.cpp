...
void OAIRequestTimeFilterFastArrivalOneToManySearch::initializeModel() {
...
void OAIRequestTimeFilterFastArrivalOneToManySearch::fromJson(QString jsonString) {
...
void OAIRequestTimeFilterFastArrivalOneToManySearch::fromJsonObject(QJsonObject json) {
...
QString OAIRequestTimeFilterFastArrivalOneToManySearch::asJson() const {
...
QJsonObject OAIRequestTimeFilterFastArrivalOneToManySearch::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIRequestTimeFilterFastArrivalOneToManySearch::getId() const {
    return id;
}
void OAIRequestTimeFilterFastArrivalOneToManySearch::setId(const QString &id) {
    this->id = id;
    this->m_id_isSet = true;
}

bool OAIRequestTimeFilterFastArrivalOneToManySearch::is_id_Set() const{
    return m_id_isSet;
}

bool OAIRequestTimeFilterFastArrivalOneToManySearch::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIRequestTimeFilterFastArrivalOneToManySearch::getDepartureLocationId() const {
    return departure_location_id;
}
void OAIRequestTimeFilterFastArrivalOneToManySearch::setDepartureLocationId(const QString &departure_location_id) {
    this->departure_location_id = departure_location_id;
    this->m_departure_location_id_isSet = true;
}

bool OAIRequestTimeFilterFastArrivalOneToManySearch::is_departure_location_id_Set() const{
    return m_departure_location_id_isSet;
}

bool OAIRequestTimeFilterFastArrivalOneToManySearch::is_departure_location_id_Valid() const{
    return m_departure_location_id_isValid;
}

QList<QString> OAIRequestTimeFilterFastArrivalOneToManySearch::getArrivalLocationIds() const {
    return arrival_location_ids;
}
void OAIRequestTimeFilterFastArrivalOneToManySearch::setArrivalLocationIds(const QList<QString> &arrival_location_ids) {
    this->arrival_location_ids = arrival_location_ids;
    this->m_arrival_location_ids_isSet = true;
}

bool OAIRequestTimeFilterFastArrivalOneToManySearch::is_arrival_location_ids_Set() const{
    return m_arrival_location_ids_isSet;
}

bool OAIRequestTimeFilterFastArrivalOneToManySearch::is_arrival_location_ids_Valid() const{
    return m_arrival_location_ids_isValid;
}

OAIRequestTransportationFast OAIRequestTimeFilterFastArrivalOneToManySearch::getTransportation() const {
    return transportation;
}
void OAIRequestTimeFilterFastArrivalOneToManySearch::setTransportation(const OAIRequestTransportationFast &transportation) {
    this->transportation = transportation;
    this->m_transportation_isSet = true;
}

bool OAIRequestTimeFilterFastArrivalOneToManySearch::is_transportation_Set() const{
    return m_transportation_isSet;
}

bool OAIRequestTimeFilterFastArrivalOneToManySearch::is_transportation_Valid() const{
    return m_transportation_isValid;
}

qint32 OAIRequestTimeFilterFastArrivalOneToManySearch::getTravelTime() const {
    return travel_time;
}
void OAIRequestTimeFilterFastArrivalOneToManySearch::setTravelTime(const qint32 &travel_time) {
    this->travel_time = travel_time;
    this->m_travel_time_isSet = true;
}

bool OAIRequestTimeFilterFastArrivalOneToManySearch::is_travel_time_Set() const{
    return m_travel_time_isSet;
}

bool OAIRequestTimeFilterFastArrivalOneToManySearch::is_travel_time_Valid() const{
    return m_travel_time_isValid;
}

OAIRequestArrivalTimePeriod OAIRequestTimeFilterFastArrivalOneToManySearch::getArrivalTimePeriod() const {
    return arrival_time_period;
}
void OAIRequestTimeFilterFastArrivalOneToManySearch::setArrivalTimePeriod(const OAIRequestArrivalTimePeriod &arrival_time_period) {
    this->arrival_time_period = arrival_time_period;
    this->m_arrival_time_period_isSet = true;
}

bool OAIRequestTimeFilterFastArrivalOneToManySearch::is_arrival_time_period_Set() const{
    return m_arrival_time_period_isSet;
}

bool OAIRequestTimeFilterFastArrivalOneToManySearch::is_arrival_time_period_Valid() const{
    return m_arrival_time_period_isValid;
}

QList<OAIRequestTimeFilterFastProperty> OAIRequestTimeFilterFastArrivalOneToManySearch::getProperties() const {
    return properties;
}
void OAIRequestTimeFilterFastArrivalOneToManySearch::setProperties(const QList<OAIRequestTimeFilterFastProperty> &properties) {
    this->properties = properties;
    this->m_properties_isSet = true;
}

bool OAIRequestTimeFilterFastArrivalOneToManySearch::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIRequestTimeFilterFastArrivalOneToManySearch::is_properties_Valid() const{
    return m_properties_isValid;
}

bool OAIRequestTimeFilterFastArrivalOneToManySearch::isSet() const {
...
bool OAIRequestTimeFilterFastArrivalOneToManySearch::isValid() const {
