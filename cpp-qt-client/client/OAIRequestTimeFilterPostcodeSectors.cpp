...
void OAIRequestTimeFilterPostcodeSectors::initializeModel() {
...
void OAIRequestTimeFilterPostcodeSectors::fromJson(QString jsonString) {
...
void OAIRequestTimeFilterPostcodeSectors::fromJsonObject(QJsonObject json) {
...
QString OAIRequestTimeFilterPostcodeSectors::asJson() const {
...
QJsonObject OAIRequestTimeFilterPostcodeSectors::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIRequestTimeFilterPostcodeSectorsDepartureSearch> OAIRequestTimeFilterPostcodeSectors::getDepartureSearches() const {
    return departure_searches;
}
void OAIRequestTimeFilterPostcodeSectors::setDepartureSearches(const QList<OAIRequestTimeFilterPostcodeSectorsDepartureSearch> &departure_searches) {
    this->departure_searches = departure_searches;
    this->m_departure_searches_isSet = true;
}

bool OAIRequestTimeFilterPostcodeSectors::is_departure_searches_Set() const{
    return m_departure_searches_isSet;
}

bool OAIRequestTimeFilterPostcodeSectors::is_departure_searches_Valid() const{
    return m_departure_searches_isValid;
}

QList<OAIRequestTimeFilterPostcodeSectorsArrivalSearch> OAIRequestTimeFilterPostcodeSectors::getArrivalSearches() const {
    return arrival_searches;
}
void OAIRequestTimeFilterPostcodeSectors::setArrivalSearches(const QList<OAIRequestTimeFilterPostcodeSectorsArrivalSearch> &arrival_searches) {
    this->arrival_searches = arrival_searches;
    this->m_arrival_searches_isSet = true;
}

bool OAIRequestTimeFilterPostcodeSectors::is_arrival_searches_Set() const{
    return m_arrival_searches_isSet;
}

bool OAIRequestTimeFilterPostcodeSectors::is_arrival_searches_Valid() const{
    return m_arrival_searches_isValid;
}

bool OAIRequestTimeFilterPostcodeSectors::isSet() const {
...
bool OAIRequestTimeFilterPostcodeSectors::isValid() const {
