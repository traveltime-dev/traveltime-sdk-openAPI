...
OAIRequestLevelOfDetail OAIRequestTimeMapArrivalSearch::getLevelOfDetail() const {
    return level_of_detail;
}
void OAIRequestTimeMapArrivalSearch::setLevelOfDetail(const OAIRequestLevelOfDetail &level_of_detail) {
    this->level_of_detail = level_of_detail;
    this->m_level_of_detail_isSet = true;
}

bool OAIRequestTimeMapArrivalSearch::is_level_of_detail_Set() const{
    return m_level_of_detail_isSet;
}

bool OAIRequestTimeMapArrivalSearch::is_level_of_detail_Valid() const{
