...
void OAIRequestTimeMapDepartureSearch::initializeModel() {
    ...
    m_level_of_detail_isSet = false;
    m_level_of_detail_isValid = false;
}
...
void OAIRequestTimeMapDepartureSearch::fromJsonObject(QJsonObject json) {
    ...
    m_level_of_detail_isValid = ::OpenAPI::fromJsonValue(level_of_detail, json[QString("level_of_detail")]);
    m_level_of_detail_isSet = !json[QString("level_of_detail")].isNull() && m_level_of_detail_isValid;
}
...
QJsonObject OAIRequestTimeMapDepartureSearch::asJsonObject() const {
    ...
    if (level_of_detail.isSet()) {
        obj.insert(QString("level_of_detail"), ::OpenAPI::toJsonValue(level_of_detail));
    }
    return obj;
}
...
OAIRequestLevelOfDetail OAIRequestTimeMapDepartureSearch::getLevelOfDetail() const {
    return level_of_detail;
}
void OAIRequestTimeMapDepartureSearch::setLevelOfDetail(const OAIRequestLevelOfDetail &level_of_detail) {
    this->level_of_detail = level_of_detail;
    this->m_level_of_detail_isSet = true;
}

bool OAIRequestTimeMapDepartureSearch::is_level_of_detail_Set() const{
    return m_level_of_detail_isSet;
}

bool OAIRequestTimeMapDepartureSearch::is_level_of_detail_Valid() const{
    return m_level_of_detail_isValid;
}
