...
void
OAIRequestTimeFilterPostcodeDistrictsProperty::fromJsonValue(QJsonValue json) {
...
QJsonValue
OAIRequestTimeFilterPostcodeDistrictsProperty::asJsonValue() const {
...
bool
OAIRequestTimeFilterPostcodeDistrictsProperty::isValid() const {
