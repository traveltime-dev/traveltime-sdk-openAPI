...
void
OAIRequestTimeFilterPostcodeSectorsProperty::fromJsonValue(QJsonValue json) {
...
QJsonValue
OAIRequestTimeFilterPostcodeSectorsProperty::asJsonValue() const {
...
bool
OAIRequestTimeFilterPostcodeSectorsProperty::isValid() const {
