...
void
OAIResponseTimeFilterFastProperties::fromJson(QString jsonString) {
...
void
OAIResponseTimeFilterFastProperties::fromJsonObject(QJsonObject json) {
...
QString
OAIResponseTimeFilterFastProperties::asJson () const {
...
QJsonObject
OAIResponseTimeFilterFastProperties::asJsonObject() const {
    QJsonObject obj;
...
qint32
OAIResponseTimeFilterFastProperties::getTravelTime() const {
    return travel_time;
}
void
OAIResponseTimeFilterFastProperties::setTravelTime(const qint32 &travel_time) {
...
OAIResponseTimeFilterFastProperties::getFares() const {
    return fares;
}
void
OAIResponseTimeFilterFastProperties::setFares(const OAIResponseFaresFast &fares) {
    this->fares = fares;
    this->m_fares_isSet = true;
}

bool
OAIResponseTimeFilterFastProperties::isSet() const {
...
bool
OAIResponseTimeFilterFastProperties::isValid() const {
