...
bool OAIResponseTimeFilterFastProperties::is_travel_time_Set() const{
    return m_travel_time_isSet;
}

bool OAIResponseTimeFilterFastProperties::is_travel_time_Valid() const{
...
bool OAIResponseTimeFilterFastProperties::is_fares_Set() const{
    return m_fares_isSet;
}

bool OAIResponseTimeFilterFastProperties::is_fares_Valid() const{
