...
OAIResponseError::fromJsonObject(QJsonObject json) {
    ::OpenAPI::fromJsonValue(http_status, json[QString("http_status")]);
    
    ::OpenAPI::fromJsonValue(error_code, json[QString("error_code")]);
    
    ::OpenAPI::fromJsonValue(description, json[QString("description")]);
    
    ::OpenAPI::fromJsonValue(documentation_link, json[QString("documentation_link")]);
