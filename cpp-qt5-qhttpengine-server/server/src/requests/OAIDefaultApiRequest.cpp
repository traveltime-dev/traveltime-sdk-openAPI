...
void OAIDefaultApiRequest::geocodingReverseSearchRequest(){
    ...
    connect(this, &OAIDefaultApiRequest::geocodingReverseSearch, handler, &OAIDefaultApiHandler::geocodingReverseSearch);
...
void OAIDefaultApiRequest::geocodingSearchRequest(){
    ...
    connect(this, &OAIDefaultApiRequest::geocodingSearch, handler, &OAIDefaultApiHandler::geocodingSearch);
...
void OAIDefaultApiRequest::mapInfoRequest(){
    qDebug() << "/v4/map-info";
    connect(this, &OAIDefaultApiRequest::mapInfo, handler, &OAIDefaultApiHandler::mapInfo);
...
void OAIDefaultApiRequest::routesRequest(){
    qDebug() << "/v4/routes";
    connect(this, &OAIDefaultApiRequest::routes, handler, &OAIDefaultApiHandler::routes);
...
void OAIDefaultApiRequest::supportedLocationsRequest(){
    ...
    connect(this, &OAIDefaultApiRequest::supportedLocations, handler, &OAIDefaultApiHandler::supportedLocations);
...
void OAIDefaultApiRequest::timeFilterRequest(){
    ...
    connect(this, &OAIDefaultApiRequest::timeFilter, handler, &OAIDefaultApiHandler::timeFilter);
...
void OAIDefaultApiRequest::timeFilterFastRequest(){
    ...
    connect(this, &OAIDefaultApiRequest::timeFilterFast, handler, &OAIDefaultApiHandler::timeFilterFast);
...
void OAIDefaultApiRequest::timeFilterPostcodeDistrictsRequest(){
    ...
    connect(this, &OAIDefaultApiRequest::timeFilterPostcodeDistricts, handler, &OAIDefaultApiHandler::timeFilterPostcodeDistricts);
...
void OAIDefaultApiRequest::timeFilterPostcodeSectorsRequest(){
    ...
    connect(this, &OAIDefaultApiRequest::timeFilterPostcodeSectors, handler, &OAIDefaultApiHandler::timeFilterPostcodeSectors);
...
void OAIDefaultApiRequest::timeFilterPostcodesRequest(){
    ...
    connect(this, &OAIDefaultApiRequest::timeFilterPostcodes, handler, &OAIDefaultApiHandler::timeFilterPostcodes);
...
void OAIDefaultApiRequest::timeMapRequest(){
    qDebug() << "/v4/time-map";
    connect(this, &OAIDefaultApiRequest::timeMap, handler, &OAIDefaultApiHandler::timeMap);
