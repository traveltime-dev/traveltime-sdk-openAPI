...
void
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::cleanup() {
    if(id != nullptr) { 
        delete id;
    }
...
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::fromJson(QString json) {
...
void
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::fromJsonObject(QJsonObject pJson) {
...
QString
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::asJson ()
{
...
QJsonObject
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::asJsonObject() {
    QJsonObject obj;
...
QString*
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::getId() {
    return id;
}
void
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::setId(QString* id) {
    this->id = id;
    this->m_id_isSet = true;
}

OAIRequestTransportation*
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::getTransportation() {
    return transportation;
}
void
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::setTransportation(OAIRequestTransportation* transportation) {
    this->transportation = transportation;
    this->m_transportation_isSet = true;
}

qint32
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::getTravelTime() {
    return travel_time;
}
void
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::setTravelTime(qint32 travel_time) {
    this->travel_time = travel_time;
    this->m_travel_time_isSet = true;
}

QDateTime*
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::getDepartureTime() {
    return departure_time;
}
void
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::setDepartureTime(QDateTime* departure_time) {
    this->departure_time = departure_time;
    this->m_departure_time_isSet = true;
}

double
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::getReachablePostcodesThreshold() {
    return reachable_postcodes_threshold;
}
void
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::setReachablePostcodesThreshold(double reachable_postcodes_threshold) {
...
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::getProperties() {
    return properties;
}
void
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::setProperties(QList<OAIRequestTimeFilterPostcodeSectorsProperty*>* properties) {
    this->properties = properties;
    this->m_properties_isSet = true;
}

OAIRequestRangeFull*
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::getRange() {
    return range;
}
void
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::setRange(OAIRequestRangeFull* range) {
    this->range = range;
...
bool
OAIRequestTimeFilterPostcodeSectorsDepartureSearch::isSet(){
