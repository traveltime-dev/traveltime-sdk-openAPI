...
std::string RequestTimeFilterDepartureSearch::toJsonString(bool prettyJson)
{
	std::stringstream ss;
...
ptree RequestTimeFilterDepartureSearch::toPropertyTree()
{
	ptree pt;
	ptree tmp_node;
	pt.put("id", m_Id);
...
void RequestTimeFilterDepartureSearch::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	m_Id = pt.get("id", "");
