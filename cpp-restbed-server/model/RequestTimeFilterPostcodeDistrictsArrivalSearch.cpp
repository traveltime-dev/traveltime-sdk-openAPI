...
std::string RequestTimeFilterPostcodeDistrictsArrivalSearch::toJsonString(bool prettyJson)
{
	std::stringstream ss;
...
ptree RequestTimeFilterPostcodeDistrictsArrivalSearch::toPropertyTree()
{
	ptree pt;
	ptree tmp_node;
	pt.put("id", m_Id);
...
void RequestTimeFilterPostcodeDistrictsArrivalSearch::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	m_Id = pt.get("id", "");
