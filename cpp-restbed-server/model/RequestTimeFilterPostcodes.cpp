...
std::string RequestTimeFilterPostcodes::toJsonString(bool prettyJson)
{
	std::stringstream ss;
...
ptree RequestTimeFilterPostcodes::toPropertyTree()
{
	ptree pt;
	ptree tmp_node;
...
void RequestTimeFilterPostcodes::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
