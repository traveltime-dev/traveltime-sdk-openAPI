...
std::string ResponseTimeFilterLocation::toJsonString(bool prettyJson)
{
	std::stringstream ss;
...
ptree ResponseTimeFilterLocation::toPropertyTree()
{
	ptree pt;
	ptree tmp_node;
	pt.put("id", m_Id);
...
void ResponseTimeFilterLocation::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	m_Id = pt.get("id", "");
