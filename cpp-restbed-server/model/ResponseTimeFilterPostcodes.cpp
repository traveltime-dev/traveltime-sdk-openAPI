...
std::string ResponseTimeFilterPostcodes::toJsonString(bool prettyJson)
{
	std::stringstream ss;
...
void ResponseTimeFilterPostcodes::fromJsonString(std::string const& jsonString)
{
...
ptree ResponseTimeFilterPostcodes::toPropertyTree()
{
	ptree pt;
	ptree tmp_node;
...
void ResponseTimeFilterPostcodes::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
...
std::vector<std::shared_ptr<ResponseTimeFilterPostcodesResult>> ResponseTimeFilterPostcodes::getResults() const
{
    return m_Results;
}
void ResponseTimeFilterPostcodes::setResults(std::vector<std::shared_ptr<ResponseTimeFilterPostcodesResult>> value)
{
	m_Results = value;
}
