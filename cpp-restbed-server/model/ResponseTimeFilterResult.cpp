...
std::string ResponseTimeFilterResult::toJsonString(bool prettyJson)
{
	std::stringstream ss;
...
ptree ResponseTimeFilterResult::toPropertyTree()
{
	ptree pt;
	ptree tmp_node;
...
void ResponseTimeFilterResult::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
