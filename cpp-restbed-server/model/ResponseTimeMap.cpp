...
std::string ResponseTimeMap::toJsonString(bool prettyJson)
{
	std::stringstream ss;
...
void ResponseTimeMap::fromJsonString(std::string const& jsonString)
{
...
ptree ResponseTimeMap::toPropertyTree()
{
	ptree pt;
	ptree tmp_node;
...
void ResponseTimeMap::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
...
std::vector<std::shared_ptr<ResponseTimeMapResult>> ResponseTimeMap::getResults() const
{
    return m_Results;
}
void ResponseTimeMap::setResults(std::vector<std::shared_ptr<ResponseTimeMapResult>> value)
{
	m_Results = value;
}
