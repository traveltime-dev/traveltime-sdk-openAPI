...
bool RequestTimeFilterPostcodeDistrictsArrivalSearch::fromJson(const web::json::value& val)
{
    bool ok = true;
...
bool RequestTimeFilterPostcodeDistrictsArrivalSearch::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
bool RequestTimeFilterPostcodeDistrictsArrivalSearch::idIsSet() const
{
    return m_IdIsSet;
}

void RequestTimeFilterPostcodeDistrictsArrivalSearch::unsetId()
{
    m_IdIsSet = false;
}
...
bool RequestTimeFilterPostcodeDistrictsArrivalSearch::transportationIsSet() const
{
    return m_TransportationIsSet;
}

void RequestTimeFilterPostcodeDistrictsArrivalSearch::unsetTransportation()
{
    m_TransportationIsSet = false;
}
...
bool RequestTimeFilterPostcodeDistrictsArrivalSearch::travelTimeIsSet() const
{
    return m_Travel_timeIsSet;
}

void RequestTimeFilterPostcodeDistrictsArrivalSearch::unsetTravel_time()
{
    m_Travel_timeIsSet = false;
}
...
bool RequestTimeFilterPostcodeDistrictsArrivalSearch::arrivalTimeIsSet() const
{
    return m_Arrival_timeIsSet;
}

void RequestTimeFilterPostcodeDistrictsArrivalSearch::unsetArrival_time()
{
    m_Arrival_timeIsSet = false;
}
...
bool RequestTimeFilterPostcodeDistrictsArrivalSearch::reachablePostcodesThresholdIsSet() const
{
    return m_Reachable_postcodes_thresholdIsSet;
}

void RequestTimeFilterPostcodeDistrictsArrivalSearch::unsetReachable_postcodes_threshold()
{
    m_Reachable_postcodes_thresholdIsSet = false;
}
...
bool RequestTimeFilterPostcodeDistrictsArrivalSearch::propertiesIsSet() const
{
    return m_PropertiesIsSet;
}

void RequestTimeFilterPostcodeDistrictsArrivalSearch::unsetProperties()
{
    m_PropertiesIsSet = false;
}
