...
bool RequestTimeMapArrivalSearch::fromJson(const web::json::value& val)
{
    bool ok = true;
...
bool RequestTimeMapArrivalSearch::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
bool RequestTimeMapArrivalSearch::idIsSet() const
{
    return m_IdIsSet;
}

void RequestTimeMapArrivalSearch::unsetId()
{
    m_IdIsSet = false;
}
...
bool RequestTimeMapArrivalSearch::coordsIsSet() const
{
    return m_CoordsIsSet;
}

void RequestTimeMapArrivalSearch::unsetCoords()
{
    m_CoordsIsSet = false;
}
...
bool RequestTimeMapArrivalSearch::transportationIsSet() const
{
    return m_TransportationIsSet;
}

void RequestTimeMapArrivalSearch::unsetTransportation()
{
    m_TransportationIsSet = false;
}
...
bool RequestTimeMapArrivalSearch::travelTimeIsSet() const
{
    return m_Travel_timeIsSet;
}

void RequestTimeMapArrivalSearch::unsetTravel_time()
{
    m_Travel_timeIsSet = false;
}
...
bool RequestTimeMapArrivalSearch::arrivalTimeIsSet() const
{
    return m_Arrival_timeIsSet;
}

void RequestTimeMapArrivalSearch::unsetArrival_time()
{
    m_Arrival_timeIsSet = false;
}
...
void RequestTimeMapArrivalSearch::setLevelOfDetail(const std::shared_ptr<RequestLevelOfDetail>& value)
{
