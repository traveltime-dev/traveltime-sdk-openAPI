...
#ifndef _RequestRoutesDepartureSearch_H_
#define _RequestRoutesDepartureSearch_H_
...
class RequestRoutesDepartureSearch : public Object {
public:
	/*! \brief Constructor.
	 */
	RequestRoutesDepartureSearch();
	RequestRoutesDepartureSearch(char* str);
...
#endif /* _RequestRoutesDepartureSearch_H_ */
