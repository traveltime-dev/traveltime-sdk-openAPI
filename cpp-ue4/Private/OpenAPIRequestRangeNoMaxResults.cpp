...
void OpenAPIRequestRangeNoMaxResults::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRequestRangeNoMaxResults::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
