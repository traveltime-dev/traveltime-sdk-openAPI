...
void OpenAPIRequestTimeFilterPostcodeDistrictsArrivalSearch::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRequestTimeFilterPostcodeDistrictsArrivalSearch::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
