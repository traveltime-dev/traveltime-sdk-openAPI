...
void OpenAPIRequestTimeFilterPostcodeDistrictsDepartureSearch::WriteJson(JsonWriter& Writer) const
{
	...
	Writer->WriteIdentifierPrefix(TEXT("reachable_postcodes_threshold")); WriteJsonValue(Writer, ReachablePostcodesThreshold);
...
bool OpenAPIRequestTimeFilterPostcodeDistrictsDepartureSearch::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("reachable_postcodes_threshold"), ReachablePostcodesThreshold);
