...
void OpenAPIRequestTimeFilterPostcodeSectors::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRequestTimeFilterPostcodeSectors::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
