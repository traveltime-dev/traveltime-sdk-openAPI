...
void OpenAPIRequestTimeFilterPostcodeSectorsArrivalSearch::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRequestTimeFilterPostcodeSectorsArrivalSearch::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
