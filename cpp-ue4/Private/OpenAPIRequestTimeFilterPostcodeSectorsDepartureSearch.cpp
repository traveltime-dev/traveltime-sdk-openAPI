...
void OpenAPIRequestTimeFilterPostcodeSectorsDepartureSearch::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRequestTimeFilterPostcodeSectorsDepartureSearch::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
