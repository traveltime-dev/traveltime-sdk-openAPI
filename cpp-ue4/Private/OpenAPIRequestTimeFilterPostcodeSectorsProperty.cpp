...
FString OpenAPIRequestTimeFilterPostcodeSectorsProperty::EnumToString(const OpenAPIRequestTimeFilterPostcodeSectorsProperty::Values& EnumValue)
{
	return ToString(EnumValue);
}

inline bool FromString(const FString& EnumAsString, OpenAPIRequestTimeFilterPostcodeSectorsProperty::Values& Value)
{
...
bool OpenAPIRequestTimeFilterPostcodeSectorsProperty::EnumFromString(const FString& EnumAsString, OpenAPIRequestTimeFilterPostcodeSectorsProperty::Values& EnumValue)
{
