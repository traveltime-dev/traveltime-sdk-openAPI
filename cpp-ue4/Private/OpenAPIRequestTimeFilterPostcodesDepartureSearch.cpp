...
void OpenAPIRequestTimeFilterPostcodesDepartureSearch::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRequestTimeFilterPostcodesDepartureSearch::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
