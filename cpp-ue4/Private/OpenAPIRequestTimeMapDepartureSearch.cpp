...
void OpenAPIRequestTimeMapDepartureSearch::WriteJson(JsonWriter& Writer) const
{
	...
	if (LevelOfDetail.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("level_of_detail")); WriteJsonValue(Writer, LevelOfDetail.GetValue());	
	}
...
bool OpenAPIRequestTimeMapDepartureSearch::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("level_of_detail"), LevelOfDetail);
