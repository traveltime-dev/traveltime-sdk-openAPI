...
FString OpenAPIRequestTransportationFast::EnumToString(const OpenAPIRequestTransportationFast::TypeEnum& EnumValue)
{
	return ToString(EnumValue);
}

inline bool FromString(const FString& EnumAsString, OpenAPIRequestTransportationFast::TypeEnum& Value)
{
...
bool OpenAPIRequestTransportationFast::EnumFromString(const FString& EnumAsString, OpenAPIRequestTransportationFast::TypeEnum& EnumValue)
{
