...
void OpenAPIResponseRoutesProperties::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIResponseRoutesProperties::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
