...
void OpenAPIResponseTimeFilterFastLocation::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIResponseTimeFilterFastLocation::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
