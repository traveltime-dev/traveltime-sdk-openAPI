...
void OpenAPIResponseTimeFilterFastResult::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIResponseTimeFilterFastResult::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
