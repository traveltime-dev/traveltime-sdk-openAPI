...
void OpenAPIResponseTimeFilterPostcode::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIResponseTimeFilterPostcode::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
