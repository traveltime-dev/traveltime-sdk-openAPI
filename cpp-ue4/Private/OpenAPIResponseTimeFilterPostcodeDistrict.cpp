...
void OpenAPIResponseTimeFilterPostcodeDistrict::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIResponseTimeFilterPostcodeDistrict::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
