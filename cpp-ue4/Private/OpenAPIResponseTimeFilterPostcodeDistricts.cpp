...
void OpenAPIResponseTimeFilterPostcodeDistricts::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIResponseTimeFilterPostcodeDistricts::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
