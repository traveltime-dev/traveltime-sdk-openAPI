...
void OpenAPIResponseTimeFilterPostcodeSector::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIResponseTimeFilterPostcodeSector::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
