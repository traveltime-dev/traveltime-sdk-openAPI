...
void OpenAPIResponseTimeFilterPostcodes::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIResponseTimeFilterPostcodes::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
