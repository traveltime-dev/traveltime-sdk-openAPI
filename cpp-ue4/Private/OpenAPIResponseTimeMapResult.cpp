...
void OpenAPIResponseTimeMapResult::WriteJson(JsonWriter& Writer) const
{
	Writer->WriteObjectStart();
	Writer->WriteIdentifierPrefix(TEXT("search_id")); WriteJsonValue(Writer, SearchId);
	Writer->WriteIdentifierPrefix(TEXT("shapes")); WriteJsonValue(Writer, Shapes);
	Writer->WriteIdentifierPrefix(TEXT("properties")); WriteJsonValue(Writer, Properties);
	Writer->WriteObjectEnd();
}

bool OpenAPIResponseTimeMapResult::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("shapes"), Shapes);
