...
FString OpenAPIResponseTransportationMode::EnumToString(const OpenAPIResponseTransportationMode::Values& EnumValue)
{
	return ToString(EnumValue);
}

inline bool FromString(const FString& EnumAsString, OpenAPIResponseTransportationMode::Values& Value)
{
...
bool OpenAPIResponseTransportationMode::EnumFromString(const FString& EnumAsString, OpenAPIResponseTransportationMode::Values& EnumValue)
{
