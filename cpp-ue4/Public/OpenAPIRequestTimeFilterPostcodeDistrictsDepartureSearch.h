...
/*
 * OpenAPIRequestTimeFilterPostcodeDistrictsDepartureSearch
 *
 * 
 */
class OPENAPI_API OpenAPIRequestTimeFilterPostcodeDistrictsDepartureSearch : public Model
{
public:
    virtual ~OpenAPIRequestTimeFilterPostcodeDistrictsDepartureSearch() {}
