...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IDefaultApi
    {
        ...
        ResponseGeocoding GeocodingReverseSearch (double? lat, double? lng, string withinCountry);
        /// <summary>
        ///  
        /// </summary>
        ...
        /// <param name="withinCountry"></param>
        /// <returns>ResponseGeocoding</returns>
        ResponseGeocoding GeocodingSearch (string query, double? focusLat, double? focusLng, string withinCountry);
        /// <summary>
        ///  
        /// </summary>
    ...
    public class DefaultApi : IDefaultApi
    {
        ...
        public ResponseGeocoding GeocodingReverseSearch (double? lat, double? lng, string withinCountry)
        {
            ...
            if (lat == null) throw new ApiException(400, "Missing required parameter 'lat' when calling GeocodingReverseSearch");
            
            // verify the required parameter 'lng' is set
            if (lng == null) throw new ApiException(400, "Missing required parameter 'lng' when calling GeocodingReverseSearch");
