...
{ 
    ...
    public interface DefaultService
    {
        ...
        ResponseGeocoding GeocodingReverseSearch(NancyContext context, double? lat, double? lng, string withinCountry);
        ...
        /// <param name="withinCountry"> (optional)</param>
        /// <returns>ResponseGeocoding</returns>
        ResponseGeocoding GeocodingSearch(NancyContext context, string query, double? focusLat, double? focusLng, string withinCountry);
    ...
    {
        public virtual ResponseGeocoding GeocodingReverseSearch(NancyContext context, double? lat, double? lng, string withinCountry)
        {
            return GeocodingReverseSearch(lat, lng, withinCountry);
        }

        public virtual ResponseGeocoding GeocodingSearch(NancyContext context, string query, double? focusLat, double? focusLng, string withinCountry)
        {
            return GeocodingSearch(query, focusLat, focusLng, withinCountry);
        }
        ...
        protected abstract ResponseGeocoding GeocodingReverseSearch(double? lat, double? lng, string withinCountry);

        protected abstract ResponseGeocoding GeocodingSearch(string query, double? focusLat, double? focusLng, string withinCountry);
