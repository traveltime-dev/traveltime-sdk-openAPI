...
namespace Org.OpenAPITools.Test
{
    ...
    public class DefaultApiTests : IDisposable
    {
        ...
        public void GeocodingReverseSearchTest()
        {
            ...
            //Assert.IsType<ResponseGeocoding> (response, "response is ResponseGeocoding");
        }
        ...
        public void MapInfoTest()
        {
            ...
            //Assert.IsType<ResponseMapInfo> (response, "response is ResponseMapInfo");
        }
        ...
        public void RoutesTest()
        {
            ...
            //Assert.IsType<ResponseRoutes> (response, "response is ResponseRoutes");
        }
        ...
        public void SupportedLocationsTest()
        {
            ...
            //Assert.IsType<ResponseSupportedLocations> (response, "response is ResponseSupportedLocations");
        }
        ...
        public void TimeFilterTest()
        {
            ...
            //Assert.IsType<ResponseTimeFilter> (response, "response is ResponseTimeFilter");
        }
        ...
        public void TimeFilterFastTest()
        {
            ...
            //Assert.IsType<ResponseTimeFilterFast> (response, "response is ResponseTimeFilterFast");
        }
        ...
        public void TimeFilterPostcodeDistrictsTest()
        {
            ...
            //Assert.IsType<ResponseTimeFilterPostcodeDistricts> (response, "response is ResponseTimeFilterPostcodeDistricts");
        }
        ...
        public void TimeFilterPostcodeSectorsTest()
        {
            ...
            //Assert.IsType<ResponseTimeFilterPostcodeSectors> (response, "response is ResponseTimeFilterPostcodeSectors");
        }
        ...
        public void TimeFilterPostcodesTest()
        {
            ...
            //Assert.IsType<ResponseTimeFilterPostcodes> (response, "response is ResponseTimeFilterPostcodes");
        }
        ...
        public void TimeMapTest()
        {
            ...
            //Assert.IsType<ResponseTimeMap> (response, "response is ResponseTimeMap");
        }
