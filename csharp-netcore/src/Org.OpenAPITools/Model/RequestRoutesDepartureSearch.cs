...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RequestRoutesDepartureSearch")]
    public partial class RequestRoutesDepartureSearch : IEquatable<RequestRoutesDepartureSearch>, IValidatableObject
    {
        ...
        public RequestRoutesDepartureSearch(string id = default(string), string departureLocationId = default(string), List<string> arrivalLocationIds = default(List<string>), RequestTransportation transportation = default(RequestTransportation), DateTime departureTime = default(DateTime), List<RequestRoutesProperty> properties = default(List<RequestRoutesProperty>), RequestRangeFull range = default(RequestRangeFull))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for RequestRoutesDepartureSearch and cannot be null");
            // to ensure "departureLocationId" is required (not null)
            this.DepartureLocationId = departureLocationId ?? throw new ArgumentNullException("departureLocationId is a required property for RequestRoutesDepartureSearch and cannot be null");
            // to ensure "arrivalLocationIds" is required (not null)
            this.ArrivalLocationIds = arrivalLocationIds ?? throw new ArgumentNullException("arrivalLocationIds is a required property for RequestRoutesDepartureSearch and cannot be null");
            // to ensure "transportation" is required (not null)
            this.Transportation = transportation ?? throw new ArgumentNullException("transportation is a required property for RequestRoutesDepartureSearch and cannot be null");
            this.DepartureTime = departureTime;
            // to ensure "properties" is required (not null)
            this.Properties = properties ?? throw new ArgumentNullException("properties is a required property for RequestRoutesDepartureSearch and cannot be null");
            this.Range = range;
        }
