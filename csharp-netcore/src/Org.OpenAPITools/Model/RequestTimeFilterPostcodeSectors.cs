...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RequestTimeFilterPostcodeSectors")]
    public partial class RequestTimeFilterPostcodeSectors : IEquatable<RequestTimeFilterPostcodeSectors>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestTimeFilterPostcodeSectors" /> class.
        /// </summary>
        /// <param name="departureSearches">departureSearches.</param>
        /// <param name="arrivalSearches">arrivalSearches.</param>
        public RequestTimeFilterPostcodeSectors(List<RequestTimeFilterPostcodeSectorsDepartureSearch> departureSearches = default(List<RequestTimeFilterPostcodeSectorsDepartureSearch>), List<RequestTimeFilterPostcodeSectorsArrivalSearch> arrivalSearches = default(List<RequestTimeFilterPostcodeSectorsArrivalSearch>))
        {
        ...
        {
            return this.Equals(input as RequestTimeFilterPostcodeSectors);
        }

        /// <summary>
        /// Returns true if RequestTimeFilterPostcodeSectors instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestTimeFilterPostcodeSectors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestTimeFilterPostcodeSectors input)
        {
            if (input == null)
                return false;
