...
namespace Org.OpenAPITools.Model
{
    ...
    /// ResponseFaresFast
    /// </summary>
    [DataContract(Name = "ResponseFaresFast")]
    public partial class ResponseFaresFast : IEquatable<ResponseFaresFast>, IValidatableObject
    {
        ...
        public ResponseFaresFast(List<ResponseFareTicket> ticketsTotal = default(List<ResponseFareTicket>))
        {
            ...
            this.TicketsTotal = ticketsTotal ?? throw new ArgumentNullException("ticketsTotal is a required property for ResponseFaresFast and cannot be null");
        }
