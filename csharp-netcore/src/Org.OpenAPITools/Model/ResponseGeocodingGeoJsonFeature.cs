...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseGeocodingGeoJsonFeature")]
    public partial class ResponseGeocodingGeoJsonFeature : IEquatable<ResponseGeocodingGeoJsonFeature>, IValidatableObject
    {
        ...
        public ResponseGeocodingGeoJsonFeature(string type = default(string), ResponseGeocodingGeometry geometry = default(ResponseGeocodingGeometry), ResponseGeocodingProperties properties = default(ResponseGeocodingProperties))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ResponseGeocodingGeoJsonFeature and cannot be null");
            // to ensure "geometry" is required (not null)
            this.Geometry = geometry ?? throw new ArgumentNullException("geometry is a required property for ResponseGeocodingGeoJsonFeature and cannot be null");
            // to ensure "properties" is required (not null)
            this.Properties = properties ?? throw new ArgumentNullException("properties is a required property for ResponseGeocodingGeoJsonFeature and cannot be null");
        }
