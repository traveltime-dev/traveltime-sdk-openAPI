...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseRoutesResult")]
    public partial class ResponseRoutesResult : IEquatable<ResponseRoutesResult>, IValidatableObject
    {
        ...
        public ResponseRoutesResult(string searchId = default(string), List<ResponseRoutesLocation> locations = default(List<ResponseRoutesLocation>), List<string> unreachable = default(List<string>))
        {
            ...
            this.SearchId = searchId ?? throw new ArgumentNullException("searchId is a required property for ResponseRoutesResult and cannot be null");
            // to ensure "locations" is required (not null)
            this.Locations = locations ?? throw new ArgumentNullException("locations is a required property for ResponseRoutesResult and cannot be null");
            // to ensure "unreachable" is required (not null)
            this.Unreachable = unreachable ?? throw new ArgumentNullException("unreachable is a required property for ResponseRoutesResult and cannot be null");
        }
