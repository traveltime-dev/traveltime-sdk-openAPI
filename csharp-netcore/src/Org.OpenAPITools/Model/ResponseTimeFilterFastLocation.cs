...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseTimeFilterFastLocation")]
    public partial class ResponseTimeFilterFastLocation : IEquatable<ResponseTimeFilterFastLocation>, IValidatableObject
    {
        ...
        public ResponseTimeFilterFastLocation(string id = default(string), List<ResponseTimeFilterFastProperties> properties = default(List<ResponseTimeFilterFastProperties>))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ResponseTimeFilterFastLocation and cannot be null");
            // to ensure "properties" is required (not null)
            this.Properties = properties ?? throw new ArgumentNullException("properties is a required property for ResponseTimeFilterFastLocation and cannot be null");
        }
