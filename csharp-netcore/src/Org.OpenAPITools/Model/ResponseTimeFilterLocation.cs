...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseTimeFilterLocation")]
    public partial class ResponseTimeFilterLocation : IEquatable<ResponseTimeFilterLocation>, IValidatableObject
    {
        ...
        public ResponseTimeFilterLocation(string id = default(string), List<ResponseTimeFilterProperties> properties = default(List<ResponseTimeFilterProperties>))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ResponseTimeFilterLocation and cannot be null");
            // to ensure "properties" is required (not null)
            this.Properties = properties ?? throw new ArgumentNullException("properties is a required property for ResponseTimeFilterLocation and cannot be null");
        }
