...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseTimeFilterPostcode")]
    public partial class ResponseTimeFilterPostcode : IEquatable<ResponseTimeFilterPostcode>, IValidatableObject
    {
        ...
        public ResponseTimeFilterPostcode(string code = default(string), List<ResponseTimeFilterPostcodesProperties> properties = default(List<ResponseTimeFilterPostcodesProperties>))
        {
            ...
            this.Code = code ?? throw new ArgumentNullException("code is a required property for ResponseTimeFilterPostcode and cannot be null");
            // to ensure "properties" is required (not null)
            this.Properties = properties ?? throw new ArgumentNullException("properties is a required property for ResponseTimeFilterPostcode and cannot be null");
        }
