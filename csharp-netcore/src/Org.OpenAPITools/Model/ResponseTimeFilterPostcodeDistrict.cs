...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseTimeFilterPostcodeDistrict")]
    public partial class ResponseTimeFilterPostcodeDistrict : IEquatable<ResponseTimeFilterPostcodeDistrict>, IValidatableObject
    {
        ...
        public ResponseTimeFilterPostcodeDistrict(string code = default(string), ResponseTimeFilterPostcodeDistrictProperties properties = default(ResponseTimeFilterPostcodeDistrictProperties))
        {
            ...
            this.Code = code ?? throw new ArgumentNullException("code is a required property for ResponseTimeFilterPostcodeDistrict and cannot be null");
            // to ensure "properties" is required (not null)
            this.Properties = properties ?? throw new ArgumentNullException("properties is a required property for ResponseTimeFilterPostcodeDistrict and cannot be null");
        }
