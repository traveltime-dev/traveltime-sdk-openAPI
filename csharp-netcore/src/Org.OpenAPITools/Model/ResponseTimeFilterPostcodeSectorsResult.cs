...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseTimeFilterPostcodeSectorsResult")]
    public partial class ResponseTimeFilterPostcodeSectorsResult : IEquatable<ResponseTimeFilterPostcodeSectorsResult>, IValidatableObject
    {
        ...
        public ResponseTimeFilterPostcodeSectorsResult(string searchId = default(string), List<ResponseTimeFilterPostcodeSector> sectors = default(List<ResponseTimeFilterPostcodeSector>))
        {
            ...
            this.SearchId = searchId ?? throw new ArgumentNullException("searchId is a required property for ResponseTimeFilterPostcodeSectorsResult and cannot be null");
            // to ensure "sectors" is required (not null)
            this.Sectors = sectors ?? throw new ArgumentNullException("sectors is a required property for ResponseTimeFilterPostcodeSectorsResult and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "sectors", IsRequired = true, EmitDefaultValue = false)]
