...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseTimeFilterPostcodesResult")]
    public partial class ResponseTimeFilterPostcodesResult : IEquatable<ResponseTimeFilterPostcodesResult>, IValidatableObject
    {
        ...
        public ResponseTimeFilterPostcodesResult(string searchId = default(string), List<ResponseTimeFilterPostcode> postcodes = default(List<ResponseTimeFilterPostcode>))
        {
            ...
            this.SearchId = searchId ?? throw new ArgumentNullException("searchId is a required property for ResponseTimeFilterPostcodesResult and cannot be null");
            // to ensure "postcodes" is required (not null)
            this.Postcodes = postcodes ?? throw new ArgumentNullException("postcodes is a required property for ResponseTimeFilterPostcodesResult and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "postcodes", IsRequired = true, EmitDefaultValue = false)]
