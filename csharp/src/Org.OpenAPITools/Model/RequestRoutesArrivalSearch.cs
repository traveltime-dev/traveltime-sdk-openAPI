...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RequestRoutesArrivalSearch :  IEquatable<RequestRoutesArrivalSearch>, IValidatableObject
    {
        ...
        public RequestRoutesArrivalSearch(string id = default(string), List<string> departureLocationIds = default(List<string>), string arrivalLocationId = default(string), RequestTransportation transportation = default(RequestTransportation), DateTime arrivalTime = default(DateTime), List<RequestRoutesProperty> properties = default(List<RequestRoutesProperty>), RequestRangeFull range = default(RequestRangeFull))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for RequestRoutesArrivalSearch and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            {
                throw new InvalidDataException("departureLocationIds is a required property for RequestRoutesArrivalSearch and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("arrivalLocationId is a required property for RequestRoutesArrivalSearch and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transportation is a required property for RequestRoutesArrivalSearch and cannot be null");
            }
            else
            {
            ...
            if (arrivalTime == null)
            {
                throw new InvalidDataException("arrivalTime is a required property for RequestRoutesArrivalSearch and cannot be null");
            }
            else
            {
            ...
            if (properties == null)
            {
                throw new InvalidDataException("properties is a required property for RequestRoutesArrivalSearch and cannot be null");
            }
            else
            {
