...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RequestTimeFilterArrivalSearch :  IEquatable<RequestTimeFilterArrivalSearch>, IValidatableObject
    {
        ...
        public RequestTimeFilterArrivalSearch(string id = default(string), List<string> departureLocationIds = default(List<string>), string arrivalLocationId = default(string), RequestTransportation transportation = default(RequestTransportation), int travelTime = default(int), DateTime arrivalTime = default(DateTime), List<RequestTimeFilterProperty> properties = default(List<RequestTimeFilterProperty>), RequestRangeFull range = default(RequestRangeFull))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for RequestTimeFilterArrivalSearch and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            {
                throw new InvalidDataException("departureLocationIds is a required property for RequestTimeFilterArrivalSearch and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("arrivalLocationId is a required property for RequestTimeFilterArrivalSearch and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transportation is a required property for RequestTimeFilterArrivalSearch and cannot be null");
            }
            else
            {
            ...
            if (travelTime == null)
            {
                throw new InvalidDataException("travelTime is a required property for RequestTimeFilterArrivalSearch and cannot be null");
            }
            else
            {
            ...
            if (arrivalTime == null)
            {
                throw new InvalidDataException("arrivalTime is a required property for RequestTimeFilterArrivalSearch and cannot be null");
            }
            else
            {
            ...
            if (properties == null)
            {
                throw new InvalidDataException("properties is a required property for RequestTimeFilterArrivalSearch and cannot be null");
            }
            else
            {
