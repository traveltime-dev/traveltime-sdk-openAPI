...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RequestTimeFilterPostcodesArrivalSearch :  IEquatable<RequestTimeFilterPostcodesArrivalSearch>, IValidatableObject
    {
        ...
        public RequestTimeFilterPostcodesArrivalSearch(string id = default(string), RequestTransportation transportation = default(RequestTransportation), int travelTime = default(int), DateTime arrivalTime = default(DateTime), List<RequestTimeFilterPostcodesProperty> properties = default(List<RequestTimeFilterPostcodesProperty>), RequestRangeFull range = default(RequestRangeFull))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for RequestTimeFilterPostcodesArrivalSearch and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            {
                throw new InvalidDataException("transportation is a required property for RequestTimeFilterPostcodesArrivalSearch and cannot be null");
            }
            else
            {
            ...
            if (travelTime == null)
            {
                throw new InvalidDataException("travelTime is a required property for RequestTimeFilterPostcodesArrivalSearch and cannot be null");
            }
            else
            {
            ...
            if (arrivalTime == null)
            {
                throw new InvalidDataException("arrivalTime is a required property for RequestTimeFilterPostcodesArrivalSearch and cannot be null");
            }
            else
            {
            ...
            if (properties == null)
            {
                throw new InvalidDataException("properties is a required property for RequestTimeFilterPostcodesArrivalSearch and cannot be null");
            }
            else
            {
