...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RequestTransportation :  IEquatable<RequestTransportation>, IValidatableObject
    {
        ...
        /// <param name="disableBorderCrossing">disableBorderCrossing.</param>
        ...
        /// <param name="cyclingTimeToStation">cyclingTimeToStation.</param>
        /// <param name="parkingTime">parkingTime.</param>
        /// <param name="boardingTime">boardingTime.</param>
        public RequestTransportation(TypeEnum type = default(TypeEnum), bool disableBorderCrossing = default(bool), int ptChangeDelay = default(int), int walkingTime = default(int), int drivingTimeToStation = default(int), int cyclingTimeToStation = default(int), int parkingTime = default(int), int boardingTime = default(int))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for RequestTransportation and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public bool Equals(RequestTransportation input)
        {
            ...
            return 
                ...
                (
                    this.DisableBorderCrossing == input.DisableBorderCrossing ||
                    (this.DisableBorderCrossing != null &&
                    this.DisableBorderCrossing.Equals(input.DisableBorderCrossing))
                ) && 
                (
                ...
                (
                    this.CyclingTimeToStation == input.CyclingTimeToStation ||
                    (this.CyclingTimeToStation != null &&
                    this.CyclingTimeToStation.Equals(input.CyclingTimeToStation))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DisableBorderCrossing != null)
                    hashCode = hashCode * 59 + this.DisableBorderCrossing.GetHashCode();
                if (this.PtChangeDelay != null)
                ...
                if (this.CyclingTimeToStation != null)
                    hashCode = hashCode * 59 + this.CyclingTimeToStation.GetHashCode();
