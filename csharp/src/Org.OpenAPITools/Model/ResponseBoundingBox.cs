...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ResponseBoundingBox :  IEquatable<ResponseBoundingBox>, IValidatableObject
    {
        ...
        public ResponseBoundingBox(ResponseBox envelope = default(ResponseBox), List<ResponseBox> boxes = default(List<ResponseBox>))
        {
            ...
            if (envelope == null)
            {
                throw new InvalidDataException("envelope is a required property for ResponseBoundingBox and cannot be null");
            }
            else
            {
            ...
            if (boxes == null)
            {
                throw new InvalidDataException("boxes is a required property for ResponseBoundingBox and cannot be null");
            }
            else
            {
                this.Boxes = boxes;
        ...
        /// </summary>
        [DataMember(Name="envelope", EmitDefaultValue=true)]
