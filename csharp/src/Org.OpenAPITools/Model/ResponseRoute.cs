...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ResponseRoute :  IEquatable<ResponseRoute>, IValidatableObject
    {
        ...
        public ResponseRoute(DateTime departureTime = default(DateTime), DateTime arrivalTime = default(DateTime), List<ResponseRoutePart> parts = default(List<ResponseRoutePart>))
        {
            ...
            {
                throw new InvalidDataException("departureTime is a required property for ResponseRoute and cannot be null");
            }
            else
            {
            ...
            if (arrivalTime == null)
            {
                throw new InvalidDataException("arrivalTime is a required property for ResponseRoute and cannot be null");
            }
            else
            {
            ...
            if (parts == null)
            {
                throw new InvalidDataException("parts is a required property for ResponseRoute and cannot be null");
            }
            else
            {
                this.Parts = parts;
