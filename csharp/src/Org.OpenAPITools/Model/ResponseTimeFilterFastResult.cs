...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ResponseTimeFilterFastResult :  IEquatable<ResponseTimeFilterFastResult>, IValidatableObject
    {
        ...
        public ResponseTimeFilterFastResult(string searchId = default(string), List<ResponseTimeFilterFastLocation> locations = default(List<ResponseTimeFilterFastLocation>), List<string> unreachable = default(List<string>))
        {
            ...
            if (searchId == null)
            {
                throw new InvalidDataException("searchId is a required property for ResponseTimeFilterFastResult and cannot be null");
            }
            else
            {
            ...
            if (locations == null)
            {
                throw new InvalidDataException("locations is a required property for ResponseTimeFilterFastResult and cannot be null");
            }
            else
            {
            ...
            if (unreachable == null)
            {
                throw new InvalidDataException("unreachable is a required property for ResponseTimeFilterFastResult and cannot be null");
            }
            else
            {
