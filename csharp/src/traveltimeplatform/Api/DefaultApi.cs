...
namespace traveltimeplatform.Api
{
    ...
    public partial class DefaultApi : IDefaultApi
    {
        ...
        {
            this.Configuration = new traveltimeplatform.Client.Configuration { BasePath = basePath };
        ...
        public DefaultApi()
        {
            this.Configuration = traveltimeplatform.Client.Configuration.Default;
        ...
        /// <returns></returns>
        public DefaultApi(traveltimeplatform.Client.Configuration configuration = null)
        {
        ...
        public traveltimeplatform.Client.Configuration Configuration {get; set;}
        ...
        {
             ApiResponse<ResponseGeocoding> localVarResponse = GeocodingReverseSearchWithHttpInfo(focusLat, focusLng, withinCountry);
        ...
        /// <param name="withinCountry"> (optional)</param>
        /// <returns>ApiResponse of ResponseGeocoding</returns>
        public ApiResponse< ResponseGeocoding > GeocodingReverseSearchWithHttpInfo (double? focusLat, double? focusLng, string withinCountry = null)
        {
            // verify the required parameter 'focusLat' is set
            if (focusLat == null)
                throw new ApiException(400, "Missing required parameter 'focusLat' when calling DefaultApi->GeocodingReverseSearch");
            // verify the required parameter 'focusLng' is set
            if (focusLng == null)
                throw new ApiException(400, "Missing required parameter 'focusLng' when calling DefaultApi->GeocodingReverseSearch");
        ...
        {
             ApiResponse<ResponseGeocoding> localVarResponse = await GeocodingReverseSearchAsyncWithHttpInfo(focusLat, focusLng, withinCountry);
             return localVarResponse.Data;
        ...
        /// <param name="withinCountry"> (optional)</param>
        /// <returns>Task of ApiResponse (ResponseGeocoding)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResponseGeocoding>> GeocodingReverseSearchAsyncWithHttpInfo (double? focusLat, double? focusLng, string withinCountry = null)
        {
            // verify the required parameter 'focusLat' is set
            if (focusLat == null)
                throw new ApiException(400, "Missing required parameter 'focusLat' when calling DefaultApi->GeocodingReverseSearch");
        ...
        {
             ApiResponse<ResponseGeocoding> localVarResponse = GeocodingSearchWithHttpInfo(query, withinCountry, focusLat, focusLng);
             return localVarResponse.Data;
        }
        ...
        /// <param name="focusLng"> (optional)</param>
        /// <returns>ApiResponse of ResponseGeocoding</returns>
        public ApiResponse< ResponseGeocoding > GeocodingSearchWithHttpInfo (string query, string withinCountry = null, double? focusLat = null, double? focusLng = null)
        {
        ...
        {
             ApiResponse<ResponseGeocoding> localVarResponse = await GeocodingSearchAsyncWithHttpInfo(query, withinCountry, focusLat, focusLng);
             return localVarResponse.Data;
        ...
        /// <param name="focusLng"> (optional)</param>
        /// <returns>Task of ApiResponse (ResponseGeocoding)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResponseGeocoding>> GeocodingSearchAsyncWithHttpInfo (string query, string withinCountry = null, double? focusLat = null, double? focusLng = null)
        {
            // verify the required parameter 'query' is set
            if (query == null)
                throw new ApiException(400, "Missing required parameter 'query' when calling DefaultApi->GeocodingSearch");
