...
// tests for RequestTimeFilterPostcodeSectorsDepartureSearch
void main() {
  final instance = RequestTimeFilterPostcodeSectorsDepartureSearchBuilder();
  // TODO add properties to the builder and call build()

  group(RequestTimeFilterPostcodeSectorsDepartureSearch, () {
    // String id
    ...
    // BuiltList<RequestTimeFilterPostcodeSectorsProperty> properties
