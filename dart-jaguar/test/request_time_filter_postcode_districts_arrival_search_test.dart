...
// tests for RequestTimeFilterPostcodeDistrictsArrivalSearch
void main() {
  var instance = new RequestTimeFilterPostcodeDistrictsArrivalSearch();

  group('test RequestTimeFilterPostcodeDistrictsArrivalSearch', () {
