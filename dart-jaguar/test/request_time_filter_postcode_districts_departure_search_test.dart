...
// tests for RequestTimeFilterPostcodeDistrictsDepartureSearch
void main() {
  var instance = new RequestTimeFilterPostcodeDistrictsDepartureSearch();

  group('test RequestTimeFilterPostcodeDistrictsDepartureSearch', () {
    ...
    // List<RequestTimeFilterPostcodeDistrictsProperty> properties (default value: const [])
