...
// tests for RequestTimeMapDepartureSearch
void main() {
  var instance = new RequestTimeMapDepartureSearch();

  group('test RequestTimeMapDepartureSearch', () {
    // String id (default value: null)
    test('to test the property `id`', () async {
      // TODO
    });

    // Coords coords (default value: null)
    ...
    // List<RequestTimeMapProperty> properties (default value: const [])
    test('to test the property `properties`', () async {
      // TODO
    });

    // RequestRangeNoMaxResults range (default value: null)
