...
// tests for RequestTimeFilterArrivalSearch
void main() {
    var instance = new RequestTimeFilterArrivalSearch();

  group('test RequestTimeFilterArrivalSearch', () {
    ...
    // List<RequestTimeFilterProperty> properties (default value: [])
