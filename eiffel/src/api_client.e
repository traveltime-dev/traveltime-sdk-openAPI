...
feature {NONE} -- Initialization
	...
	make
		do
			...
			authentications.force (create {API_KEY_AUTH}.make ("header", "X-Api-Key"), "ApiKey") 
			is_api_key_configured := True 
			authentications.force (create {API_KEY_AUTH}.make ("header", "X-Application-Id"), "ApplicationId") 
			is_api_key_configured := True 
		end

feature -- Access

	default_base_path: STRING = "https://api.traveltimeapp.com"
			-- default base path.
