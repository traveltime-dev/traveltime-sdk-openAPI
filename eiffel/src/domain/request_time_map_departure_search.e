...
class REQUEST_TIME_MAP_DEPARTURE_SEARCH 
...
feature --Access
    ...
    level_of_detail: detachable REQUEST_LEVEL_OF_DETAIL 
...
feature -- Change Element  
    ...
    set_level_of_detail (a_name: like level_of_detail)
        -- Set 'level_of_detail' with 'a_name'.
      do
        level_of_detail := a_name
      ensure
        level_of_detail_set: level_of_detail = a_name		
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass REQUEST_TIME_MAP_DEPARTURE_SEARCH%N")
        ...
        if attached level_of_detail as l_level_of_detail then
          Result.append ("%Nlevel_of_detail:")
          Result.append (l_level_of_detail.out)
          Result.append ("%N")    
        end  
      end
end
