...
defmodule TravelTimeAPI.Model.RequestTimeFilterPostcodeDistrictsArrivalSearch do
  @moduledoc """
...
defimpl Poison.Decoder, for: TravelTimeAPI.Model.RequestTimeFilterPostcodeDistrictsArrivalSearch do
