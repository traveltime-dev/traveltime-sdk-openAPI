...
defmodule TravelTimePlatformAPI.Model.RequestTimeFilterFastArrivalOneToManySearch do
  @moduledoc """
...
defimpl Poison.Decoder, for: TravelTimePlatformAPI.Model.RequestTimeFilterFastArrivalOneToManySearch do
