...
defmodule TravelTimePlatformAPI.Model.RequestTimeFilterPostcodesArrivalSearch do
  @moduledoc """
...
defimpl Poison.Decoder, for: TravelTimePlatformAPI.Model.RequestTimeFilterPostcodesArrivalSearch do
