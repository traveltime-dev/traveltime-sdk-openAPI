...
module Data.RequestTimeFilterFastArrivalManyToOneSearch exposing (RequestTimeFilterFastArrivalManyToOneSearch, decoder, encoder)
...
encoder : RequestTimeFilterFastArrivalManyToOneSearch -> Encode.Value
encoder model =
    Encode.object
