...
module Data.RequestTimeFilterPostcodeSectorsArrivalSearch exposing (RequestTimeFilterPostcodeSectorsArrivalSearch, decoder, encoder)
...
encoder : RequestTimeFilterPostcodeSectorsArrivalSearch -> Encode.Value
encoder model =
    Encode.object
