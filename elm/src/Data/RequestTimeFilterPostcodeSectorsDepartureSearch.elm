...
module Data.RequestTimeFilterPostcodeSectorsDepartureSearch exposing (RequestTimeFilterPostcodeSectorsDepartureSearch, decoder, encode, encodeWithTag, toString)
...
encodeWithTag : ( String, String ) -> RequestTimeFilterPostcodeSectorsDepartureSearch -> Encode.Value
encodeWithTag (tagField, tag) model =
    Encode.object <| encodePairs model ++ [ ( tagField, Encode.string tag ) ]


encodePairs : RequestTimeFilterPostcodeSectorsDepartureSearch -> List (String, Encode.Value)
encodePairs model =
...
toString : RequestTimeFilterPostcodeSectorsDepartureSearch -> String
toString =
