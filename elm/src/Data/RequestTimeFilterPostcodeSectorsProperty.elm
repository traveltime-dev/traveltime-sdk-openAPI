...
module Data.RequestTimeFilterPostcodeSectorsProperty exposing (RequestTimeFilterPostcodeSectorsProperty(..), decoder, encode, toString)
...
encode : RequestTimeFilterPostcodeSectorsProperty -> Encode.Value
encode model =
    case model of
        TravelTimeReachable ->
...
toString : RequestTimeFilterPostcodeSectorsProperty -> String
toString model =
    case model of
        TravelTimeReachable ->
            "travel_time_reachable"
