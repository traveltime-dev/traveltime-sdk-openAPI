...
module Data.RequestTimeFilterPostcodesDepartureSearch exposing (RequestTimeFilterPostcodesDepartureSearch, decoder, encoder)
...
encoder : RequestTimeFilterPostcodesDepartureSearch -> Encode.Value
encoder model =
    Encode.object
