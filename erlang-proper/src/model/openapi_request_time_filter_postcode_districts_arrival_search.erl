...
-export([openapi_request_time_filter_postcode_districts_arrival_search/0]).

-export([openapi_request_time_filter_postcode_districts_arrival_search/1]).
...
openapi_request_time_filter_postcode_districts_arrival_search() ->
    openapi_request_time_filter_postcode_districts_arrival_search([]).

openapi_request_time_filter_postcode_districts_arrival_search(Fields) ->
  Default = [ {'id', binary() }
            , {'transportation', openapi_request_transportation:openapi_request_transportation() }
