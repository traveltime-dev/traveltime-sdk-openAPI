...
-export([openapi_request_time_filter_postcode_districts_departure_search/0]).

-export([openapi_request_time_filter_postcode_districts_departure_search/1]).
...
-type openapi_request_time_filter_postcode_districts_departure_search() ::
  ...
  | {'properties', list(openapi_request_time_filter_postcode_districts_property:openapi_request_time_filter_postcode_districts_property()) }
  | {'range', openapi_request_range_full:openapi_request_range_full() }
  ].


openapi_request_time_filter_postcode_districts_departure_search() ->
    openapi_request_time_filter_postcode_districts_departure_search([]).

openapi_request_time_filter_postcode_districts_departure_search(Fields) ->
  Default = [ {'id', binary() }
            , {'transportation', openapi_request_transportation:openapi_request_transportation() }
