...
-export([traveltimeplatform_request_time_filter_fast_arrival_many_to_one_search/1]).
...
traveltimeplatform_request_time_filter_fast_arrival_many_to_one_search(Fields) ->
  Default = [ {'id', binary() }
            , {'arrival_location_id', binary() }
