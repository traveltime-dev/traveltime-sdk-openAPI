...
-export([traveltimeplatform_request_time_filter_fast_arrival_one_to_many_search/0]).

-export([traveltimeplatform_request_time_filter_fast_arrival_one_to_many_search/1]).
...
traveltimeplatform_request_time_filter_fast_arrival_one_to_many_search() ->
    traveltimeplatform_request_time_filter_fast_arrival_one_to_many_search([]).

traveltimeplatform_request_time_filter_fast_arrival_one_to_many_search(Fields) ->
  Default = [ {'id', binary() }
            , {'departure_location_id', binary() }
