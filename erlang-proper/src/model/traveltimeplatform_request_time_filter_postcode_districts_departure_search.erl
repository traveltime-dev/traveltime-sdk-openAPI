...
-export([traveltimeplatform_request_time_filter_postcode_districts_departure_search/1]).
...
traveltimeplatform_request_time_filter_postcode_districts_departure_search(Fields) ->
  Default = [ {'id', binary() }
            , {'transportation', traveltimeplatform_request_transportation:traveltimeplatform_request_transportation() }
