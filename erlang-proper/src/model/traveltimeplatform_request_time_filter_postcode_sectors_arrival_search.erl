...
-export([traveltimeplatform_request_time_filter_postcode_sectors_arrival_search/1]).
...
traveltimeplatform_request_time_filter_postcode_sectors_arrival_search(Fields) ->
  Default = [ {'id', binary() }
            , {'transportation', traveltimeplatform_request_transportation:traveltimeplatform_request_transportation() }
