...
-export([traveltimeplatform_request_time_filter_postcodes_departure_search/0]).

-export([traveltimeplatform_request_time_filter_postcodes_departure_search/1]).
...
traveltimeplatform_request_time_filter_postcodes_departure_search() ->
    traveltimeplatform_request_time_filter_postcodes_departure_search([]).

traveltimeplatform_request_time_filter_postcodes_departure_search(Fields) ->
  Default = [ {'id', binary() }
            , {'transportation', traveltimeplatform_request_transportation:traveltimeplatform_request_transportation() }
