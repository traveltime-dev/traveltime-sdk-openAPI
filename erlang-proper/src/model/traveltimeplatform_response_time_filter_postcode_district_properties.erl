...
-export([traveltimeplatform_response_time_filter_postcode_district_properties/1]).
...
traveltimeplatform_response_time_filter_postcode_district_properties(Fields) ->
