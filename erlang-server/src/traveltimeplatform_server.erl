-module(traveltimeplatform_server).


-define(DEFAULT_ACCEPTORS_POOLSIZE, 100).
-define(DEFAULT_LOGIC_HANDLER, traveltimeplatform_default_logic_handler).
...
get_socket_transport(IP, Port, Options) ->
    ...
    case traveltimeplatform_utils:get_opt(ssl, Options) of
        SslOpts = [_|_] ->
...
get_default_dispatch(LogicHandler) ->
    Paths = traveltimeplatform_router:get_paths(LogicHandler),
