...
public class DefaultApi extends OpenApi {
    ...
    */
     ...
     */
    public function geocoding_reverse_search (lat: Number, lng: Number, withinCountry: String): String {
        ...
        if("null" != String(lat))
            queryParams["lat"] = toPathValue(lat);
if("null" != String(lng))
            queryParams["lng"] = toPathValue(lng);
if("null" != String(withinCountry))
     ...
     * Returns ResponseGeocoding 
     */
    public function geocoding_search (query: String, focusLat: Number, focusLng: Number, withinCountry: String): String {
        // create path and map variables
