...
module TestHelper = 
  ...
  let createHost() =
      WebHostBuilder()
          ...
          .Configure(Action<IApplicationBuilder> traveltimeplatform.App.configureApp)
          .ConfigureServices(Action<IServiceCollection> traveltimeplatform.App.configureServices)
