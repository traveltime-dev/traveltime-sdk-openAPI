...
// GetLevelOfDetail returns the LevelOfDetail field value if set, zero value otherwise.
func (o *RequestTimeMapArrivalSearch) GetLevelOfDetail() RequestLevelOfDetail {
	if o == nil || o.LevelOfDetail == nil {
		var ret RequestLevelOfDetail
		return ret
	}
	return *o.LevelOfDetail
}

// GetLevelOfDetailOk returns a tuple with the LevelOfDetail field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RequestTimeMapArrivalSearch) GetLevelOfDetailOk() (*RequestLevelOfDetail, bool) {
	if o == nil || o.LevelOfDetail == nil {
		return nil, false
	}
	return o.LevelOfDetail, true
}
...
// SetLevelOfDetail gets a reference to the given RequestLevelOfDetail and assigns it to the LevelOfDetail field.
...
func (o RequestTimeMapArrivalSearch) MarshalJSON() ([]byte, error) {
	...
	if o.LevelOfDetail != nil {
		toSerialize["level_of_detail"] = o.LevelOfDetail
	}
