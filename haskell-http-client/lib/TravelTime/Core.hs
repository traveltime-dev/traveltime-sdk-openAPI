...
-- | 
data TravelTimeConfig = TravelTimeConfig
...
-- | display the config
instance P.Show TravelTimeConfig where
  show c =
    T.printf
...
-- | constructs a default TravelTimeConfig
--
-- configHost:
--
...
-- @"traveltime/0.1.0.0"@
--
newConfig :: IO TravelTimeConfig
newConfig = do
    logCxt <- initLogContext
    return $ TravelTimeConfig
        { configHost = "https://api.traveltimeapp.com"
        , configUserAgent = "traveltime/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => TravelTimeConfig -> auth -> TravelTimeConfig
addAuthMethod config@TravelTimeConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: TravelTimeConfig -> IO TravelTimeConfig
...
withStderrLogging :: TravelTimeConfig -> IO TravelTimeConfig
...
withNoLogging :: TravelTimeConfig -> TravelTimeConfig
...
data TravelTimeRequest req contentType res accept = TravelTimeRequest
  { rMethod  :: NH.Method   -- ^ Method of TravelTimeRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of TravelTimeRequest
  , rParams   :: Params -- ^ params of TravelTimeRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (TravelTimeRequest req contentType res accept) NH.Method
rMethodL f TravelTimeRequest{..} = (\rMethod -> TravelTimeRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (TravelTimeRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f TravelTimeRequest{..} = (\rUrlPath -> TravelTimeRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (TravelTimeRequest req contentType res accept) Params
rParamsL f TravelTimeRequest{..} = (\rParams -> TravelTimeRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (TravelTimeRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f TravelTimeRequest{..} = (\rAuthTypes -> TravelTimeRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => TravelTimeRequest req contentType res accept -> param -> TravelTimeRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: TravelTimeRequest req contentType res accept -> param -> TravelTimeRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: TravelTimeRequest req contentType res accept -> param -> TravelTimeRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** TravelTimeRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> TravelTimeRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = TravelTimeRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: TravelTimeRequest req contentType res accept -> [NH.Header] -> TravelTimeRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: TravelTimeRequest req contentType res accept -> [NH.HeaderName] -> TravelTimeRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => TravelTimeRequest req contentType res accept -> TravelTimeRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => TravelTimeRequest req contentType res accept -> TravelTimeRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: TravelTimeRequest req contentType res accept -> [NH.QueryItem] -> TravelTimeRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: TravelTimeRequest req contentType res accept -> WH.Form -> TravelTimeRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: TravelTimeRequest req contentType res accept -> NH.Part -> TravelTimeRequest req contentType res accept
...
_setBodyBS :: TravelTimeRequest req contentType res accept -> B.ByteString -> TravelTimeRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: TravelTimeRequest req contentType res accept -> BL.ByteString -> TravelTimeRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => TravelTimeRequest req contentType res accept -> P.Proxy authMethod -> TravelTimeRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: TravelTimeConfig
    -> a
    -> TravelTimeRequest req contentType res accept
    -> IO (TravelTimeRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> TravelTimeConfig
  -> IO (TravelTimeRequest req contentType res accept)
_applyAuthMethods req config@(TravelTimeConfig {configAuthMethods = as}) =
  foldlM go req as
  where
