...
data RequestLevelOfDetail = RequestLevelOfDetail
  { requestLevelOfDetailScaleType :: !(E'ScaleType) -- ^ /Required/ "scale_type"
  , requestLevelOfDetailLevel :: !(E'Level) -- ^ /Required/ "level"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON RequestLevelOfDetail
instance A.FromJSON RequestLevelOfDetail where
  parseJSON = A.withObject "RequestLevelOfDetail" $ \o ->
    RequestLevelOfDetail
      <$> (o .:  "scale_type")
      <*> (o .:  "level")

-- | ToJSON RequestLevelOfDetail
instance A.ToJSON RequestLevelOfDetail where
  toJSON RequestLevelOfDetail {..} =
   _omitNulls
      [ "scale_type" .= requestLevelOfDetailScaleType
      , "level" .= requestLevelOfDetailLevel
      ]


-- | Construct a value of type 'RequestLevelOfDetail' (by applying it's required fields, if any)
mkRequestLevelOfDetail
  :: E'ScaleType -- ^ 'requestLevelOfDetailScaleType' 
  -> E'Level -- ^ 'requestLevelOfDetailLevel' 
  -> RequestLevelOfDetail
mkRequestLevelOfDetail requestLevelOfDetailScaleType requestLevelOfDetailLevel =
  RequestLevelOfDetail
  { requestLevelOfDetailScaleType
  , requestLevelOfDetailLevel
  }
...
data RequestTimeMapArrivalSearch = RequestTimeMapArrivalSearch
  ...
  , requestTimeMapArrivalSearchLevelOfDetail :: !(Maybe RequestLevelOfDetail) -- ^ "level_of_detail"
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON RequestTimeMapArrivalSearch where
  toJSON RequestTimeMapArrivalSearch {..} =
   _omitNulls
      ...
      , "level_of_detail" .= requestTimeMapArrivalSearchLevelOfDetail
      ]
...
mkRequestTimeMapArrivalSearch requestTimeMapArrivalSearchId requestTimeMapArrivalSearchCoords requestTimeMapArrivalSearchTransportation requestTimeMapArrivalSearchTravelTime requestTimeMapArrivalSearchArrivalTime =
  ...
  , requestTimeMapArrivalSearchLevelOfDetail = Nothing
  }
...
data RequestTimeMapDepartureSearch = RequestTimeMapDepartureSearch
  ...
  , requestTimeMapDepartureSearchLevelOfDetail :: !(Maybe RequestLevelOfDetail) -- ^ "level_of_detail"
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON RequestTimeMapDepartureSearch where
  toJSON RequestTimeMapDepartureSearch {..} =
   _omitNulls
      ...
      , "level_of_detail" .= requestTimeMapDepartureSearchLevelOfDetail
      ]
...
mkRequestTimeMapDepartureSearch requestTimeMapDepartureSearchId requestTimeMapDepartureSearchCoords requestTimeMapDepartureSearchTransportation requestTimeMapDepartureSearchTravelTime requestTimeMapDepartureSearchDepartureTime =
  ...
  , requestTimeMapDepartureSearchLevelOfDetail = Nothing
  }
...
data RequestTransportation = RequestTransportation
  ...
  , requestTransportationDisableBorderCrossing :: !(Maybe Bool) -- ^ "disable_border_crossing"
  ...
  , requestTransportationCyclingTimeToStation :: !(Maybe Int) -- ^ "cycling_time_to_station"
...
instance A.FromJSON RequestTransportation where
  parseJSON = A.withObject "RequestTransportation" $ \o ->
    RequestTransportation
      <$> (o .:  "type")
      <*> (o .:? "disable_border_crossing")
      <*> (o .:? "pt_change_delay")
      <*> (o .:? "walking_time")
      <*> (o .:? "driving_time_to_station")
      <*> (o .:? "cycling_time_to_station")
      <*> (o .:? "parking_time")
      <*> (o .:? "boarding_time")
...
instance A.ToJSON RequestTransportation where
  toJSON RequestTransportation {..} =
   _omitNulls
      ...
      , "disable_border_crossing" .= requestTransportationDisableBorderCrossing
      ...
      , "cycling_time_to_station" .= requestTransportationCyclingTimeToStation
...
mkRequestTransportation requestTransportationType =
  ...
  , requestTransportationDisableBorderCrossing = Nothing
  ...
  , requestTransportationCyclingTimeToStation = Nothing
...
-- | Enum of 'Text'
data E'Level
  = E'Level'Lowest -- ^ @"lowest"@
  | E'Level'Low -- ^ @"low"@
  | E'Level'Medium -- ^ @"medium"@
  | E'Level'High -- ^ @"high"@
  | E'Level'Highest -- ^ @"highest"@
...
toE'Level = \case
  "lowest" -> P.Right E'Level'Lowest
  "low" -> P.Right E'Level'Low
  "medium" -> P.Right E'Level'Medium
  "high" -> P.Right E'Level'High
  "highest" -> P.Right E'Level'Highest
...
-- | Enum of 'Text'
data E'ScaleType
  = E'ScaleType'Simple -- ^ @"simple"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)

instance A.ToJSON E'ScaleType where toJSON = A.toJSON . fromE'ScaleType
instance A.FromJSON E'ScaleType where parseJSON o = P.either P.fail (pure . P.id) . toE'ScaleType =<< A.parseJSON o
instance WH.ToHttpApiData E'ScaleType where toQueryParam = WH.toQueryParam . fromE'ScaleType
instance WH.FromHttpApiData E'ScaleType where parseQueryParam o = WH.parseQueryParam o >>= P.left T.pack . toE'ScaleType
instance MimeRender MimeMultipartFormData E'ScaleType where mimeRender _ = mimeRenderDefaultMultipartFormData

-- | unwrap 'E'ScaleType' enum
fromE'ScaleType :: E'ScaleType -> Text
fromE'ScaleType = \case
  E'ScaleType'Simple -> "simple"

-- | parse 'E'ScaleType' enum
toE'ScaleType :: Text -> P.Either String E'ScaleType
toE'ScaleType = \case
  "simple" -> P.Right E'ScaleType'Simple
  s -> P.Left $ "toE'ScaleType: enum parse failure: " P.++ P.show s
