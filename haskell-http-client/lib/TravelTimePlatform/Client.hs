...
module TravelTimePlatform.Client where
...
dispatchLbs
  ...
  -> TravelTimePlatformConfig -- ^ config
  -> TravelTimePlatformRequest req contentType res accept -- ^ request
