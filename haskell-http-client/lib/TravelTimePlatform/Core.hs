...
module TravelTimePlatform.Core where
...
-- * TravelTimePlatformConfig

-- | 
data TravelTimePlatformConfig = TravelTimePlatformConfig
...
-- | display the config
instance P.Show TravelTimePlatformConfig where
  show c =
    T.printf
...
-- | constructs a default TravelTimePlatformConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"traveltime-platform/0.1.0.0"@
--
newConfig :: IO TravelTimePlatformConfig
newConfig = do
    logCxt <- initLogContext
    return $ TravelTimePlatformConfig
        { configHost = "https://api.traveltimeapp.com"
        , configUserAgent = "traveltime-platform/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => TravelTimePlatformConfig -> auth -> TravelTimePlatformConfig
addAuthMethod config@TravelTimePlatformConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: TravelTimePlatformConfig -> IO TravelTimePlatformConfig
...
withStderrLogging :: TravelTimePlatformConfig -> IO TravelTimePlatformConfig
...
withNoLogging :: TravelTimePlatformConfig -> TravelTimePlatformConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}
 
-- * TravelTimePlatformRequest
...
data TravelTimePlatformRequest req contentType res accept = TravelTimePlatformRequest
  { rMethod  :: NH.Method   -- ^ Method of TravelTimePlatformRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of TravelTimePlatformRequest
  , rParams   :: Params -- ^ params of TravelTimePlatformRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (TravelTimePlatformRequest req contentType res accept) NH.Method
rMethodL f TravelTimePlatformRequest{..} = (\rMethod -> TravelTimePlatformRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (TravelTimePlatformRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f TravelTimePlatformRequest{..} = (\rUrlPath -> TravelTimePlatformRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (TravelTimePlatformRequest req contentType res accept) Params
rParamsL f TravelTimePlatformRequest{..} = (\rParams -> TravelTimePlatformRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (TravelTimePlatformRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f TravelTimePlatformRequest{..} = (\rAuthTypes -> TravelTimePlatformRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => TravelTimePlatformRequest req contentType res accept -> param -> TravelTimePlatformRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: TravelTimePlatformRequest req contentType res accept -> param -> TravelTimePlatformRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: TravelTimePlatformRequest req contentType res accept -> param -> TravelTimePlatformRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** TravelTimePlatformRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> TravelTimePlatformRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = TravelTimePlatformRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: TravelTimePlatformRequest req contentType res accept -> [NH.Header] -> TravelTimePlatformRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: TravelTimePlatformRequest req contentType res accept -> [NH.HeaderName] -> TravelTimePlatformRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => TravelTimePlatformRequest req contentType res accept -> TravelTimePlatformRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => TravelTimePlatformRequest req contentType res accept -> TravelTimePlatformRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: TravelTimePlatformRequest req contentType res accept -> [NH.QueryItem] -> TravelTimePlatformRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: TravelTimePlatformRequest req contentType res accept -> WH.Form -> TravelTimePlatformRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: TravelTimePlatformRequest req contentType res accept -> NH.Part -> TravelTimePlatformRequest req contentType res accept
...
_setBodyBS :: TravelTimePlatformRequest req contentType res accept -> B.ByteString -> TravelTimePlatformRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: TravelTimePlatformRequest req contentType res accept -> BL.ByteString -> TravelTimePlatformRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => TravelTimePlatformRequest req contentType res accept -> P.Proxy authMethod -> TravelTimePlatformRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: TravelTimePlatformConfig
    -> a
    -> TravelTimePlatformRequest req contentType res accept
    -> IO (TravelTimePlatformRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> TravelTimePlatformConfig
  -> IO (TravelTimePlatformRequest req contentType res accept)
_applyAuthMethods req config@(TravelTimePlatformConfig {configAuthMethods = as}) =
  foldlM go req as
  where
