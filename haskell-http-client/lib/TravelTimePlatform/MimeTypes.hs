...
module TravelTimePlatform.MimeTypes where
...
-- ** MimeVndBoundingBoxesjson

data MimeVndBoundingBoxesjson = MimeVndBoundingBoxesjson deriving (P.Typeable)

-- | @application/vnd.bounding-boxes+json@
instance MimeType MimeVndBoundingBoxesjson where
  mimeType _ = Just $ P.fromString "application/vnd.bounding-boxes+json"
instance A.ToJSON a => MimeRender MimeVndBoundingBoxesjson a where mimeRender _ = A.encode
instance A.FromJSON a => MimeUnrender MimeVndBoundingBoxesjson a where mimeUnrender _ = A.eitherDecode
-- instance MimeRender MimeVndBoundingBoxesjson T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimeVndBoundingBoxesjson T.Text where mimeUnrender _ = undefined

-- ** MimeVndWktjson

data MimeVndWktjson = MimeVndWktjson deriving (P.Typeable)

-- | @application/vnd.wkt+json@
instance MimeType MimeVndWktjson where
  mimeType _ = Just $ P.fromString "application/vnd.wkt+json"
instance A.ToJSON a => MimeRender MimeVndWktjson a where mimeRender _ = A.encode
instance A.FromJSON a => MimeUnrender MimeVndWktjson a where mimeUnrender _ = A.eitherDecode
-- instance MimeRender MimeVndWktjson T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimeVndWktjson T.Text where mimeUnrender _ = undefined

-- ** MimeVndWktNoHolesjson

data MimeVndWktNoHolesjson = MimeVndWktNoHolesjson deriving (P.Typeable)

-- | @application/vnd.wkt-no-holes+json@
instance MimeType MimeVndWktNoHolesjson where
  mimeType _ = Just $ P.fromString "application/vnd.wkt-no-holes+json"
instance A.ToJSON a => MimeRender MimeVndWktNoHolesjson a where mimeRender _ = A.encode
instance A.FromJSON a => MimeUnrender MimeVndWktNoHolesjson a where mimeUnrender _ = A.eitherDecode
-- instance MimeRender MimeVndWktNoHolesjson T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimeVndWktNoHolesjson T.Text where mimeUnrender _ = undefined
