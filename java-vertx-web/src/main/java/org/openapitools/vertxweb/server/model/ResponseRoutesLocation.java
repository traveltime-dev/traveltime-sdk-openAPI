...
import org.openapitools.vertxweb.server.model.ResponseRoutesProperties;
...
public class ResponseRoutesLocation   {
  ...
  public ResponseRoutesLocation (String id, List<ResponseRoutesProperties> properties) {
    this.id = id;
