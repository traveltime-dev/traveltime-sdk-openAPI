...
import org.openapitools.server.api.model.ResponseTimeFilterProperties;
...
public class ResponseTimeFilterLocation   {
  ...
  public ResponseTimeFilterLocation (String id, List<ResponseTimeFilterProperties> properties) {
    this.id = id;
