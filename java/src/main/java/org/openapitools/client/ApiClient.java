...
public class ApiClient {
    ...
    private String basePath = "https://api.traveltimeapp.com";
    ...
    public ApiClient() {
        ...
        authentications.put("ApplicationId", new ApiKeyAuth("header", "X-Application-Id"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.traveltimeapp.com
