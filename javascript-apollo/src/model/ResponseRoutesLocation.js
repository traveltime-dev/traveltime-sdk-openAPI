...
class ResponseRoutesLocation {
    ...
    id;
    /**
     * @member {Array.<CodegenProperty{openApiType='ResponseRoutesProperties', baseName='properties', complexType='ResponseRoutesProperties', getter='getProperties', setter='setProperties', description='null', dataType='ResponseRoutesProperties', datatypeWithEnum='ResponseRoutesProperties', dataFormat='null', name='properties', min='null', max='null', defaultValue='null', defaultValueWithParam=' = ResponseRoutesProperties.constructFromObject(data['properties']);', baseType='ResponseRoutesProperties', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='null', jsonSchema='{
