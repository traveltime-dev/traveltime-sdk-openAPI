...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimeApi.RequestRoutesDepartureSearch();
  });
  ...
  describe('RequestRoutesDepartureSearch', function() {
    it('should create an instance of RequestRoutesDepartureSearch', function() {
      ...
      //var instance = new TravelTimeApi.RequestRoutesDepartureSearch();
      //expect(instance).to.be.a(TravelTimeApi.RequestRoutesDepartureSearch);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instane = new TravelTimeApi.RequestRoutesDepartureSearch();
