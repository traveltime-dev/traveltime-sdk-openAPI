...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimeApi.RequestTimeFilterArrivalSearch();
  });
  ...
  describe('RequestTimeFilterArrivalSearch', function() {
    it('should create an instance of RequestTimeFilterArrivalSearch', function() {
      // uncomment below and update the code to test RequestTimeFilterArrivalSearch
      //var instance = new TravelTimeApi.RequestTimeFilterArrivalSearch();
      //expect(instance).to.be.a(TravelTimeApi.RequestTimeFilterArrivalSearch);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instane = new TravelTimeApi.RequestTimeFilterArrivalSearch();
