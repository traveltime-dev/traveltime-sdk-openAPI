...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimeApi.RequestTimeFilterPostcodeDistrictsArrivalSearch();
  });
  ...
  describe('RequestTimeFilterPostcodeDistrictsArrivalSearch', function() {
    it('should create an instance of RequestTimeFilterPostcodeDistrictsArrivalSearch', function() {
      // uncomment below and update the code to test RequestTimeFilterPostcodeDistrictsArrivalSearch
      //var instance = new TravelTimeApi.RequestTimeFilterPostcodeDistrictsArrivalSearch();
      //expect(instance).to.be.a(TravelTimeApi.RequestTimeFilterPostcodeDistrictsArrivalSearch);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instane = new TravelTimeApi.RequestTimeFilterPostcodeDistrictsArrivalSearch();
