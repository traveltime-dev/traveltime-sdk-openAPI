...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimeApi.RequestTimeFilterPostcodes();
  });
  ...
  describe('RequestTimeFilterPostcodes', function() {
    it('should create an instance of RequestTimeFilterPostcodes', function() {
      ...
      //var instance = new TravelTimeApi.RequestTimeFilterPostcodes();
      //expect(instance).to.be.a(TravelTimeApi.RequestTimeFilterPostcodes);
    });
    ...
    it('should have the property departureSearches (base name: "departure_searches")', function() {
      ...
      //var instane = new TravelTimeApi.RequestTimeFilterPostcodes();
