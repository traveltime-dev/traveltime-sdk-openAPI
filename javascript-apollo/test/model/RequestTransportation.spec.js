...
(function(root, factory) {
  ...
  describe('RequestTransportation', function() {
    ...
    it('should have the property disableBorderCrossing (base name: "disable_border_crossing")', function() {
      // uncomment below and update the code to test the property disableBorderCrossing
      //var instane = new TravelTimeApi.RequestTransportation();
      //expect(instance).to.be();
    });
    ...
    it('should have the property cyclingTimeToStation (base name: "cycling_time_to_station")', function() {
      // uncomment below and update the code to test the property cyclingTimeToStation
      //var instane = new TravelTimeApi.RequestTransportation();
      //expect(instance).to.be();
    });
