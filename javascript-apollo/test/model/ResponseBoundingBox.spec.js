...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimeApi.ResponseBoundingBox();
  });
  ...
  describe('ResponseBoundingBox', function() {
    it('should create an instance of ResponseBoundingBox', function() {
      ...
      //var instance = new TravelTimeApi.ResponseBoundingBox();
      //expect(instance).to.be.a(TravelTimeApi.ResponseBoundingBox);
    });
    ...
    it('should have the property envelope (base name: "envelope")', function() {
      ...
      //var instane = new TravelTimeApi.ResponseBoundingBox();
