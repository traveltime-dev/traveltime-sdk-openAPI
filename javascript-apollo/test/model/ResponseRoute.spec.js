...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimeApi.ResponseRoute();
  });
  ...
  describe('ResponseRoute', function() {
    it('should create an instance of ResponseRoute', function() {
      ...
      //var instance = new TravelTimeApi.ResponseRoute();
      //expect(instance).to.be.a(TravelTimeApi.ResponseRoute);
    });
    ...
    it('should have the property departureTime (base name: "departure_time")', function() {
      ...
      //var instane = new TravelTimeApi.ResponseRoute();
