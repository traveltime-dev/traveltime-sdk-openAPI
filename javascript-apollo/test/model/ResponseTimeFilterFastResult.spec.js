...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimeApi.ResponseTimeFilterFastResult();
  });
  ...
  describe('ResponseTimeFilterFastResult', function() {
    it('should create an instance of ResponseTimeFilterFastResult', function() {
      // uncomment below and update the code to test ResponseTimeFilterFastResult
      //var instance = new TravelTimeApi.ResponseTimeFilterFastResult();
      //expect(instance).to.be.a(TravelTimeApi.ResponseTimeFilterFastResult);
    });
    ...
    it('should have the property searchId (base name: "search_id")', function() {
      ...
      //var instane = new TravelTimeApi.ResponseTimeFilterFastResult();
