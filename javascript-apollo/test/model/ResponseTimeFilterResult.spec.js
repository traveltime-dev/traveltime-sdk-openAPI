...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimeApi.ResponseTimeFilterResult();
  });
  ...
  describe('ResponseTimeFilterResult', function() {
    it('should create an instance of ResponseTimeFilterResult', function() {
      // uncomment below and update the code to test ResponseTimeFilterResult
      //var instance = new TravelTimeApi.ResponseTimeFilterResult();
      //expect(instance).to.be.a(TravelTimeApi.ResponseTimeFilterResult);
    });
    ...
    it('should have the property searchId (base name: "search_id")', function() {
      ...
      //var instane = new TravelTimeApi.ResponseTimeFilterResult();
