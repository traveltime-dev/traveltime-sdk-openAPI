...
export const DefaultApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        routes(requestRoutes: RequestRoutes, options: RequestOptions): FetchArgs {
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(requestRoutes || {}) : (((requestRoutes:any):string) || "");
        ...
        supportedLocations(requestSupportedLocations: RequestSupportedLocations, options: RequestOptions): FetchArgs {
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(requestSupportedLocations || {}) : (((requestSupportedLocations:any):string) || "");
        ...
        timeFilter(requestTimeFilter: RequestTimeFilter, options: RequestOptions): FetchArgs {
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(requestTimeFilter || {}) : (((requestTimeFilter:any):string) || "");
        ...
        timeFilterFast(requestTimeFilterFast: RequestTimeFilterFast, options: RequestOptions): FetchArgs {
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(requestTimeFilterFast || {}) : (((requestTimeFilterFast:any):string) || "");
        ...
        timeFilterPostcodeDistricts(requestTimeFilterPostcodeDistricts: RequestTimeFilterPostcodeDistricts, options: RequestOptions): FetchArgs {
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(requestTimeFilterPostcodeDistricts || {}) : (((requestTimeFilterPostcodeDistricts:any):string) || "");
        ...
        timeFilterPostcodeSectors(requestTimeFilterPostcodeSectors: RequestTimeFilterPostcodeSectors, options: RequestOptions): FetchArgs {
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(requestTimeFilterPostcodeSectors || {}) : (((requestTimeFilterPostcodeSectors:any):string) || "");
        ...
        timeFilterPostcodes(requestTimeFilterPostcodes: RequestTimeFilterPostcodes, options: RequestOptions): FetchArgs {
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(requestTimeFilterPostcodes || {}) : (((requestTimeFilterPostcodes:any):string) || "");
        ...
        timeMap(requestTimeMap: RequestTimeMap, options: RequestOptions): FetchArgs {
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(requestTimeMap || {}) : (((requestTimeMap:any):string) || "");
