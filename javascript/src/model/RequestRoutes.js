...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RequestLocation', 'model/RequestRoutesArrivalSearch', 'model/RequestRoutesDepartureSearch'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RequestLocation'), require('./RequestRoutesArrivalSearch'), require('./RequestRoutesDepartureSearch'));
  } else {
    // Browser globals (root is window)
    if (!root.TravelTimePlatformApi) {
      root.TravelTimePlatformApi = {};
    }
    root.TravelTimePlatformApi.RequestRoutes = factory(root.TravelTimePlatformApi.ApiClient, root.TravelTimePlatformApi.RequestLocation, root.TravelTimePlatformApi.RequestRoutesArrivalSearch, root.TravelTimePlatformApi.RequestRoutesDepartureSearch);
  }
}(this, function(ApiClient, RequestLocation, RequestRoutesArrivalSearch, RequestRoutesDepartureSearch) {
  'use strict';
