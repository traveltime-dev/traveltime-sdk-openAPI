...
class RequestTransportation {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('disable_border_crossing')) {
                obj['disable_border_crossing'] = ApiClient.convertToType(data['disable_border_crossing'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('cycling_time_to_station')) {
                obj['cycling_time_to_station'] = ApiClient.convertToType(data['cycling_time_to_station'], 'Number');
            }
...
/**
 * @member {Boolean} disable_border_crossing
 */
RequestTransportation.prototype['disable_border_crossing'] = undefined;
...
/**
 * @member {Number} cycling_time_to_station
 */
RequestTransportation.prototype['cycling_time_to_station'] = undefined;
