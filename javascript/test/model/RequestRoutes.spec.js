...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.RequestRoutes();
  });
  ...
  describe('RequestRoutes', function() {
    it('should create an instance of RequestRoutes', function() {
      ...
      //var instance = new TravelTimePlatformApi.RequestRoutes();
      //expect(instance).to.be.a(TravelTimePlatformApi.RequestRoutes);
    });
