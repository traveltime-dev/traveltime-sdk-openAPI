...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.RequestRoutesArrivalSearch();
  });
  ...
  describe('RequestRoutesArrivalSearch', function() {
    it('should create an instance of RequestRoutesArrivalSearch', function() {
      ...
      //var instance = new TravelTimePlatformApi.RequestRoutesArrivalSearch();
      //expect(instance).to.be.a(TravelTimePlatformApi.RequestRoutesArrivalSearch);
    });
