...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.RequestTimeFilter();
  });
  ...
  describe('RequestTimeFilter', function() {
    it('should create an instance of RequestTimeFilter', function() {
      ...
      //var instance = new TravelTimePlatformApi.RequestTimeFilter();
      //expect(instance).to.be.a(TravelTimePlatformApi.RequestTimeFilter);
    });
