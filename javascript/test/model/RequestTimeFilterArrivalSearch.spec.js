...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.RequestTimeFilterArrivalSearch();
  });
  ...
  describe('RequestTimeFilterArrivalSearch', function() {
    it('should create an instance of RequestTimeFilterArrivalSearch', function() {
      ...
      //var instance = new TravelTimePlatformApi.RequestTimeFilterArrivalSearch();
      //expect(instance).to.be.a(TravelTimePlatformApi.RequestTimeFilterArrivalSearch);
    });
