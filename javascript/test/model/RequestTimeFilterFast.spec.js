...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.RequestTimeFilterFast();
  });
  ...
  describe('RequestTimeFilterFast', function() {
    it('should create an instance of RequestTimeFilterFast', function() {
      ...
      //var instance = new TravelTimePlatformApi.RequestTimeFilterFast();
      //expect(instance).to.be.a(TravelTimePlatformApi.RequestTimeFilterFast);
    });
