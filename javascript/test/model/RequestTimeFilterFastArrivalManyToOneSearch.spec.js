...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.RequestTimeFilterFastArrivalManyToOneSearch();
  });
  ...
  describe('RequestTimeFilterFastArrivalManyToOneSearch', function() {
    it('should create an instance of RequestTimeFilterFastArrivalManyToOneSearch', function() {
      ...
      //var instance = new TravelTimePlatformApi.RequestTimeFilterFastArrivalManyToOneSearch();
      //expect(instance).to.be.a(TravelTimePlatformApi.RequestTimeFilterFastArrivalManyToOneSearch);
    });
