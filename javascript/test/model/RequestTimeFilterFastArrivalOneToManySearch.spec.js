...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.RequestTimeFilterFastArrivalOneToManySearch();
  });
  ...
  describe('RequestTimeFilterFastArrivalOneToManySearch', function() {
    it('should create an instance of RequestTimeFilterFastArrivalOneToManySearch', function() {
      ...
      //var instance = new TravelTimePlatformApi.RequestTimeFilterFastArrivalOneToManySearch();
      //expect(instance).to.be.a(TravelTimePlatformApi.RequestTimeFilterFastArrivalOneToManySearch);
    });
