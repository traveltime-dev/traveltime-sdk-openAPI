...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.RequestTimeFilterFastArrivalSearches();
  });
  ...
  describe('RequestTimeFilterFastArrivalSearches', function() {
    it('should create an instance of RequestTimeFilterFastArrivalSearches', function() {
      ...
      //var instance = new TravelTimePlatformApi.RequestTimeFilterFastArrivalSearches();
      //expect(instance).to.be.a(TravelTimePlatformApi.RequestTimeFilterFastArrivalSearches);
    });
