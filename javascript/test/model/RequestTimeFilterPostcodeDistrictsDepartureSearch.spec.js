...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimeApi.RequestTimeFilterPostcodeDistrictsDepartureSearch();
  });
  ...
  describe('RequestTimeFilterPostcodeDistrictsDepartureSearch', function() {
    it('should create an instance of RequestTimeFilterPostcodeDistrictsDepartureSearch', function() {
      // uncomment below and update the code to test RequestTimeFilterPostcodeDistrictsDepartureSearch
      //var instane = new TravelTimeApi.RequestTimeFilterPostcodeDistrictsDepartureSearch();
      //expect(instance).to.be.a(TravelTimeApi.RequestTimeFilterPostcodeDistrictsDepartureSearch);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TravelTimeApi.RequestTimeFilterPostcodeDistrictsDepartureSearch();
