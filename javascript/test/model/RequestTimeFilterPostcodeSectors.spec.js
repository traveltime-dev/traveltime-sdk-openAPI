...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.RequestTimeFilterPostcodeSectors();
  });
  ...
  describe('RequestTimeFilterPostcodeSectors', function() {
    it('should create an instance of RequestTimeFilterPostcodeSectors', function() {
      ...
      //var instance = new TravelTimePlatformApi.RequestTimeFilterPostcodeSectors();
      //expect(instance).to.be.a(TravelTimePlatformApi.RequestTimeFilterPostcodeSectors);
    });
