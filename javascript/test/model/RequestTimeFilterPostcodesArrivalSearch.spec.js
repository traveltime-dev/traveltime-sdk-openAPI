...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.RequestTimeFilterPostcodesArrivalSearch();
  });
  ...
  describe('RequestTimeFilterPostcodesArrivalSearch', function() {
    it('should create an instance of RequestTimeFilterPostcodesArrivalSearch', function() {
      ...
      //var instance = new TravelTimePlatformApi.RequestTimeFilterPostcodesArrivalSearch();
      //expect(instance).to.be.a(TravelTimePlatformApi.RequestTimeFilterPostcodesArrivalSearch);
    });
