...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.RequestTimeFilterPostcodesDepartureSearch();
  });
  ...
  describe('RequestTimeFilterPostcodesDepartureSearch', function() {
    it('should create an instance of RequestTimeFilterPostcodesDepartureSearch', function() {
      ...
      //var instance = new TravelTimePlatformApi.RequestTimeFilterPostcodesDepartureSearch();
      //expect(instance).to.be.a(TravelTimePlatformApi.RequestTimeFilterPostcodesDepartureSearch);
    });
