...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimeApi.RequestTimeFilterPostcodesDepartureSearch();
  });
  ...
  describe('RequestTimeFilterPostcodesDepartureSearch', function() {
    it('should create an instance of RequestTimeFilterPostcodesDepartureSearch', function() {
      // uncomment below and update the code to test RequestTimeFilterPostcodesDepartureSearch
      //var instane = new TravelTimeApi.RequestTimeFilterPostcodesDepartureSearch();
      //expect(instance).to.be.a(TravelTimeApi.RequestTimeFilterPostcodesDepartureSearch);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TravelTimeApi.RequestTimeFilterPostcodesDepartureSearch();
