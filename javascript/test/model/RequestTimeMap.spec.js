...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.RequestTimeMap();
  });
  ...
  describe('RequestTimeMap', function() {
    it('should create an instance of RequestTimeMap', function() {
      ...
      //var instance = new TravelTimePlatformApi.RequestTimeMap();
      //expect(instance).to.be.a(TravelTimePlatformApi.RequestTimeMap);
    });
