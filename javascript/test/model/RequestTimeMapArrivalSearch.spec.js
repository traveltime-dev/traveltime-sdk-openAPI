...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimeApi.RequestTimeMapArrivalSearch();
  });
  ...
  describe('RequestTimeMapArrivalSearch', function() {
    it('should create an instance of RequestTimeMapArrivalSearch', function() {
      // uncomment below and update the code to test RequestTimeMapArrivalSearch
      //var instane = new TravelTimeApi.RequestTimeMapArrivalSearch();
      //expect(instance).to.be.a(TravelTimeApi.RequestTimeMapArrivalSearch);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TravelTimeApi.RequestTimeMapArrivalSearch();
