...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.RequestTimeMapArrivalSearch();
  });
  ...
  describe('RequestTimeMapArrivalSearch', function() {
    it('should create an instance of RequestTimeMapArrivalSearch', function() {
      ...
      //var instance = new TravelTimePlatformApi.RequestTimeMapArrivalSearch();
      //expect(instance).to.be.a(TravelTimePlatformApi.RequestTimeMapArrivalSearch);
    });
