...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimeApi.RequestTimeMapDepartureSearch();
  });
  ...
  describe('RequestTimeMapDepartureSearch', function() {
    it('should create an instance of RequestTimeMapDepartureSearch', function() {
      // uncomment below and update the code to test RequestTimeMapDepartureSearch
      //var instane = new TravelTimeApi.RequestTimeMapDepartureSearch();
      //expect(instance).to.be.a(TravelTimeApi.RequestTimeMapDepartureSearch);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TravelTimeApi.RequestTimeMapDepartureSearch();
    ...
    it('should have the property levelOfDetail (base name: "level_of_detail")', function() {
      // uncomment below and update the code to test the property levelOfDetail
      //var instance = new TravelTimeApi.RequestTimeMapDepartureSearch();
      //expect(instance).to.be();
    });
