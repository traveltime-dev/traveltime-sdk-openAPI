...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.RequestTransportationFast();
  });
  ...
  describe('RequestTransportationFast', function() {
    it('should create an instance of RequestTransportationFast', function() {
      ...
      //var instance = new TravelTimePlatformApi.RequestTransportationFast();
      //expect(instance).to.be.a(TravelTimePlatformApi.RequestTransportationFast);
    });
