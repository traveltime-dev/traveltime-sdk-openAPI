...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimeApi.RequestUnionOnIntersection();
  });
  ...
  describe('RequestUnionOnIntersection', function() {
    it('should create an instance of RequestUnionOnIntersection', function() {
      ...
      //var instane = new TravelTimeApi.RequestUnionOnIntersection();
      //expect(instance).to.be.a(TravelTimeApi.RequestUnionOnIntersection);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TravelTimeApi.RequestUnionOnIntersection();
