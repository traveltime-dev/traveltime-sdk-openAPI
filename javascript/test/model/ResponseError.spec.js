...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.ResponseError();
  });
  ...
  describe('ResponseError', function() {
    it('should create an instance of ResponseError', function() {
      ...
      //var instance = new TravelTimePlatformApi.ResponseError();
      //expect(instance).to.be.a(TravelTimePlatformApi.ResponseError);
    });
