...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.ResponseGeocodingGeometry();
  });
  ...
  describe('ResponseGeocodingGeometry', function() {
    it('should create an instance of ResponseGeocodingGeometry', function() {
      ...
      //var instance = new TravelTimePlatformApi.ResponseGeocodingGeometry();
      //expect(instance).to.be.a(TravelTimePlatformApi.ResponseGeocodingGeometry);
    });
