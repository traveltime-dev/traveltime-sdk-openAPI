...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.ResponseMapInfoFeaturesPublicTransport();
  });
  ...
  describe('ResponseMapInfoFeaturesPublicTransport', function() {
    it('should create an instance of ResponseMapInfoFeaturesPublicTransport', function() {
      ...
      //var instance = new TravelTimePlatformApi.ResponseMapInfoFeaturesPublicTransport();
      //expect(instance).to.be.a(TravelTimePlatformApi.ResponseMapInfoFeaturesPublicTransport);
    });
