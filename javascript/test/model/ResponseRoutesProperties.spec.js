...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.ResponseRoutesProperties();
  });
  ...
  describe('ResponseRoutesProperties', function() {
    it('should create an instance of ResponseRoutesProperties', function() {
      ...
      //var instance = new TravelTimePlatformApi.ResponseRoutesProperties();
      //expect(instance).to.be.a(TravelTimePlatformApi.ResponseRoutesProperties);
    });
