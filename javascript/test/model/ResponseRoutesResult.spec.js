...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimeApi.ResponseRoutesResult();
  });
  ...
  describe('ResponseRoutesResult', function() {
    it('should create an instance of ResponseRoutesResult', function() {
      // uncomment below and update the code to test ResponseRoutesResult
      //var instane = new TravelTimeApi.ResponseRoutesResult();
      //expect(instance).to.be.a(TravelTimeApi.ResponseRoutesResult);
    });
    ...
    it('should have the property searchId (base name: "search_id")', function() {
      ...
      //var instance = new TravelTimeApi.ResponseRoutesResult();
