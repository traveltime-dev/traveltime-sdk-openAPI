...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.ResponseRoutesResult();
  });
  ...
  describe('ResponseRoutesResult', function() {
    it('should create an instance of ResponseRoutesResult', function() {
      ...
      //var instance = new TravelTimePlatformApi.ResponseRoutesResult();
      //expect(instance).to.be.a(TravelTimePlatformApi.ResponseRoutesResult);
    });
