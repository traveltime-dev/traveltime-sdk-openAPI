...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.ResponseShape();
  });
  ...
  describe('ResponseShape', function() {
    it('should create an instance of ResponseShape', function() {
      ...
      //var instance = new TravelTimePlatformApi.ResponseShape();
      //expect(instance).to.be.a(TravelTimePlatformApi.ResponseShape);
    });
