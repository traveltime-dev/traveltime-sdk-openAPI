...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.ResponseTimeFilter();
  });
  ...
  describe('ResponseTimeFilter', function() {
    it('should create an instance of ResponseTimeFilter', function() {
      ...
      //var instance = new TravelTimePlatformApi.ResponseTimeFilter();
      //expect(instance).to.be.a(TravelTimePlatformApi.ResponseTimeFilter);
    });
