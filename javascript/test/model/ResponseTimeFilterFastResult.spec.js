...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.ResponseTimeFilterFastResult();
  });
  ...
  describe('ResponseTimeFilterFastResult', function() {
    it('should create an instance of ResponseTimeFilterFastResult', function() {
      ...
      //var instance = new TravelTimePlatformApi.ResponseTimeFilterFastResult();
      //expect(instance).to.be.a(TravelTimePlatformApi.ResponseTimeFilterFastResult);
    });
