...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.ResponseTimeFilterPostcodeDistrictProperties();
  });
  ...
  describe('ResponseTimeFilterPostcodeDistrictProperties', function() {
    it('should create an instance of ResponseTimeFilterPostcodeDistrictProperties', function() {
      ...
      //var instance = new TravelTimePlatformApi.ResponseTimeFilterPostcodeDistrictProperties();
      //expect(instance).to.be.a(TravelTimePlatformApi.ResponseTimeFilterPostcodeDistrictProperties);
    });
