...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.ResponseTimeFilterPostcodeSectorProperties();
  });
  ...
  describe('ResponseTimeFilterPostcodeSectorProperties', function() {
    it('should create an instance of ResponseTimeFilterPostcodeSectorProperties', function() {
      ...
      //var instance = new TravelTimePlatformApi.ResponseTimeFilterPostcodeSectorProperties();
      //expect(instance).to.be.a(TravelTimePlatformApi.ResponseTimeFilterPostcodeSectorProperties);
    });
