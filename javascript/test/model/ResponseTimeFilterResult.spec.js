...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimePlatformApi.ResponseTimeFilterResult();
  });
  ...
  describe('ResponseTimeFilterResult', function() {
    it('should create an instance of ResponseTimeFilterResult', function() {
      ...
      //var instance = new TravelTimePlatformApi.ResponseTimeFilterResult();
      //expect(instance).to.be.a(TravelTimePlatformApi.ResponseTimeFilterResult);
    });
