...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelTimeApi.ResponseTravelTimeStatistics();
  });
  ...
  describe('ResponseTravelTimeStatistics', function() {
    it('should create an instance of ResponseTravelTimeStatistics', function() {
      ...
      //var instane = new TravelTimeApi.ResponseTravelTimeStatistics();
      //expect(instance).to.be.a(TravelTimeApi.ResponseTravelTimeStatistics);
    });

    it('should have the property min (base name: "min")', function() {
      // uncomment below and update the code to test the property min
      //var instance = new TravelTimeApi.ResponseTravelTimeStatistics();
