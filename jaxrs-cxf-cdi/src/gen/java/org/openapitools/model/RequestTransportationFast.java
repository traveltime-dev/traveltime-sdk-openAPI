...
public enum TypeEnum {
    ...
    @XmlEnumValue("public_transport") PUBLIC_TRANSPORT(String.valueOf("public_transport")), @XmlEnumValue("driving") DRIVING(String.valueOf("driving")), @XmlEnumValue("driving+public_transport") DRIVING_PUBLIC_TRANSPORT(String.valueOf("driving+public_transport"));
