...
public interface DefaultApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "The json body returned upon error. [Docs link](http://docs.traveltime.com/reference/error-response)", response = ResponseError.class) })
    public ResponseRoutes routes(@Valid @NotNull RequestRoutes requestRoutes);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "The json body returned upon error. [Docs link](http://docs.traveltime.com/reference/error-response)", response = ResponseError.class) })
    public ResponseSupportedLocations supportedLocations(@Valid @NotNull RequestSupportedLocations requestSupportedLocations);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "The json body returned upon error. [Docs link](http://docs.traveltime.com/reference/error-response)", response = ResponseError.class) })
    public ResponseTimeFilter timeFilter(@Valid @NotNull RequestTimeFilter requestTimeFilter);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "The json body returned upon error. [Docs link](http://docs.traveltime.com/reference/error-response)", response = ResponseError.class) })
    public ResponseTimeFilterFast timeFilterFast(@Valid @NotNull RequestTimeFilterFast requestTimeFilterFast);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "The json body returned upon error. [Docs link](http://docs.traveltime.com/reference/error-response)", response = ResponseError.class) })
    public ResponseTimeFilterPostcodeDistricts timeFilterPostcodeDistricts(@Valid @NotNull RequestTimeFilterPostcodeDistricts requestTimeFilterPostcodeDistricts);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "The json body returned upon error. [Docs link](http://docs.traveltime.com/reference/error-response)", response = ResponseError.class) })
    public ResponseTimeFilterPostcodeSectors timeFilterPostcodeSectors(@Valid @NotNull RequestTimeFilterPostcodeSectors requestTimeFilterPostcodeSectors);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "The json body returned upon error. [Docs link](http://docs.traveltime.com/reference/error-response)", response = ResponseError.class) })
    public ResponseTimeFilterPostcodes timeFilterPostcodes(@Valid @NotNull RequestTimeFilterPostcodes requestTimeFilterPostcodes);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "The json body returned upon error. [Docs link](http://docs.traveltime.com/reference/error-response)", response = ResponseError.class) })
    public ResponseTimeMap timeMap(@Valid @NotNull RequestTimeMap requestTimeMap);
}
