...
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaJAXRSSpecServerCodegen", date = "2021-05-26T18:50:31.276Z[Etc/UTC]")public class ResponseGeocodingProperties   {
  
  private @Valid String name;
  private @Valid String label;
  private @Valid Double score;
  private @Valid String houseNumber;
  private @Valid String street;
  private @Valid String region;
  private @Valid String regionCode;
  private @Valid String neighbourhood;
  private @Valid String county;
  private @Valid String macroregion;
