...
export default function() {
    ...
    group("/v4/time-map", () => {
        ...
        // Request No. 1
        // TODO: edit the parameters of the request body.
        let body = {"departureSearches": [{"id": "string", "coords": "coords", "transportation": "requesttransportation", "travelTime": "integer", "departureTime": "date", "properties": "list", "range": "requestrangenomaxresults", "levelOfDetail": "requestlevelofdetail"}], "arrivalSearches": [{"id": "string", "coords": "coords", "transportation": "requesttransportation", "travelTime": "integer", "arrivalTime": "date", "properties": "list", "range": "requestrangenomaxresults", "levelOfDetail": "requestlevelofdetail"}], "unions": [{"id": "string", "searchIds": "list"}], "intersections": [{"id": "string", "searchIds": "list"}]};
        let params = {headers: {"Content-Type": "application/json", "Accept": "application/json"}};
        let request = http.post(url, body, params);
        check(request, {
