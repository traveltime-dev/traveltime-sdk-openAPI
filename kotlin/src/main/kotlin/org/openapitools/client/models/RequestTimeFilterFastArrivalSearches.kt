...
data class RequestTimeFilterFastArrivalSearches (
    ...
    val manyToOne: kotlin.collections.List<RequestTimeFilterFastArrivalManyToOneSearch>? = null,
    @Json(name = "one_to_many")
    val oneToMany: kotlin.collections.List<RequestTimeFilterFastArrivalOneToManySearch>? = null
)
