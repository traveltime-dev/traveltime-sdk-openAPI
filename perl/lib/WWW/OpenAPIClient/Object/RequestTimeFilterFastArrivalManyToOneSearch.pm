...
#
package WWW::OpenAPIClient::Object::RequestTimeFilterFastArrivalManyToOneSearch;
...
__PACKAGE__->method_documentation({
    ...
    'departure_location_ids' => {
        ...
        base_name => 'departure_location_ids',
        description => '',
        format => '',
        read_only => '',
            },
    'transportation' => {
        datatype => 'RequestTransportationFast',
    ...
    'arrival_time_period' => {
        datatype => 'RequestArrivalTimePeriod',
        base_name => 'arrival_time_period',
        description => '',
        format => '',
        read_only => '',
            },
    'properties' => {
        datatype => 'ARRAY[RequestTimeFilterFastProperty]',
