...
#
package WWW::OpenAPIClient::Object::RequestTimeFilterFastArrivalSearches;
...
__PACKAGE__->method_documentation({
    'many_to_one' => {
    	datatype => 'ARRAY[RequestTimeFilterFastArrivalManyToOneSearch]',
    	base_name => 'many_to_one',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'one_to_many' => {
    	datatype => 'ARRAY[RequestTimeFilterFastArrivalOneToManySearch]',
    	base_name => 'one_to_many',
    	description => '',
    	format => '',
    	read_only => '',
    		},
