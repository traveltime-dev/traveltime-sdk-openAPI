...
#
package WWW::OpenAPIClient::Object::RequestTimeFilterPostcodeDistricts;
...
__PACKAGE__->method_documentation({
    'departure_searches' => {
        datatype => 'ARRAY[RequestTimeFilterPostcodeDistrictsDepartureSearch]',
    ...
    'arrival_searches' => {
        datatype => 'ARRAY[RequestTimeFilterPostcodeDistrictsArrivalSearch]',
