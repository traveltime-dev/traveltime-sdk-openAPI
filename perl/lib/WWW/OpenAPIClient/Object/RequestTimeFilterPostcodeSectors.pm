...
#
package WWW::OpenAPIClient::Object::RequestTimeFilterPostcodeSectors;
...
__PACKAGE__->method_documentation({
    'departure_searches' => {
        datatype => 'ARRAY[RequestTimeFilterPostcodeSectorsDepartureSearch]',
    ...
    'arrival_searches' => {
        datatype => 'ARRAY[RequestTimeFilterPostcodeSectorsArrivalSearch]',
