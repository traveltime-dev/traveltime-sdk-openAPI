...
#
package WWW::OpenAPIClient::Object::RequestTimeMap;
...
__PACKAGE__->method_documentation({
    'departure_searches' => {
        datatype => 'ARRAY[RequestTimeMapDepartureSearch]',
    ...
    'arrival_searches' => {
        datatype => 'ARRAY[RequestTimeMapArrivalSearch]',
    ...
    'unions' => {
        datatype => 'ARRAY[RequestUnionOnIntersection]',
        base_name => 'unions',
        description => '',
        format => '',
        read_only => '',
