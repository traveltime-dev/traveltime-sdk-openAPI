...
#
package WWW::OpenAPIClient::Object::RequestTimeMapDepartureSearch;
...
__PACKAGE__->method_documentation({
    ...
    'departure_time' => {
        datatype => 'DateTime',
        base_name => 'departure_time',
        description => '',
        format => '',
        read_only => '',
            },
    'properties' => {
        datatype => 'ARRAY[RequestTimeMapProperty]',
    ...
    'range' => {
        datatype => 'RequestRangeNoMaxResults',
        base_name => 'range',
        description => '',
        format => '',
        read_only => '',
    ...
    'level_of_detail' => {
        datatype => 'RequestLevelOfDetail',
        base_name => 'level_of_detail',
        description => '',
        format => '',
        read_only => '',
            },
