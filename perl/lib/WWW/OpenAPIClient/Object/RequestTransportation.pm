...
#
package WWW::OpenAPIClient::Object::RequestTransportation;
...
__PACKAGE__->method_documentation({
    ...
    'disable_border_crossing' => {
        datatype => 'boolean',
        base_name => 'disable_border_crossing',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'driving_time_to_station' => {
        datatype => 'int',
        base_name => 'driving_time_to_station',
        description => '',
        format => '',
        read_only => '',
            },
    'cycling_time_to_station' => {
        datatype => 'int',
        base_name => 'cycling_time_to_station',
        description => '',
        format => '',
        read_only => '',
            },
