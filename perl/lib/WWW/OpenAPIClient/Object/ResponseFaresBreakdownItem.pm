...
#
package WWW::OpenAPIClient::Object::ResponseFaresBreakdownItem;
...
__PACKAGE__->method_documentation({
    'modes' => {
        datatype => 'ARRAY[ResponseTransportationMode]',
        base_name => 'modes',
        description => '',
        format => '',
        read_only => '',
    ...
    'route_part_ids' => {
        datatype => 'ARRAY[int]',
        base_name => 'route_part_ids',
        description => '',
        format => '',
        read_only => '',
            },
    'tickets' => {
        datatype => 'ARRAY[ResponseFareTicket]',
        base_name => 'tickets',
        description => '',
        format => '',
        read_only => '',
