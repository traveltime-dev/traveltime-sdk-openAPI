...
#
package WWW::OpenAPIClient::Object::ResponseTimeFilterPostcodeDistrictProperties;
...
__PACKAGE__->method_documentation({
    'travel_time_reachable' => {
        datatype => 'ResponseTravelTimeStatistics',
        base_name => 'travel_time_reachable',
        description => '',
        format => '',
        read_only => '',
            },
