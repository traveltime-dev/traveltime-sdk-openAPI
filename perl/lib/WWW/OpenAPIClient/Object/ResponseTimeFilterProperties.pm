...
#
package WWW::OpenAPIClient::Object::ResponseTimeFilterProperties;
...
__PACKAGE__->method_documentation({
    ...
    'distance_breakdown' => {
        datatype => 'ARRAY[ResponseDistanceBreakdownItem]',
        base_name => 'distance_breakdown',
        description => '',
        format => '',
        read_only => '',
            },
    'fares' => {
        datatype => 'ResponseFares',
        base_name => 'fares',
        description => '',
        format => '',
        read_only => '',
