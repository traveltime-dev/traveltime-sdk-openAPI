...
/**
 * Class representing the RequestTimeFilterPostcodeSectorsDepartureSearch model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
class RequestTimeFilterPostcodeSectorsDepartureSearch 
{
    ...
    /**
     * @var OpenAPI\Server\Model\RequestTimeFilterPostcodeSectorsProperty[]
     * @SerializedName("properties")
     * @Assert\NotNull()
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\RequestTimeFilterPostcodeSectorsProperty")
     * })
     * @Type("array<OpenAPI\Server\Model\RequestTimeFilterPostcodeSectorsProperty>")
     */
     ...
     * Sets properties.
     *
     * @param OpenAPI\Server\Model\RequestTimeFilterPostcodeSectorsProperty[] $properties
     *
     * @return $this
     */
