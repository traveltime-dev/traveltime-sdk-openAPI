...
class RequestTimeFilterPostcodeSectorsDepartureSearch
{
     ...
     * @DTA\Strategy(name="ObjectArray", options={"type":\App\DTO\RequestTimeFilterPostcodeSectorsProperty::class})
     * @DTA\Validator(name="Collection", options={"validators":{
     *     {"name":"Dictionary", "options":{"type":\App\DTO\RequestTimeFilterPostcodeSectorsProperty::class}}
     * }})
     * @var \App\DTO\RequestTimeFilterPostcodeSectorsProperty[]
     */
    public $properties;
    /**
