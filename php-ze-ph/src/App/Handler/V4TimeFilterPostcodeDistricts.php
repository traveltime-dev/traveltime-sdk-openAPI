 ...
 */
class V4TimeFilterPostcodeDistricts
{
    /**
     * @PHA\Post()
     ...
     */
    public function timeFilterPostcodeDistricts(ServerRequestInterface $request): \App\DTO\ResponseTimeFilterPostcodeDistricts
    {
