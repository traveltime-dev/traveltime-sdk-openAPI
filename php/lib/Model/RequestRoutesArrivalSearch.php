...
/**
 * RequestRoutesArrivalSearch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RequestRoutesArrivalSearch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestRoutesArrivalSearch';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['departure_location_ids']) > 2)) {
            $invalidProperties[] = "invalid value for 'departure_location_ids', number of items must be less than or equal to 2.";
        }
    ...
    public function setDepartureLocationIds($departure_location_ids)
    {
        ...
        if ((count($departure_location_ids) > 2)) {
            throw new \InvalidArgumentException('invalid value for $departure_location_ids when calling RequestRoutesArrivalSearch., number of items must be less than or equal to 2.');
        }
        if ((count($departure_location_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $departure_location_ids when calling RequestRoutesArrivalSearch., number of items must be greater than or equal to 1.');
        }
