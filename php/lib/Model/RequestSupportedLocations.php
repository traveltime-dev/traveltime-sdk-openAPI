...
/**
 * RequestSupportedLocations Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RequestSupportedLocations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestSupportedLocations';
    ...
    public function setLocations($locations)
    {
        ...
        if ((count($locations) < 1)) {
            throw new \InvalidArgumentException('invalid length for $locations when calling RequestSupportedLocations., number of items must be greater than or equal to 1.');
        }
