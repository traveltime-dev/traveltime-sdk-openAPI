 ...
 */
class RequestTimeFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setLocations($locations)
    {
        ...
        if ((count($locations) < 1)) {
            throw new \InvalidArgumentException('invalid length for $locations when calling RequestTimeFilter., number of items must be greater than or equal to 1.');
        }
    ...
    public function setDepartureSearches($departure_searches)
    {
        ...
        if (!is_null($departure_searches) && (count($departure_searches) > 10)) {
            throw new \InvalidArgumentException('invalid value for $departure_searches when calling RequestTimeFilter., number of items must be less than or equal to 10.');
        }
    ...
    public function setArrivalSearches($arrival_searches)
    {
        ...
        if (!is_null($arrival_searches) && (count($arrival_searches) > 10)) {
            throw new \InvalidArgumentException('invalid value for $arrival_searches when calling RequestTimeFilter., number of items must be less than or equal to 10.');
        }
