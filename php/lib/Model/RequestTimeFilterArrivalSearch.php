...
/**
 * RequestTimeFilterArrivalSearch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RequestTimeFilterArrivalSearch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestTimeFilterArrivalSearch';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['departure_location_ids']) > 2000)) {
            $invalidProperties[] = "invalid value for 'departure_location_ids', number of items must be less than or equal to 2000.";
        }
    ...
    public function setDepartureLocationIds($departure_location_ids)
    {
        ...
        if ((count($departure_location_ids) > 2000)) {
            throw new \InvalidArgumentException('invalid value for $departure_location_ids when calling RequestTimeFilterArrivalSearch., number of items must be less than or equal to 2000.');
        }
        if ((count($departure_location_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $departure_location_ids when calling RequestTimeFilterArrivalSearch., number of items must be greater than or equal to 1.');
        }
    ...
    public function setTravelTime($travel_time)
    {
        ...
        if (($travel_time > 14400)) {
            throw new \InvalidArgumentException('invalid value for $travel_time when calling RequestTimeFilterArrivalSearch., must be smaller than or equal to 14400.');
        }
        if (($travel_time < 60)) {
            throw new \InvalidArgumentException('invalid value for $travel_time when calling RequestTimeFilterArrivalSearch., must be bigger than or equal to 60.');
        }
