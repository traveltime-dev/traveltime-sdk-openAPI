...
/**
 * RequestTimeFilterPostcodeSectorsArrivalSearch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RequestTimeFilterPostcodeSectorsArrivalSearch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestTimeFilterPostcodeSectorsArrivalSearch';
    ...
    public function setTravelTime($travel_time)
    {
        ...
        if (($travel_time > 14400)) {
            throw new \InvalidArgumentException('invalid value for $travel_time when calling RequestTimeFilterPostcodeSectorsArrivalSearch., must be smaller than or equal to 14400.');
        }
        if (($travel_time < 60)) {
            throw new \InvalidArgumentException('invalid value for $travel_time when calling RequestTimeFilterPostcodeSectorsArrivalSearch., must be bigger than or equal to 60.');
        }
