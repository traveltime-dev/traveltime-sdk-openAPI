...
/**
 * RequestTimeFilterPostcodeSectorsDepartureSearch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RequestTimeFilterPostcodeSectorsDepartureSearch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestTimeFilterPostcodeSectorsDepartureSearch';
    ...
    protected static $openAPITypes = [
        ...
        'properties' => '\OpenAPI\Client\Model\RequestTimeFilterPostcodeSectorsProperty[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['reachable_postcodes_threshold'] = $data['reachable_postcodes_threshold'] ?? null;
    ...
    public function setTravelTime($travel_time)
    {
        ...
        if (($travel_time > 14400)) {
            throw new \InvalidArgumentException('invalid value for $travel_time when calling RequestTimeFilterPostcodeSectorsDepartureSearch., must be smaller than or equal to 14400.');
        }
        if (($travel_time < 60)) {
            throw new \InvalidArgumentException('invalid value for $travel_time when calling RequestTimeFilterPostcodeSectorsDepartureSearch., must be bigger than or equal to 60.');
        }
     ...
     * Gets properties
     *
     * @return \OpenAPI\Client\Model\RequestTimeFilterPostcodeSectorsProperty[]
     */
     ...
     * Sets properties
     *
     * @param \OpenAPI\Client\Model\RequestTimeFilterPostcodeSectorsProperty[] $properties properties
     *
     * @return self
     */
