 ...
 */
class RequestTimeMap implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['unions'] = $data['unions'] ?? null;
        $this->container['intersections'] = $data['intersections'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['unions']) && (count($this->container['unions']) > 10)) {
            $invalidProperties[] = "invalid value for 'unions', number of items must be less than or equal to 10.";
        }

        if (!is_null($this->container['intersections']) && (count($this->container['intersections']) > 10)) {
            $invalidProperties[] = "invalid value for 'intersections', number of items must be less than or equal to 10.";
        }
    ...
    public function setDepartureSearches($departure_searches)
    {
        ...
        if (!is_null($departure_searches) && (count($departure_searches) > 10)) {
            throw new \InvalidArgumentException('invalid value for $departure_searches when calling RequestTimeMap., number of items must be less than or equal to 10.');
        }
    ...
    public function setArrivalSearches($arrival_searches)
    {
        ...
        if (!is_null($arrival_searches) && (count($arrival_searches) > 10)) {
            throw new \InvalidArgumentException('invalid value for $arrival_searches when calling RequestTimeMap., number of items must be less than or equal to 10.');
        }
    ...
    public function setUnions($unions)
    {
        ...
        if (!is_null($unions) && (count($unions) > 10)) {
            throw new \InvalidArgumentException('invalid value for $unions when calling RequestTimeMap., number of items must be less than or equal to 10.');
        }
    ...
    public function setIntersections($intersections)
    {
        ...
        if (!is_null($intersections) && (count($intersections) > 10)) {
            throw new \InvalidArgumentException('invalid value for $intersections when calling RequestTimeMap., number of items must be less than or equal to 10.');
        }
