 ...
 */
class ResponseBox implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['min_lat'] = $data['min_lat'] ?? null;
        $this->container['max_lat'] = $data['max_lat'] ?? null;
        $this->container['min_lng'] = $data['min_lng'] ?? null;
        $this->container['max_lng'] = $data['max_lng'] ?? null;
    }
