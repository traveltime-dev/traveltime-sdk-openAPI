...
/**
 * ResponseTimeFilterPostcodeSectorProperties Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseTimeFilterPostcodeSectorProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseTimeFilterPostcodeSectorProperties';
    ...
    {
        $this->container['travel_time_reachable'] = $data['travel_time_reachable'] ?? null;
        $this->container['travel_time_all'] = $data['travel_time_all'] ?? null;
