function New-RequestTimeFilterPostcodeSectorsDepartureSearch {
    ...
    Process {
        'Creating object: Org.OpenAPITools.Model.RequestTimeFilterPostcodeSectorsDepartureSearch' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        New-Object -TypeName Org.OpenAPITools.Model.RequestTimeFilterPostcodeSectorsDepartureSearch -ArgumentList @(
            ${id},
            ${transportation},
            ${travelUnderscoretime},
            ${departureUnderscoretime},
