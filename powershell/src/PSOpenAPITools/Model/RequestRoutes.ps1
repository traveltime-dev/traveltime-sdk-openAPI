...
RequestRoutes<PSCustomObject>
#>

function Initialize-RequestRoutes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RequestRoutes' | Write-Debug
...
Convert from JSON to RequestRoutes<PSCustomObject>
...
RequestRoutes<PSCustomObject>
#>
function ConvertFrom-JsonToRequestRoutes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RequestRoutes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RequestRoutes
