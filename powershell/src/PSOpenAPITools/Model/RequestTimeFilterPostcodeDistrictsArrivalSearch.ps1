...
RequestTimeFilterPostcodeDistrictsArrivalSearch<PSCustomObject>
#>

function Initialize-RequestTimeFilterPostcodeDistrictsArrivalSearch {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RequestTimeFilterPostcodeDistrictsArrivalSearch' | Write-Debug
...
Convert from JSON to RequestTimeFilterPostcodeDistrictsArrivalSearch<PSCustomObject>
...
RequestTimeFilterPostcodeDistrictsArrivalSearch<PSCustomObject>
#>
function ConvertFrom-JsonToRequestTimeFilterPostcodeDistrictsArrivalSearch {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RequestTimeFilterPostcodeDistrictsArrivalSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RequestTimeFilterPostcodeDistrictsArrivalSearch
        $AllProperties = ("id", "transportation", "travel_time", "arrival_time", "reachable_postcodes_threshold", "properties", "range")
