...
RequestTimeFilterPostcodeSectorsArrivalSearch<PSCustomObject>
#>

function Initialize-RequestTimeFilterPostcodeSectorsArrivalSearch {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RequestTimeFilterPostcodeSectorsArrivalSearch' | Write-Debug
...
Convert from JSON to RequestTimeFilterPostcodeSectorsArrivalSearch<PSCustomObject>
...
RequestTimeFilterPostcodeSectorsArrivalSearch<PSCustomObject>
#>
function ConvertFrom-JsonToRequestTimeFilterPostcodeSectorsArrivalSearch {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RequestTimeFilterPostcodeSectorsArrivalSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RequestTimeFilterPostcodeSectorsArrivalSearch
