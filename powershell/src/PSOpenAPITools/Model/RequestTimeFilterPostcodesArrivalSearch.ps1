...
RequestTimeFilterPostcodesArrivalSearch<PSCustomObject>
#>

function Initialize-RequestTimeFilterPostcodesArrivalSearch {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RequestTimeFilterPostcodesArrivalSearch' | Write-Debug
...
Convert from JSON to RequestTimeFilterPostcodesArrivalSearch<PSCustomObject>
...
RequestTimeFilterPostcodesArrivalSearch<PSCustomObject>
#>
function ConvertFrom-JsonToRequestTimeFilterPostcodesArrivalSearch {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RequestTimeFilterPostcodesArrivalSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RequestTimeFilterPostcodesArrivalSearch
        $AllProperties = ("id", "transportation", "travel_time", "arrival_time", "properties", "range")
