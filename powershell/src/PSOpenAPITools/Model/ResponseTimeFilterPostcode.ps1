...
ResponseTimeFilterPostcode<PSCustomObject>
#>

function Initialize-ResponseTimeFilterPostcode {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ResponseTimeFilterPostcode' | Write-Debug
...
Convert from JSON to ResponseTimeFilterPostcode<PSCustomObject>
...
ResponseTimeFilterPostcode<PSCustomObject>
#>
function ConvertFrom-JsonToResponseTimeFilterPostcode {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ResponseTimeFilterPostcode' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ResponseTimeFilterPostcode
