...
ResponseTimeFilterResult<PSCustomObject>
#>

function Initialize-ResponseTimeFilterResult {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ResponseTimeFilterResult' | Write-Debug
...
Convert from JSON to ResponseTimeFilterResult<PSCustomObject>
...
ResponseTimeFilterResult<PSCustomObject>
#>
function ConvertFrom-JsonToResponseTimeFilterResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ResponseTimeFilterResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ResponseTimeFilterResult
