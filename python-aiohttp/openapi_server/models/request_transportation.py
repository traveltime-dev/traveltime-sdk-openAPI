...
class RequestTransportation(Model):
    ...
    def __init__(self, type: str=None, disable_border_crossing: bool=None, pt_change_delay: int=None, walking_time: int=None, driving_time_to_station: int=None, cycling_time_to_station: int=None, parking_time: int=None, boarding_time: int=None):
