...
class ResponseTimeMapWktResult(Model):
    ...
    def __init__(self, search_id: str=None, shape: str=None, properties: ResponseTimeMapProperties=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ResponseTimeMapWktResult':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ResponseTimeMapWktResult of this ResponseTimeMapWktResult.
        """
