...
class RequestRangeFull(Model):
    ...
    def __init__(self, enabled: bool=None, max_results: int=None, width: int=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RequestRangeFull':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The RequestRangeFull of this RequestRangeFull.
        """
    ...
    def width(self, width):
        ...
        if width is not None and width > 43200:
            raise ValueError("Invalid value for `width`, must be a value less than or equal to `43200`")
