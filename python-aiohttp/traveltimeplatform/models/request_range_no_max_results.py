...
class RequestRangeNoMaxResults(Model):
    ...
    def __init__(self, enabled: bool=None, width: int=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RequestRangeNoMaxResults':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The RequestRangeNoMaxResults of this RequestRangeNoMaxResults.
        """
