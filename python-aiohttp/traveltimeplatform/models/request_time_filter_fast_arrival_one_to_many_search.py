...
class RequestTimeFilterFastArrivalOneToManySearch(Model):
    ...
    def __init__(self, id: str=None, departure_location_id: str=None, arrival_location_ids: List[str]=None, transportation: RequestTransportationFast=None, travel_time: int=None, arrival_time_period: RequestArrivalTimePeriod=None, properties: List[RequestTimeFilterFastProperty]=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RequestTimeFilterFastArrivalOneToManySearch':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The RequestTimeFilterFastArrivalOneToManySearch of this RequestTimeFilterFastArrivalOneToManySearch.
        """
