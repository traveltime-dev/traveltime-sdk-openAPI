...
class RequestTransportation(Model):
    ...
    def __init__(self, type: str=None, pt_change_delay: int=None, walking_time: int=None, driving_time_to_station: int=None, parking_time: int=None, boarding_time: int=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RequestTransportation':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The RequestTransportation of this RequestTransportation.
        """
    ...
    def type(self, type):
        ...
        :type type: str
        """
        allowed_values = ["cycling", "driving", "driving+train", "public_transport", "walking", "coach", "bus", "train", "ferry", "driving+ferry", "cycling+ferry"]
