...
class ResponseFaresFast(Model):
    ...
    def __init__(self, tickets_total: List[ResponseFareTicket]=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ResponseFaresFast':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ResponseFaresFast of this ResponseFaresFast.
        """
