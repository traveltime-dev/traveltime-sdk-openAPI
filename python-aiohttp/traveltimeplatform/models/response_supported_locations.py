...
class ResponseSupportedLocations(Model):
    ...
    def __init__(self, locations: List[ResponseSupportedLocation]=None, unsupported_locations: List[str]=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ResponseSupportedLocations':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ResponseSupportedLocations of this ResponseSupportedLocations.
        """
    ...
    def unsupported_locations(self, unsupported_locations):
        ...
        if unsupported_locations is None:
            raise ValueError("Invalid value for `unsupported_locations`, must not be `None`")
