...
class ResponseTravelTimeStatistics(Model):
    ...
    def __init__(self, min: int=None, max: int=None, mean: int=None, median: int=None):  # noqa: E501
        """ResponseTravelTimeStatistics - a model defined in Swagger
