...
from app.traveltimeplatform.models.request_time_filter_arrival_search import RequestTimeFilterArrivalSearch  # noqa: F401,E501
from app.traveltimeplatform.models.request_time_filter_departure_search import RequestTimeFilterDepartureSearch  # noqa: F401,E501
...
class RequestTimeFilter(Model):
    ...
    def __init__(self, locations: List[RequestLocation]=None, departure_searches: List[RequestTimeFilterDepartureSearch]=None, arrival_searches: List[RequestTimeFilterArrivalSearch]=None):  # noqa: E501
        """RequestTimeFilter - a model defined in Swagger
    ...
    @property
    def departure_searches(self) -> List[RequestTimeFilterDepartureSearch]:
    ...
    def departure_searches(self, departure_searches: List[RequestTimeFilterDepartureSearch]):
    ...
    @property
    def arrival_searches(self) -> List[RequestTimeFilterArrivalSearch]:
    ...
    def arrival_searches(self, arrival_searches: List[RequestTimeFilterArrivalSearch]):
