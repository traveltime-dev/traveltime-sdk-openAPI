...
class RequestTimeFilterDepartureSearch(Model):
    ...
    def __init__(self, id: str=None, departure_location_id: str=None, arrival_location_ids: List[str]=None, transportation: RequestTransportation=None, travel_time: int=None, departure_time: datetime=None, properties: List[RequestTimeFilterProperty]=None, range: RequestRangeFull=None):  # noqa: E501
        """RequestTimeFilterDepartureSearch - a model defined in Swagger
