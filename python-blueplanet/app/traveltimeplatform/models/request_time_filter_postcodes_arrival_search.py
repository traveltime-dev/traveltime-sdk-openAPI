...
class RequestTimeFilterPostcodesArrivalSearch(Model):
    ...
    def __init__(self, id: str=None, transportation: RequestTransportation=None, travel_time: int=None, arrival_time: datetime=None, properties: List[RequestTimeFilterPostcodesProperty]=None, range: RequestRangeFull=None):  # noqa: E501
        """RequestTimeFilterPostcodesArrivalSearch - a model defined in Swagger
