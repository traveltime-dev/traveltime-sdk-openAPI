...
class ResponseBox(Model):
    ...
    def __init__(self, min_lat: float=None, max_lat: float=None, min_lng: float=None, max_lng: float=None):  # noqa: E501
        """ResponseBox - a model defined in Swagger
    ...
    @min_lat.setter
    def min_lat(self, min_lat: float):
    ...
    @max_lat.setter
    def max_lat(self, max_lat: float):
    ...
    @min_lng.setter
    def min_lng(self, min_lng: float):
    ...
    @max_lng.setter
    def max_lng(self, max_lng: float):
