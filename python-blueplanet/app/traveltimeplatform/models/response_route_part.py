...
class ResponseRoutePart(Model):
    ...
    @coords.setter
    def coords(self, coords: List[Coords]):
    ...
    def departure_station(self, departure_station: str):
    ...
    def arrival_station(self, arrival_station: str):
    ...
    @departs_at.setter
    def departs_at(self, departs_at: str):
    ...
    @arrives_at.setter
    def arrives_at(self, arrives_at: str):
    ...
    @num_stops.setter
    def num_stops(self, num_stops: int):
