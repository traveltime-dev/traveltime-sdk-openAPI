...
from app.traveltimeplatform.models.response_time_filter_postcodes_properties import ResponseTimeFilterPostcodesProperties  # noqa: F401,E501
...
class ResponseTimeFilterPostcode(Model):
    ...
    def __init__(self, code: String=None, properties: List[ResponseTimeFilterPostcodesProperties]=None):  # noqa: E501
        """ResponseTimeFilterPostcode - a model defined in Swagger
    ...
    @property
    def properties(self) -> List[ResponseTimeFilterPostcodesProperties]:
    ...
    @properties.setter
    def properties(self, properties: List[ResponseTimeFilterPostcodesProperties]):
