...
from app.traveltimeplatform.models.response_time_filter_postcode import ResponseTimeFilterPostcode  # noqa: F401,E501
...
class ResponseTimeFilterPostcodesResult(Model):
    ...
    def __init__(self, search_id: str=None, postcodes: List[ResponseTimeFilterPostcode]=None):  # noqa: E501
        """ResponseTimeFilterPostcodesResult - a model defined in Swagger
    ...
    @property
    def postcodes(self) -> List[ResponseTimeFilterPostcode]:
    ...
    @postcodes.setter
    def postcodes(self, postcodes: List[ResponseTimeFilterPostcode]):
