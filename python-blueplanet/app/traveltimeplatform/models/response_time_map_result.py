...
from app.traveltimeplatform.models.response_shape import ResponseShape  # noqa: F401,E501
...
class ResponseTimeMapResult(Model):
    ...
    def __init__(self, search_id: str=None, shapes: List[ResponseShape]=None, properties: ResponseTimeMapProperties=None):  # noqa: E501
        """ResponseTimeMapResult - a model defined in Swagger
    ...
    @property
    def shapes(self) -> List[ResponseShape]:
    ...
    @shapes.setter
    def shapes(self, shapes: List[ResponseShape]):
