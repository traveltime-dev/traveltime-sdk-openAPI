...
class RequestTimeMapArrivalSearch(Model):
    ...
    def __init__(self, id=None, coords=None, transportation=None, travel_time=None, arrival_time=None, properties=None, range=None, level_of_detail=None):  # noqa: E501
