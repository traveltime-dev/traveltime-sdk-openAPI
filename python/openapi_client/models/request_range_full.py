...
class RequestRangeFull(object):
    ...
    def __init__(self, enabled=None, max_results=None, width=None, local_vars_configuration=None):  # noqa: E501
    ...
    def max_results(self, max_results):
        ...
        """
        if self.local_vars_configuration.client_side_validation and max_results is None:  # noqa: E501
            raise ValueError("Invalid value for `max_results`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                max_results is not None and max_results > 5):  # noqa: E501
