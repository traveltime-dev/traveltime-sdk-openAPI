...
class RequestRoutesArrivalSearch(object):
    ...
    def __init__(self, id=None, departure_location_ids=None, arrival_location_id=None, transportation=None, arrival_time=None, properties=None, range=None, local_vars_configuration=None):  # noqa: E501
