...
class RequestTimeFilterFastArrivalManyToOneSearch(object):
    ...
    def __init__(self, id=None, arrival_location_id=None, departure_location_ids=None, transportation=None, travel_time=None, arrival_time_period=None, properties=None, local_vars_configuration=None):  # noqa: E501
