...
class RequestTimeFilterPostcodeDistrictsDepartureSearch(object):
    ...
    def __init__(self, id=None, transportation=None, travel_time=None, departure_time=None, reachable_postcodes_threshold=None, properties=None, range=None, local_vars_configuration=None):  # noqa: E501
