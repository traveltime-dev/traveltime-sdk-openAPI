...
from traveltimeplatform.exceptions import (
    ApiTypeError,
    ApiValueError
)
...
class DefaultApi(object):
    ...
    def geocoding_reverse_search_with_http_info(self, focus_lat, focus_lng, **kwargs):  # noqa: E501
        ...
        if ('focus_lat' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `focus_lat` when calling `geocoding_reverse_search`")  # noqa: E501
        # verify the required parameter 'focus_lng' is set
        if ('focus_lng' not in local_var_params or
                local_var_params['focus_lng'] is None):
            raise ApiValueError("Missing the required parameter `focus_lng` when calling `geocoding_reverse_search`")  # noqa: E501
