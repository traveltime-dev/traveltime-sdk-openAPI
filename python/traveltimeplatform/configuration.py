...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        """Constructor"""
        # Default Base url
        self.host = "https://api.traveltimeapp.com"
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("traveltimeplatform")
            ...
            'ApplicationId':
                {
                    ...
                    'value': self.get_api_key_with_prefix('X-Application-Id')
                },
        }
