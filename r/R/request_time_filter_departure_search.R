  ...
  public = list(
    ...
    fromJSON = function(RequestTimeFilterDepartureSearchJson) {
      ...
      if (!is.null(RequestTimeFilterDepartureSearchObject$`properties`)) {
        self$`properties` <- sapply(RequestTimeFilterDepartureSearchObject$`properties`, function(x) {
    ...
    fromJSONString = function(RequestTimeFilterDepartureSearchJson) {
      ...
      self$`id` <- RequestTimeFilterDepartureSearchObject$`id`
      self$`departure_location_id` <- RequestTimeFilterDepartureSearchObject$`departure_location_id`
      self$`arrival_location_ids` <- lapply(RequestTimeFilterDepartureSearchObject$`arrival_location_ids`, function (x) x)
      self$`transportation` <- RequestTransportation$new()$fromJSON(jsonlite::toJSON(RequestTimeFilterDepartureSearchObject$transportation, auto_unbox = TRUE))
      self$`travel_time` <- RequestTimeFilterDepartureSearchObject$`travel_time`
      self$`departure_time` <- RequestTimeFilterDepartureSearchObject$`departure_time`
      data.frame <- RequestTimeFilterDepartureSearchObject$`properties`
      ...
      self$`range` <- RequestRangeFull$new()$fromJSON(jsonlite::toJSON(RequestTimeFilterDepartureSearchObject$range, auto_unbox = TRUE))
      self
    }
  )
)
