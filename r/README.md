# R API client for traveltimeplatform
...
cd GIT_REPO_ID
R CMD build .
R CMD check traveltimeplatform_1.0.0.tar.gz
R CMD INSTALL traveltimeplatform_1.0.0.tar.gz
```

### Install the package

```R
install.packages("traveltimeplatform")
```
