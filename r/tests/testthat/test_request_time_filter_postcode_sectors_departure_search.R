...
context("Test RequestTimeFilterPostcodeSectorsDepartureSearch")

model.instance <- RequestTimeFilterPostcodeSectorsDepartureSearch$new()
...
test_that("properties", {
  # tests for the property `properties` (RequestTimeFilterPostcodeSectorsProperty)
