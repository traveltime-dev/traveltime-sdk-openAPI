...
module OpenapiClient
  class RequestTimeFilterPostcodeDistrictsArrivalSearch
    ...
    attr_accessor :reachable_postcodes_threshold
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::RequestTimeFilterPostcodeDistrictsArrivalSearch` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::RequestTimeFilterPostcodeDistrictsArrivalSearch`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'reachable_postcodes_threshold')
        self.reachable_postcodes_threshold = attributes[:'reachable_postcodes_threshold']
      end
    ...
    def list_invalid_properties
      ...
      if @reachable_postcodes_threshold.nil?
        invalid_properties.push('invalid value for "reachable_postcodes_threshold", reachable_postcodes_threshold cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @reachable_postcodes_threshold.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reachable_postcodes_threshold == o.reachable_postcodes_threshold &&
    ...
    def hash
      [id, transportation, travel_time, arrival_time, reachable_postcodes_threshold, properties, range].hash
    end
