  ...
  class RequestTimeMapArrivalSearch
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::RequestTimeMapArrivalSearch` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::RequestTimeMapArrivalSearch`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'level_of_detail')
        self.level_of_detail = attributes[:'level_of_detail']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          range == o.range &&
          level_of_detail == o.level_of_detail
    end
    ...
    def hash
      [id, coords, transportation, travel_time, arrival_time, properties, range, level_of_detail].hash
    end
