...
pub async fn geocoding_reverse_search(configuration: &configuration::Configuration, lat: f64, lng: f64, within_country: Option<&str>) -> Result<crate::models::ResponseGeocoding, Error<GeocodingReverseSearchError>> {
    ...
    let local_var_uri_str = format!("{}/v4/geocoding/reverse", configuration.base_path);
    ...
    if let Some(ref local_var_str) = within_country {
        local_var_req_builder = local_var_req_builder.query(&[("within.country", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_apikey) = configuration.api_key {
        ...
        local_var_req_builder = local_var_req_builder.header("X-Application-Id", local_var_value);
    };
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GeocodingReverseSearchError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn geocoding_search(configuration: &configuration::Configuration, query: &str, focus_lat: Option<f64>, focus_lng: Option<f64>, within_country: Option<&str>) -> Result<crate::models::ResponseGeocoding, Error<GeocodingSearchError>> {
    ...
    let local_var_uri_str = format!("{}/v4/geocoding/search", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());

    local_var_req_builder = local_var_req_builder.query(&[("query", &query.to_string())]);
    if let Some(ref local_var_str) = focus_lat {
        local_var_req_builder = local_var_req_builder.query(&[("focus.lat", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = focus_lng {
        local_var_req_builder = local_var_req_builder.query(&[("focus.lng", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = within_country {
        local_var_req_builder = local_var_req_builder.query(&[("within.country", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GeocodingSearchError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn map_info(configuration: &configuration::Configuration, ) -> Result<crate::models::ResponseMapInfo, Error<MapInfoError>> {
    ...
    let local_var_uri_str = format!("{}/v4/map-info", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MapInfoError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn routes(configuration: &configuration::Configuration, request_routes: crate::models::RequestRoutes) -> Result<crate::models::ResponseRoutes, Error<RoutesError>> {
    ...
    let local_var_uri_str = format!("{}/v4/routes", configuration.base_path);
    ...
    local_var_req_builder = local_var_req_builder.json(&request_routes);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RoutesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn supported_locations(configuration: &configuration::Configuration, request_supported_locations: crate::models::RequestSupportedLocations) -> Result<crate::models::ResponseSupportedLocations, Error<SupportedLocationsError>> {
    ...
    let local_var_uri_str = format!("{}/v4/supported-locations", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&request_supported_locations);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SupportedLocationsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn time_filter(configuration: &configuration::Configuration, request_time_filter: crate::models::RequestTimeFilter) -> Result<crate::models::ResponseTimeFilter, Error<TimeFilterError>> {
    ...
    let local_var_uri_str = format!("{}/v4/time-filter", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&request_time_filter);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TimeFilterError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn time_filter_fast(configuration: &configuration::Configuration, request_time_filter_fast: crate::models::RequestTimeFilterFast) -> Result<crate::models::ResponseTimeFilterFast, Error<TimeFilterFastError>> {
    ...
    let local_var_uri_str = format!("{}/v4/time-filter/fast", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&request_time_filter_fast);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TimeFilterFastError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn time_filter_postcode_districts(configuration: &configuration::Configuration, request_time_filter_postcode_districts: crate::models::RequestTimeFilterPostcodeDistricts) -> Result<crate::models::ResponseTimeFilterPostcodeDistricts, Error<TimeFilterPostcodeDistrictsError>> {
    ...
    let local_var_uri_str = format!("{}/v4/time-filter/postcode-districts", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&request_time_filter_postcode_districts);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TimeFilterPostcodeDistrictsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn time_filter_postcode_sectors(configuration: &configuration::Configuration, request_time_filter_postcode_sectors: crate::models::RequestTimeFilterPostcodeSectors) -> Result<crate::models::ResponseTimeFilterPostcodeSectors, Error<TimeFilterPostcodeSectorsError>> {
    ...
    let local_var_uri_str = format!("{}/v4/time-filter/postcode-sectors", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&request_time_filter_postcode_sectors);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TimeFilterPostcodeSectorsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn time_filter_postcodes(configuration: &configuration::Configuration, request_time_filter_postcodes: crate::models::RequestTimeFilterPostcodes) -> Result<crate::models::ResponseTimeFilterPostcodes, Error<TimeFilterPostcodesError>> {
    ...
    let local_var_uri_str = format!("{}/v4/time-filter/postcodes", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&request_time_filter_postcodes);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TimeFilterPostcodesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn time_map(configuration: &configuration::Configuration, request_time_map: crate::models::RequestTimeMap) -> Result<crate::models::ResponseTimeMap, Error<TimeMapError>> {
    ...
    let local_var_uri_str = format!("{}/v4/time-map", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&request_time_map);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TimeMapError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
