...
impl RequestTimeFilterArrivalSearch {
  ...
  pub fn with_id(mut self, id: String) -> RequestTimeFilterArrivalSearch {
    self.id = id;
    self
  }
  ...
  pub fn with_departure_location_ids(mut self, departure_location_ids: Vec<String>) -> RequestTimeFilterArrivalSearch {
    self.departure_location_ids = departure_location_ids;
    self
  }
  ...
  pub fn with_arrival_location_id(mut self, arrival_location_id: String) -> RequestTimeFilterArrivalSearch {
    self.arrival_location_id = arrival_location_id;
    self
  }
  ...
  pub fn with_transportation(mut self, transportation: ::models::RequestTransportation) -> RequestTimeFilterArrivalSearch {
    self.transportation = transportation;
    self
  }
  ...
  pub fn with_travel_time(mut self, travel_time: i32) -> RequestTimeFilterArrivalSearch {
    self.travel_time = travel_time;
    self
  }
  ...
  pub fn with_arrival_time(mut self, arrival_time: String) -> RequestTimeFilterArrivalSearch {
    self.arrival_time = arrival_time;
    self
  }
  ...
  pub fn with_properties(mut self, properties: Vec<::models::RequestTimeFilterProperty>) -> RequestTimeFilterArrivalSearch {
    self.properties = properties;
    self
  }
  ...
  pub fn with_range(mut self, range: ::models::RequestRangeFull) -> RequestTimeFilterArrivalSearch {
    self.range = Some(range);
    self
  }
