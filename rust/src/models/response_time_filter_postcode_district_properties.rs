...
impl ResponseTimeFilterPostcodeDistrictProperties {
  ...
  pub fn with_travel_time_reachable(mut self, travel_time_reachable: ::models::ResponseTravelTimeStatistics) -> ResponseTimeFilterPostcodeDistrictProperties {
    self.travel_time_reachable = Some(travel_time_reachable);
    self
  }
  ...
  pub fn with_travel_time_all(mut self, travel_time_all: ::models::ResponseTravelTimeStatistics) -> ResponseTimeFilterPostcodeDistrictProperties {
    self.travel_time_all = Some(travel_time_all);
    self
  }
  ...
  pub fn with_coverage(mut self, coverage: f64) -> ResponseTimeFilterPostcodeDistrictProperties {
    self.coverage = Some(coverage);
    self
  }
