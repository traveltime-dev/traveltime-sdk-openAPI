...
open class DefaultAPI: APIBase {
     ...
     */
    open class func geocodingReverseSearch(focusLat: Double, focusLng: Double, withinCountry: String? = nil, completion: @escaping ((_ data: ResponseGeocoding?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func geocodingSearch(query: String, withinCountry: String? = nil, focusLat: Double? = nil, focusLng: Double? = nil, completion: @escaping ((_ data: ResponseGeocoding?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func mapInfo(completion: @escaping ((_ data: ResponseMapInfo?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func routes(requestRoutes: RequestRoutes, completion: @escaping ((_ data: ResponseRoutes?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func routesWithRequestBuilder(requestRoutes: RequestRoutes) -> RequestBuilder<ResponseRoutes> {
        let path = "/v4/routes"
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = requestRoutes.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func supportedLocations(requestSupportedLocations: RequestSupportedLocations, completion: @escaping ((_ data: ResponseSupportedLocations?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func supportedLocationsWithRequestBuilder(requestSupportedLocations: RequestSupportedLocations) -> RequestBuilder<ResponseSupportedLocations> {
        ...
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = requestSupportedLocations.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func timeFilter(requestTimeFilter: RequestTimeFilter, completion: @escaping ((_ data: ResponseTimeFilter?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func timeFilterWithRequestBuilder(requestTimeFilter: RequestTimeFilter) -> RequestBuilder<ResponseTimeFilter> {
        ...
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = requestTimeFilter.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func timeFilterFast(requestTimeFilterFast: RequestTimeFilterFast, completion: @escaping ((_ data: ResponseTimeFilterFast?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func timeFilterFastWithRequestBuilder(requestTimeFilterFast: RequestTimeFilterFast) -> RequestBuilder<ResponseTimeFilterFast> {
        ...
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = requestTimeFilterFast.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func timeFilterPostcodeDistricts(requestTimeFilterPostcodeDistricts: RequestTimeFilterPostcodeDistricts, completion: @escaping ((_ data: ResponseTimeFilterPostcodeDistricts?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func timeFilterPostcodeDistrictsWithRequestBuilder(requestTimeFilterPostcodeDistricts: RequestTimeFilterPostcodeDistricts) -> RequestBuilder<ResponseTimeFilterPostcodeDistricts> {
        ...
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = requestTimeFilterPostcodeDistricts.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func timeFilterPostcodeSectors(requestTimeFilterPostcodeSectors: RequestTimeFilterPostcodeSectors, completion: @escaping ((_ data: ResponseTimeFilterPostcodeSectors?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func timeFilterPostcodeSectorsWithRequestBuilder(requestTimeFilterPostcodeSectors: RequestTimeFilterPostcodeSectors) -> RequestBuilder<ResponseTimeFilterPostcodeSectors> {
        ...
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = requestTimeFilterPostcodeSectors.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func timeFilterPostcodes(requestTimeFilterPostcodes: RequestTimeFilterPostcodes, completion: @escaping ((_ data: ResponseTimeFilterPostcodes?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func timeFilterPostcodesWithRequestBuilder(requestTimeFilterPostcodes: RequestTimeFilterPostcodes) -> RequestBuilder<ResponseTimeFilterPostcodes> {
        ...
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = requestTimeFilterPostcodes.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func timeMap(requestTimeMap: RequestTimeMap, completion: @escaping ((_ data: ResponseTimeMap?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func timeMapWithRequestBuilder(requestTimeMap: RequestTimeMap) -> RequestBuilder<ResponseTimeMap> {
        ...
        let URLString = OpenAPIClientAPI.basePath + path
        let parameters = requestTimeMap.encodeToJSON()
