...
public struct RequestTimeFilterArrivalSearch: Codable { 
    ...
    public init(id: String, departureLocationIds: [String], arrivalLocationId: String, transportation: RequestTransportation, travelTime: Int, arrivalTime: Date, properties: [RequestTimeFilterProperty], range: RequestRangeFull?) {
        self.id = id
