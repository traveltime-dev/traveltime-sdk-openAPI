...
public struct RequestTimeFilterPostcodeDistrictsArrivalSearch: Codable {
    ...
    public init(_id: String, transportation: RequestTransportation, travelTime: Int, arrivalTime: Date, reachablePostcodesThreshold: Double, properties: [RequestTimeFilterPostcodeDistrictsProperty], range: RequestRangeFull?) {
        self._id = _id
