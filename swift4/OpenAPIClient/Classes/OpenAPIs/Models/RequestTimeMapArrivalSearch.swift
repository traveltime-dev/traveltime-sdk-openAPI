...
public struct RequestTimeMapArrivalSearch: Codable {
    ...
    public init(id: String, coords: Coords, transportation: RequestTransportation, travelTime: Int, arrivalTime: Date, properties: [RequestTimeMapProperty]?, range: RequestRangeNoMaxResults?) {
        self.id = id
        self.coords = coords
