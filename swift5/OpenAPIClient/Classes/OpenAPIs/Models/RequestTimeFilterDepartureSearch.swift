...
public struct RequestTimeFilterDepartureSearch: Codable, Hashable {
    ...
    public init(id: String, departureLocationId: String, arrivalLocationIds: [String], transportation: RequestTransportation, travelTime: Int, departureTime: Date, properties: [RequestTimeFilterProperty], range: RequestRangeFull? = nil) {
        self.id = id
