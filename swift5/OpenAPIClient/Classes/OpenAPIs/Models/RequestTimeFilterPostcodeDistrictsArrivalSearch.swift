...
public struct RequestTimeFilterPostcodeDistrictsArrivalSearch: Codable, Hashable {
    ...
    public init(id: String, transportation: RequestTransportation, travelTime: Int, arrivalTime: Date, reachablePostcodesThreshold: Double, properties: [RequestTimeFilterPostcodeDistrictsProperty], range: RequestRangeFull? = nil) {
        self.id = id
