...
let requestTimeMap = RequestTimeMap(departureSearches: [RequestTimeMapDepartureSearch(id: "id_example", coords: Coords(lat: 123, lng: 123), transportation: RequestTransportation(type: "type_example", ptChangeDelay: 123, walkingTime: 123, drivingTimeToStation: 123, parkingTime: 123, boardingTime: 123), travelTime: 123, departureTime: Date(), properties: [RequestTimeMapProperty()], range: RequestRangeNoMaxResults(enabled: false, width: 123))], arrivalSearches: [RequestTimeMapArrivalSearch(id: "id_example", coords: nil, transportation: nil, travelTime: 123, arrivalTime: Date(), properties: [nil], range: nil)], unions: [RequestUnionOnIntersection(id: "id_example", searchIds: ["searchIds_example"])], intersections: [nil]) // RequestTimeMap | 
