...
export function RequestRoutesDepartureSearchFromJSON(json: any): RequestRoutesDepartureSearch {
    return RequestRoutesDepartureSearchFromJSONTyped(json, false);
}

export function RequestRoutesDepartureSearchFromJSONTyped(json: any, ignoreDiscriminator: boolean): RequestRoutesDepartureSearch {
...
export function RequestRoutesDepartureSearchToJSON(value?: RequestRoutesDepartureSearch | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
