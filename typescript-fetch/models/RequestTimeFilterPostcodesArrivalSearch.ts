...
export function RequestTimeFilterPostcodesArrivalSearchFromJSON(json: any): RequestTimeFilterPostcodesArrivalSearch {
    return RequestTimeFilterPostcodesArrivalSearchFromJSONTyped(json, false);
}

export function RequestTimeFilterPostcodesArrivalSearchFromJSONTyped(json: any, ignoreDiscriminator: boolean): RequestTimeFilterPostcodesArrivalSearch {
...
export function RequestTimeFilterPostcodesArrivalSearchToJSON(value?: RequestTimeFilterPostcodesArrivalSearch | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
