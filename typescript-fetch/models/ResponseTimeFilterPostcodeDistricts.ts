...
import {
    ...
    ResponseTimeFilterPostcodeDistrictsResultFromJSONTyped,
...
export function ResponseTimeFilterPostcodeDistrictsFromJSON(json: any): ResponseTimeFilterPostcodeDistricts {
    return ResponseTimeFilterPostcodeDistrictsFromJSONTyped(json, false);
}

export function ResponseTimeFilterPostcodeDistrictsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResponseTimeFilterPostcodeDistricts {
...
export function ResponseTimeFilterPostcodeDistrictsToJSON(value?: ResponseTimeFilterPostcodeDistricts | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
